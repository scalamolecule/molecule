  ...
  case class Trait(arity: Int) extends TemplateVals(arity) {
    ...
    val body =
      s"""
         ...
         |  def apply(v    : t, vs: t*): Ns1[${`A..V, `}t] = _exprOneTac(Eq     , v +: vs   )
         |  def apply(vs   : Seq[t]   ): Ns1[${`A..V, `}t] = _exprOneTac(Eq     , vs        )
         |  def not  (v    : t, vs: t*): Ns1[${`A..V, `}t] = _exprOneTac(Neq    , v +: vs   )
         |  def not  (vs   : Seq[t]   ): Ns1[${`A..V, `}t] = _exprOneTac(Neq    , vs        )
