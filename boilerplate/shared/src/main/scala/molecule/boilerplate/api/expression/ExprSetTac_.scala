...
trait ExprSetTac_0[t, Ns1[_], Ns2[_, _]]
  ...
  def has  (v  : t, vs: t*  ): Ns1[t] = _exprSet(Has    , (v +: vs).toSet)
  def has  (vs : Iterable[t]): Ns1[t] = _exprSet(Has    , vs.toSet       )
  def hasNo(v  : t, vs: t*  ): Ns1[t] = _exprSet(HasNo  , (v +: vs).toSet)
  def hasNo(vs : Iterable[t]): Ns1[t] = _exprSet(HasNo  , vs.toSet       )
  
  def has  [ns1[_], ns2[_, _]](a: ModelOps_0[t, ns1, ns2] with CardOne): Ns1[t] = _attrTac(Has  , a)
  def hasNo[ns1[_], ns2[_, _]](a: ModelOps_0[t, ns1, ns2] with CardOne): Ns1[t] = _attrTac(HasNo, a)
