  ...
  case class Trait(arity: Int) extends TemplateVals(arity) {
    val body =
      s"""
         ...
         |  def ==   (v    : t)        : Ns[${`A..V, `}t] = _exprTac(Eq, Seq(v))
         |  def ==   (v    : t, vs: t*): Ns[${`A..V, `}t] = _exprTac(Eq, v +: vs)
         |  def ==   (vs   : Seq[t])   : Ns[${`A..V, `}t] = _exprTac(Eq, vs)
         |  def not  (v    : t, vs: t*): Ns[${`A..V, `}t] = _exprTac(Neq, v +: vs)
         |  def not  (vs   : Seq[t])   : Ns[${`A..V, `}t] = _exprTac(Neq, vs)
         |  def !=   (v    : t)        : Ns[${`A..V, `}t] = _exprTac(Neq, Seq(v))
         |  def !=   (v    : t, vs: t*): Ns[${`A..V, `}t] = _exprTac(Neq, v +: vs)
         |  def !=   (vs   : Seq[t])   : Ns[${`A..V, `}t] = _exprTac(Neq, vs)
