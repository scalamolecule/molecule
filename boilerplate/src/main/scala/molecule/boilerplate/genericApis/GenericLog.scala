...
//  object Log extends Log_0_0[Log_, Init] with FirstNS {
//
...
//     */
//    final def apply(from: Option[Any], until: Option[Any]): Log_0_0[Log_, Init] = ???
//
//    final def apply(from: Option[Any]): Log_0_0[Log_, Init] = ???
//
//    final def apply(): Log_0_0[Log_, Init] = ???
//  }
//}