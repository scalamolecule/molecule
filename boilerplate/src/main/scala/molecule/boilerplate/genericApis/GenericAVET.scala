...
//import molecule.boilerplate.api.generic.dsl.AVET.{AVET_, AVET_0_0}
//
///** AVET Index.
// *
...
//     *
//     * */
//    final def range(a: String, from: Option[Any], until: Option[Any]): AVET_0_0[AVET_, Init] = ???
//  }
//}