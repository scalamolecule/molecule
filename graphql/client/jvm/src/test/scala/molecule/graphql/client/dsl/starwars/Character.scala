...
private[dsl] class Character_0[t](override val dataModel: DataModel) extends Character_0_refs[t](dataModel) with Character_base with ModelOps_0[t, Character_0, Character_1] {
  lazy val id          = new Character_1[Long               , Long  ](dataModel.add(id_man       )) with ExprOneMan_1         [Long               , Long  , Character_1, Character_2] with CardOne
  ...
  override protected def _exprOneTac(op: Op, vs: Seq[t], binding: Boolean) = new Character_0[t](addOne  (dataModel, op, vs, binding)) with CardOne
...
private[dsl] class Character_2[A, B, t](override val dataModel: DataModel) extends Character_2_refs[A, B, t](dataModel) with Character_base with ModelOps_2[A, B, t, Character_2, Character_3] {
  ...
  override protected def _exprOneMan(op: Op, vs: Seq[t], binding: Boolean) = new Character_2[A, B     , t     ](addOne   (dataModel, op, vs, binding)) with SortAttrs_2[A, B     , t     , Character_2] with CardOne
  ...
  override protected def _exprOneTac(op: Op, vs: Seq[t], binding: Boolean) = new Character_2[A, B     , t     ](addOne   (dataModel, op, vs, binding)) with CardOne
...
private[dsl] class Character_3[A, B, C, t](override val dataModel: DataModel) extends Character_3_refs[A, B, C, t](dataModel) with Character_base with ModelOps_3[A, B, C, t, Character_3, Character_4] {
  ...
  override protected def _exprOneMan(op: Op, vs: Seq[t], binding: Boolean) = new Character_3[A, B, C     , t     ](addOne   (dataModel, op, vs, binding)) with SortAttrs_3[A, B, C     , t     , Character_3] with CardOne
  ...
  override protected def _exprOneTac(op: Op, vs: Seq[t], binding: Boolean) = new Character_3[A, B, C     , t     ](addOne   (dataModel, op, vs, binding)) with CardOne
...
private[dsl] class Character_3_refs[A, B, C, t](override val dataModel: DataModel) extends Molecule_03[A, B, C] {
...
private[dsl] class Character_4[A, B, C, D, t](override val dataModel: DataModel) extends Character_4_refs[A, B, C, D, t](dataModel) with Character_base with ModelOps_4[A, B, C, D, t, Character_4, Character_5] {
  ...
  override protected def _exprOneMan(op: Op, vs: Seq[t], binding: Boolean) = new Character_4[A, B, C, D     , t     ](addOne   (dataModel, op, vs, binding)) with SortAttrs_4[A, B, C, D     , t     , Character_4] with CardOne
  ...
  override protected def _exprOneTac(op: Op, vs: Seq[t], binding: Boolean) = new Character_4[A, B, C, D     , t     ](addOne   (dataModel, op, vs, binding)) with CardOne
...
private[dsl] class Character_4_refs[A, B, C, D, t](override val dataModel: DataModel) extends Molecule_04[A, B, C, D] {
...
private[dsl] class Character_5[A, B, C, D, E, t](override val dataModel: DataModel) extends Character_5_refs[A, B, C, D, E, t](dataModel) with Character_base with ModelOps_5[A, B, C, D, E, t, Character_5, Character_6] {
  ...
  override protected def _exprOneMan(op: Op, vs: Seq[t], binding: Boolean) = new Character_5[A, B, C, D, E     , t     ](addOne   (dataModel, op, vs, binding)) with SortAttrs_5[A, B, C, D, E     , t     , Character_5] with CardOne
  ...
  override protected def _exprOneTac(op: Op, vs: Seq[t], binding: Boolean) = new Character_5[A, B, C, D, E     , t     ](addOne   (dataModel, op, vs, binding)) with CardOne
...
private[dsl] class Character_5_refs[A, B, C, D, E, t](override val dataModel: DataModel) extends Molecule_05[A, B, C, D, E] {
...
private[dsl] class Character_6[A, B, C, D, E, F, t](override val dataModel: DataModel) extends Character_6_refs[A, B, C, D, E, F, t](dataModel) with Character_base with ModelOps_6[A, B, C, D, E, F, t, Character_6, X8] {
  ...
  override protected def _exprOneMan(op: Op, vs: Seq[t], binding: Boolean) = new Character_6[A, B, C, D, E, F     , t     ](addOne   (dataModel, op, vs, binding)) with SortAttrs_6[A, B, C, D, E, F     , t     , Character_6] with CardOne
  ...
  override protected def _exprOneTac(op: Op, vs: Seq[t], binding: Boolean) = new Character_6[A, B, C, D, E, F     , t     ](addOne   (dataModel, op, vs, binding)) with CardOne
...
private[dsl] class Character_6_refs[A, B, C, D, E, F, t](override val dataModel: DataModel) extends Molecule_06[A, B, C, D, E, F] {
