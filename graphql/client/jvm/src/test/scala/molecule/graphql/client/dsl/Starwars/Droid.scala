...
class Droid_0[t](override val dataModel: DataModel) extends Droid_0_refs[t](dataModel) with Droid_base with ModelOps_0[t, Droid_0, Droid_1] {
  lazy val id                = new Droid_1[String               , String  ](dataModel.add(id_man             )) with ExprOneMan_1         [String               , String  , Droid_1, Droid_2] with CardOne
  ...
  override protected def _exprOneTac(op: Op, vs: Seq[t]) = new Droid_0[t](addOne(dataModel, op, vs)) with CardOne
