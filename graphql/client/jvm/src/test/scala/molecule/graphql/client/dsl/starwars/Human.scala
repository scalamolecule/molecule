...
class Human_0[t](override val dataModel: DataModel) extends Human_0_refs[t](dataModel) with Human_base with ModelOps_0[t, Human_0, Human_1] {
  lazy val id           = new Human_1[Long               , Long  ](dataModel.add(id_man        )) with ExprOneMan_1         [Long               , Long  , Human_1, Human_2] with CardOne
  ...
  override protected def _exprOneTac(op: Op, vs: Seq[t], binding: Boolean) = new Human_0[t](addOne  (dataModel, op, vs, binding)) with CardOne
...
class Human_1[A, t](override val dataModel: DataModel) extends Human_1_refs[A, t](dataModel) with Human_base with ModelOps_1[A, t, Human_1, Human_2] {
  ...
  override protected def _exprOneMan(op: Op, vs: Seq[t], binding: Boolean) = new Human_1[A     , t     ](addOne   (dataModel, op, vs, binding)) with SortAttrs_1[A     , t     , Human_1] with CardOne
  ...
  override protected def _exprOneTac(op: Op, vs: Seq[t], binding: Boolean) = new Human_1[A     , t     ](addOne   (dataModel, op, vs, binding)) with CardOne
...
class Human_2[A, B, t](override val dataModel: DataModel) extends Human_2_refs[A, B, t](dataModel) with Human_base with ModelOps_2[A, B, t, Human_2, Human_3] {
  ...
  override protected def _exprOneMan(op: Op, vs: Seq[t], binding: Boolean) = new Human_2[A, B     , t     ](addOne   (dataModel, op, vs, binding)) with SortAttrs_2[A, B     , t     , Human_2] with CardOne
  ...
  override protected def _exprOneTac(op: Op, vs: Seq[t], binding: Boolean) = new Human_2[A, B     , t     ](addOne   (dataModel, op, vs, binding)) with CardOne
...
class Human_3[A, B, C, t](override val dataModel: DataModel) extends Human_3_refs[A, B, C, t](dataModel) with Human_base with ModelOps_3[A, B, C, t, Human_3, Human_4] {
  ...
  override protected def _exprOneMan(op: Op, vs: Seq[t], binding: Boolean) = new Human_3[A, B, C     , t     ](addOne   (dataModel, op, vs, binding)) with SortAttrs_3[A, B, C     , t     , Human_3] with CardOne
  ...
  override protected def _exprOneTac(op: Op, vs: Seq[t], binding: Boolean) = new Human_3[A, B, C     , t     ](addOne   (dataModel, op, vs, binding)) with CardOne
...
class Human_4[A, B, C, D, t](override val dataModel: DataModel) extends Human_4_refs[A, B, C, D, t](dataModel) with Human_base with ModelOps_4[A, B, C, D, t, Human_4, Human_5] {
  ...
  override protected def _exprOneMan(op: Op, vs: Seq[t], binding: Boolean) = new Human_4[A, B, C, D     , t     ](addOne   (dataModel, op, vs, binding)) with SortAttrs_4[A, B, C, D     , t     , Human_4] with CardOne
  ...
  override protected def _exprOneTac(op: Op, vs: Seq[t], binding: Boolean) = new Human_4[A, B, C, D     , t     ](addOne   (dataModel, op, vs, binding)) with CardOne
...
class Human_5[A, B, C, D, E, t](override val dataModel: DataModel) extends Human_5_refs[A, B, C, D, E, t](dataModel) with Human_base with ModelOps_5[A, B, C, D, E, t, Human_5, Human_6] {
  ...
  override protected def _exprOneMan(op: Op, vs: Seq[t], binding: Boolean) = new Human_5[A, B, C, D, E     , t     ](addOne   (dataModel, op, vs, binding)) with SortAttrs_5[A, B, C, D, E     , t     , Human_5] with CardOne
  ...
  override protected def _exprOneTac(op: Op, vs: Seq[t], binding: Boolean) = new Human_5[A, B, C, D, E     , t     ](addOne   (dataModel, op, vs, binding)) with CardOne
...
class Human_6[A, B, C, D, E, F, t](override val dataModel: DataModel) extends Human_6_refs[A, B, C, D, E, F, t](dataModel) with Human_base with ModelOps_6[A, B, C, D, E, F, t, Human_6, X8] {
  ...
  override protected def _exprOneMan(op: Op, vs: Seq[t], binding: Boolean) = new Human_6[A, B, C, D, E, F     , t     ](addOne   (dataModel, op, vs, binding)) with SortAttrs_6[A, B, C, D, E, F     , t     , Human_6] with CardOne
  ...
  override protected def _exprOneTac(op: Op, vs: Seq[t], binding: Boolean) = new Human_6[A, B, C, D, E, F     , t     ](addOne   (dataModel, op, vs, binding)) with CardOne
