...
import molecule.graphql.test.dsl.Starwars.*
import molecule.graphql.test.dsl.Starwars.Enums.Episode.*
import molecule.graphql.test.dsl.Starwars.input.InputReview
...
object StarwarsQuery extends StarwarsTest_zio {
  ...
  val a: Review = mutation.createReview(JEDI, InputReview(3, Some("good")))
//  val a: InputReview = Starwars.mutation.createReviex(JEDI, 3, Some("good"))
