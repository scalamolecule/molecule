...
trait Spi_sqlite_zio extends SpiZio with SpiBase_sqlite_zio {
  ...
  override def query_inspect[Tpl](q: Query[Tpl]): ZIO[Conn, MoleculeError, Unit] = {
    async2zio[Unit]((conn: JdbcConn_JS, ec: EC) => Spi_sqlite_async.query_inspect(q)(conn, ec))
  }
  ...
  override def queryOffset_inspect[Tpl](q: QueryOffset[Tpl]): ZIO[Conn, MoleculeError, Unit] = {
    async2zio[Unit]((conn: JdbcConn_JS, ec: EC) => Spi_sqlite_async.queryOffset_inspect(q)(conn, ec))
  }
  ...
  override def save_inspect(save: Save): ZIO[Conn, MoleculeError, Unit] = {
    async2zio[Unit]((conn: JdbcConn_JS, ec: EC) => Spi_sqlite_async.save_inspect(save)(conn, ec))
  }
  ...
  override def insert_inspect(insert: Insert): ZIO[Conn, MoleculeError, Unit] = {
    async2zio[Unit]((conn: JdbcConn_JS, ec: EC) => Spi_sqlite_async.insert_inspect(insert)(conn, ec))
  }
  ...
  override def update_inspect(update: Update): ZIO[Conn, MoleculeError, Unit] = {
    async2zio[Unit]((conn: JdbcConn_JS, ec: EC) => Spi_sqlite_async.update_inspect(update)(conn, ec))
  }
  ...
  override def delete_inspect(delete: Delete): ZIO[Conn, MoleculeError, Unit] = {
    async2zio[Unit]((conn: JdbcConn_JS, ec: EC) => Spi_sqlite_async.delete_inspect(delete)(conn, ec))
  }
