...
import molecule.sql.h2.query.LambdasSet_h2

trait LambdasSet_postgres extends LambdasSet_h2 { self: SqlQueryBase =>
  ...
  //
  //
  //  private lazy val array2setString    : (Row, Int) => Set[String]     = (row: Row, n: Int) => sqlArray2set(row, n, valueString)
  //  private lazy val array2setInt       : (Row, Int) => Set[Int]        = (row: Row, n: Int) => sqlArray2set(row, n, valueInt)
  //  private lazy val array2setLong      : (Row, Int) => Set[Long]       = (row: Row, n: Int) => sqlArray2set(row, n, valueLong)
  //  private lazy val array2setFloat     : (Row, Int) => Set[Float]      = (row: Row, n: Int) => sqlArray2set(row, n, valueFloat)
  //  private lazy val array2setDouble    : (Row, Int) => Set[Double]     = (row: Row, n: Int) => sqlArray2set(row, n, valueDouble)
  //  private lazy val array2setBoolean   : (Row, Int) => Set[Boolean]    = (row: Row, n: Int) => sqlArray2set(row, n, valueBoolean)
  //  private lazy val array2setBigInt    : (Row, Int) => Set[BigInt]     = (row: Row, n: Int) => sqlArray2set(row, n, valueBigInt)
  //  private lazy val array2setBigDecimal: (Row, Int) => Set[BigDecimal] = (row: Row, n: Int) => sqlArray2set(row, n, valueBigDecimal)
  //  private lazy val array2setDate      : (Row, Int) => Set[Date]       = (row: Row, n: Int) => sqlArray2set(row, n, valueDate)
  //  private lazy val array2setUUID      : (Row, Int) => Set[UUID]       = (row: Row, n: Int) => sqlArray2set(row, n, valueUUID)
  //  private lazy val array2setURI       : (Row, Int) => Set[URI]        = (row: Row, n: Int) => sqlArray2set(row, n, valueURI)
  //  private lazy val array2setByte      : (Row, Int) => Set[Byte]       = (row: Row, n: Int) => sqlArray2set(row, n, valueByte)
  //  private lazy val array2setShort     : (Row, Int) => Set[Short]      = (row: Row, n: Int) => sqlArray2set(row, n, valueShort)
  //  private lazy val array2setChar      : (Row, Int) => Set[Char]       = (row: Row, n: Int) => sqlArray2set(row, n, valueChar)
  //
  //
  //  private def sqlNestedArrays2coalescedSet[T](row: Row, n: Int, j2s: Any => T): Set[T] = {
  ...
  //  private lazy val nestedArray2coalescedSetBigDecimal: (Row, Int) => Set[BigDecimal] = (row: Row, n: Int) => sqlNestedArrays2coalescedSet(row, n, j2BigDecimal)
  //  private lazy val nestedArray2coalescedSetDate      : (Row, Int) => Set[Date]       = (row: Row, n: Int) => sqlNestedArrays2coalescedSet(row, n, j2Date)
  //  private lazy val nestedArray2coalescedSetUUID      : (Row, Int) => Set[UUID]       = (row: Row, n: Int) => sqlNestedArrays2coalescedSet(row, n, j2UUID)
  //  private lazy val nestedArray2coalescedSetURI       : (Row, Int) => Set[URI]        = (row: Row, n: Int) => sqlNestedArrays2coalescedSet(row, n, j2String).map(v => new URI(v))
  //  private lazy val nestedArray2coalescedSetByte      : (Row, Int) => Set[Byte]       = (row: Row, n: Int) => sqlNestedArrays2coalescedSet(row, n, j2Byte)
  //  private lazy val nestedArray2coalescedSetShort     : (Row, Int) => Set[Short]      = (row: Row, n: Int) => sqlNestedArrays2coalescedSet(row, n, j2Short)
  //  private lazy val nestedArray2coalescedSetChar      : (Row, Int) => Set[Char]       = (row: Row, n: Int) => sqlNestedArrays2coalescedSet(row, n, j2Char)
  //
  ...
  //  private lazy val nestedArray2setAscBigDecimal: Int => (Row, Int) => Set[BigDecimal] = (size: Int) => (row: Row, n: Int) => sqlNestedArrays2coalescedSet(row, n, j2BigDecimal).toList.sorted.take(size).toSet
  //  private lazy val nestedArray2setAscDate      : Int => (Row, Int) => Set[Date]       = (size: Int) => (row: Row, n: Int) => sqlNestedArrays2coalescedSet(row, n, j2Date).toList.sorted.take(size).toSet
  //  private lazy val nestedArray2setAscUUID      : Int => (Row, Int) => Set[UUID]       = (size: Int) => (row: Row, n: Int) => sqlNestedArrays2coalescedSet(row, n, j2UUID).toList.sorted.take(size).toSet
  //  private lazy val nestedArray2setAscURI       : Int => (Row, Int) => Set[URI]        = (size: Int) => (row: Row, n: Int) => sqlNestedArrays2coalescedSet(row, n, j2String).toList.sorted.take(size).map(s => new URI(s)).toSet
  //  private lazy val nestedArray2setAscByte      : Int => (Row, Int) => Set[Byte]       = (size: Int) => (row: Row, n: Int) => sqlNestedArrays2coalescedSet(row, n, j2Byte).toList.sorted.take(size).toSet
  //  private lazy val nestedArray2setAscShort     : Int => (Row, Int) => Set[Short]      = (size: Int) => (row: Row, n: Int) => sqlNestedArrays2coalescedSet(row, n, j2Short).toList.sorted.take(size).toSet
  //  private lazy val nestedArray2setAscChar      : Int => (Row, Int) => Set[Char]       = (size: Int) => (row: Row, n: Int) => sqlNestedArrays2coalescedSet(row, n, j2Char).toList.sorted.take(size).toSet
  //
  ...
  //  private lazy val nestedArray2setDescBigDecimal: Int => (Row, Int) => Set[BigDecimal] = (size: Int) => (row: Row, n: Int) => sqlNestedArrays2coalescedSet(row, n, j2BigDecimal).toList.sorted.takeRight(size).toSet
  //  private lazy val nestedArray2setDescDate      : Int => (Row, Int) => Set[Date]       = (size: Int) => (row: Row, n: Int) => sqlNestedArrays2coalescedSet(row, n, j2Date).toList.sorted.takeRight(size).toSet
  //  private lazy val nestedArray2setDescUUID      : Int => (Row, Int) => Set[UUID]       = (size: Int) => (row: Row, n: Int) => sqlNestedArrays2coalescedSet(row, n, j2UUID).toList.sorted.takeRight(size).toSet
  //  private lazy val nestedArray2setDescURI       : Int => (Row, Int) => Set[URI]        = (size: Int) => (row: Row, n: Int) => sqlNestedArrays2coalescedSet(row, n, j2String).toList.sorted.takeRight(size).map(s => new URI(s)).toSet
  //  private lazy val nestedArray2setDescByte      : Int => (Row, Int) => Set[Byte]       = (size: Int) => (row: Row, n: Int) => sqlNestedArrays2coalescedSet(row, n, j2Byte).toList.sorted.takeRight(size).toSet
  //  private lazy val nestedArray2setDescShort     : Int => (Row, Int) => Set[Short]      = (size: Int) => (row: Row, n: Int) => sqlNestedArrays2coalescedSet(row, n, j2Short).toList.sorted.takeRight(size).toSet
  //  private lazy val nestedArray2setDescChar      : Int => (Row, Int) => Set[Char]       = (size: Int) => (row: Row, n: Int) => sqlNestedArrays2coalescedSet(row, n, j2Char).toList.sorted.takeRight(size).toSet
  //
  ...
  //  private lazy val nestedArray2nestedSetBigDecimal: (Row, Int) => Set[Set[BigDecimal]] = (row: Row, n: Int) => sqlNestedArrays2nestedSet(row, n, j2BigDecimal)
  //  private lazy val nestedArray2nestedSetDate      : (Row, Int) => Set[Set[Date]]       = (row: Row, n: Int) => sqlNestedArrays2nestedSet(row, n, j2Date)
  //  private lazy val nestedArray2nestedSetUUID      : (Row, Int) => Set[Set[UUID]]       = (row: Row, n: Int) => sqlNestedArrays2nestedSet(row, n, j2UUID)
  //  private lazy val nestedArray2nestedSetURI       : (Row, Int) => Set[Set[URI]]        = (row: Row, n: Int) => sqlNestedArrays2nestedSet(row, n, (v: Any) => new URI(j2String(v)))
  //  private lazy val nestedArray2nestedSetByte      : (Row, Int) => Set[Set[Byte]]       = (row: Row, n: Int) => sqlNestedArrays2nestedSet(row, n, j2Byte)
  //  private lazy val nestedArray2nestedSetShort     : (Row, Int) => Set[Set[Short]]      = (row: Row, n: Int) => sqlNestedArrays2nestedSet(row, n, j2Short)
  //  private lazy val nestedArray2nestedSetChar      : (Row, Int) => Set[Set[Char]]       = (row: Row, n: Int) => sqlNestedArrays2nestedSet(row, n, j2Char)
  //
  //
