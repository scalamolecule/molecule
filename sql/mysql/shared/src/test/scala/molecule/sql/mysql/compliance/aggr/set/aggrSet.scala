...
object AggrSet_Duration extends AggrSet_Duration_ with TestAsync_mysql
object AggrSet_Instant extends AggrSet_Instant_ with TestAsync_mysql
object AggrSet_LocalDate extends AggrSet_LocalDate_ with TestAsync_mysql
object AggrSet_LocalTime extends AggrSet_LocalTime_ with TestAsync_mysql
object AggrSet_LocalDateTime extends AggrSet_LocalDateTime_ with TestAsync_mysql
object AggrSet_OffsetTime extends AggrSet_OffsetTime_ with TestAsync_mysql
object AggrSet_OffsetDateTime extends AggrSet_OffsetDateTime_ with TestAsync_mysql
object AggrSet_ZonedDateTime extends AggrSet_ZonedDateTime_ with TestAsync_mysql
