...
import molecule.sql.core.api.SqlApiSync
import molecule.sql.core.facade.SqlConn_JVM
import molecule.sql.core.query.cursorStrategy.CursorUtils
import scala.annotation.tailrec
import scala.collection.mutable.ListBuffer


abstract class SqlQueryResolve[Tpl](elements: List[Element], dbView: Option[DbView])
  extends SqlModel2Query[Tpl](elements) with SqlApiSync with CursorUtils {
