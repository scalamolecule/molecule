...
object CastTpl2_ extends SqlQueryBase {
  ...
  final def tupleCaster(casts: List[Cast], firstIndex: ParamIndex): RS => Any = {
    casts.length match {
      ...
      //      case 4  => cast4(casters, i)
      //      case 5  => cast5(casters, i)
      //      case 6  => cast6(casters, i)
      //      case 7  => cast7(casters, i)
      //      case 8  => cast8(casters, i)
      //      case 9  => cast9(casters, i)
      //      case 10 => cast10(casters, i)
      //      case 11 => cast11(casters, i)
      //      case 12 => cast12(casters, i)
      //      case 13 => cast13(casters, i)
      //      case 14 => cast14(casters, i)
      //      case 15 => cast15(casters, i)
      //      case 16 => cast16(casters, i)
      //      case 17 => cast17(casters, i)
      //      case 18 => cast18(casters, i)
      //      case 19 => cast19(casters, i)
      //      case 20 => cast20(casters, i)
      //      case 21 => cast21(casters, i)
      //      case 22 => cast22(casters, i)
    }
  }
  ...
  final private def cast1(casters: List[(RS, ParamIndex) => Any], firstIndex: ParamIndex): RS => Any = {
    val List(c1) = casters
    (row: RS) => {
      println(s"CastTpl2_  $firstIndex  " + c1(row, firstIndex))
      c1(row, firstIndex)
    }
  }
