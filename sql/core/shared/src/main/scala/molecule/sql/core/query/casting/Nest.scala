...
//
////  private lazy val rowIndexTx                             = row.getMetaData.getColumnCount - txAttrs
//  private lazy val rowIndexTx                             = row.size() - txAttrs
//  private lazy val tplBranch0: (RowOLD, List[Any]) => Tpl = castBranch[Tpl](aritiess(0), castss(0), i0, rowIndexTx)
//  private lazy val tplBranch1: (RowOLD, List[Any]) => Any = castBranch[Any](aritiess(1), castss(1), i1, 0)
//  private lazy val tplBranch2: (RowOLD, List[Any]) => Any = castBranch[Any](aritiess(2), castss(2), i2, 0)
//  private lazy val tplBranch3: (RowOLD, List[Any]) => Any = castBranch[Any](aritiess(3), castss(3), i3, 0)
//  private lazy val tplBranch4: (RowOLD, List[Any]) => Any = castBranch[Any](aritiess(4), castss(4), i4, 0)
//  private lazy val tplBranch5: (RowOLD, List[Any]) => Any = castBranch[Any](aritiess(5), castss(5), i5, 0)
//  private lazy val tplBranch6: (RowOLD, List[Any]) => Any = castBranch[Any](aritiess(6), castss(6), i6, 0)
//
//  private lazy val tplLeaf1: RowOLD => Any = castRow2AnyTpl(aritiess(1), castss(1), i1, None)
//  private lazy val tplLeaf2: RowOLD => Any = castRow2AnyTpl(aritiess(2), castss(2), i2, None)
//  private lazy val tplLeaf3: RowOLD => Any = castRow2AnyTpl(aritiess(3), castss(3), i3, None)
//  private lazy val tplLeaf4: RowOLD => Any = castRow2AnyTpl(aritiess(4), castss(4), i4, None)
//  private lazy val tplLeaf5: RowOLD => Any = castRow2AnyTpl(aritiess(5), castss(5), i5, None)
//  private lazy val tplLeaf6: RowOLD => Any = castRow2AnyTpl(aritiess(6), castss(6), i6, None)
//  private lazy val tplLeaf7: RowOLD => Any = castRow2AnyTpl(aritiess(7), castss(7), i7, None)
//
...
//
//
//  final protected def rows2nested(rows: jArrayList[RowOLD]): List[Tpl] = {
//    nestedLevels match {
...
//  }
//
//  final private def rows2nested1(rows: jArrayList[RowOLD]): List[Tpl] = {
//    if (rows.size == 1) {
//      row = rows.get(0)
//      List(tplBranch0(row,
//        List(tplLeaf1(row))))
...
//
//
//  final private def rows2nested2(rows: jArrayList[RowOLD]): List[Tpl] = {
//    if (rows.size == 1) {
//      row = rows.get(0)
//      List(tplBranch0(row,
//        List(tplBranch1(row,
...
//
//
//  final private def rows2nested3(rows: jArrayList[RowOLD]): List[Tpl] = {
//    if (rows.size == 1) {
//      row = rows.get(0)
//      List(tplBranch0(row,
//        List(tplBranch1(row,
...
//
//
//  final private def rows2nested4(rows: jArrayList[RowOLD]): List[Tpl] = {
//    if (rows.size == 1) {
//      row = rows.get(0)
//      List(tplBranch0(row,
//        List(tplBranch1(row,
...
//
//
//  final private def rows2nested5(rows: jArrayList[RowOLD]): List[Tpl] = {
//    if (rows.size == 1) {
//      row = rows.get(0)
//      List(tplBranch0(row,
//        List(tplBranch1(row,
...
//
//
//  final private def rows2nested6(rows: jArrayList[RowOLD]): List[Tpl] = {
//    if (rows.size == 1) {
//      row = rows.get(0)
//      List(tplBranch0(row,
//        List(tplBranch1(row,
...
//  }
//
//  final private def rows2nested7(rows: jArrayList[RowOLD]): List[Tpl] = {
//    if (rows.size() == 1) {
//      row = rows.get(0)
//      List(tplBranch0(row,
//        List(tplBranch1(row,
