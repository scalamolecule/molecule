...
trait LambdasOne extends LambdasBase { self: SqlQueryBase =>
  ...
  protected lazy val sql2oneStringOrNull    : (Row, Int) => Any = { (row: Row, n: Int) => val v = row.getString(n); if (row.wasNull()) null else v }
  protected lazy val sql2oneIntOrNull       : (Row, Int) => Any = { (row: Row, n: Int) => val v = row.getInt(n); if (row.wasNull()) null else v }
  protected lazy val sql2oneLongOrNull      : (Row, Int) => Any = { (row: Row, n: Int) => val v = row.getLong(n); if (row.wasNull()) null else v }
  protected lazy val sql2oneFloatOrNull     : (Row, Int) => Any = { (row: Row, n: Int) => val v = row.getFloat(n); if (row.wasNull()) null else v }
  protected lazy val sql2oneDoubleOrNull    : (Row, Int) => Any = { (row: Row, n: Int) => val v = row.getDouble(n); if (row.wasNull()) null else v }
  protected lazy val sql2oneBooleanOrNull   : (Row, Int) => Any = { (row: Row, n: Int) => val v = row.getBoolean(n); if (row.wasNull()) null else v }
  protected lazy val sql2oneBigIntOrNull    : (Row, Int) => Any = { (row: Row, n: Int) => val v = row.getBigDecimal(n); if (row.wasNull()) null else BigInt(v.toBigInteger) }
  protected lazy val sql2oneBigDecimalOrNull: (Row, Int) => Any = { (row: Row, n: Int) => val v = row.getBigDecimal(n); if (row.wasNull()) null else BigDecimal(v) }
  protected lazy val sql2oneDateOrNull      : (Row, Int) => Any = { (row: Row, n: Int) => val v = row.getDate(n); if (row.wasNull()) null else v }
  protected lazy val sql2oneUUIDOrNull      : (Row, Int) => Any = { (row: Row, n: Int) => val v = row.getString(n); if (row.wasNull()) null else UUID.fromString(v) }
  protected lazy val sql2oneURIOrNull       : (Row, Int) => Any = { (row: Row, n: Int) => val v = row.getString(n); if (row.wasNull()) null else new URI(v) }
  protected lazy val sql2oneByteOrNull      : (Row, Int) => Any = { (row: Row, n: Int) => val v = row.getByte(n); if (row.wasNull()) null else v }
