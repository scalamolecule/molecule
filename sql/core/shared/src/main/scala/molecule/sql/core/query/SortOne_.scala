...
trait SortOne_[Tpl] { self: SqlModel2Query[Tpl] =>

  protected def sortOneString(attr: Attr, attrIndex: Int): Option[(Int, Int => (RowOLD, RowOLD) => Int)] = {
    attr.sort.map { sort =>
      (
  ...
  protected def sortOneInt(attr: Attr, attrIndex: Int): Option[(Int, Int => (RowOLD, RowOLD) => Int)] = {
    attr.sort.map { sort =>
      (
        sort.last.toString.toInt,
        sort.head match {
  ...
  protected def sortOneLong(attr: Attr, attrIndex: Int): Option[(Int, Int => (RowOLD, RowOLD) => Int)] = {
    attr.sort.map { sort =>
      (
        sort.last.toString.toInt,
        sort.head match {
  ...
  protected def sortOneFloat(attr: Attr, attrIndex: Int): Option[(Int, Int => (RowOLD, RowOLD) => Int)] = {
    attr.sort.map { sort =>
      (
        sort.last.toString.toInt,
        sort.head match {
  ...
  protected def sortOneDouble(attr: Attr, attrIndex: Int): Option[(Int, Int => (RowOLD, RowOLD) => Int)] = {
    attr.sort.map { sort =>
      (
        sort.last.toString.toInt,
        sort.head match {
  ...
  protected def sortOneBoolean(attr: Attr, attrIndex: Int): Option[(Int, Int => (RowOLD, RowOLD) => Int)] = {
    attr.sort.map { sort =>
      (
        sort.last.toString.toInt,
        sort.head match {
  ...
  protected def sortOneBigInt(attr: Attr, attrIndex: Int): Option[(Int, Int => (RowOLD, RowOLD) => Int)] = {
    attr.sort.map { sort =>
      (
        sort.last.toString.toInt,
        sort.head match {
  ...
  protected def sortOneBigDecimal(attr: Attr, attrIndex: Int): Option[(Int, Int => (RowOLD, RowOLD) => Int)] = {
    attr.sort.map { sort =>
      (
        sort.last.toString.toInt,
        sort.head match {
  ...
  protected def sortOneDate(attr: Attr, attrIndex: Int): Option[(Int, Int => (RowOLD, RowOLD) => Int)] = {
    attr.sort.map { sort =>
      (
        sort.last.toString.toInt,
        sort.head match {
  ...
  protected def sortOneUUID(attr: Attr, attrIndex: Int): Option[(Int, Int => (RowOLD, RowOLD) => Int)] = {
    attr.sort.map { sort =>
      (
        sort.last.toString.toInt,
        sort.head match {
  ...
  protected def sortOneURI(attr: Attr, attrIndex: Int): Option[(Int, Int => (RowOLD, RowOLD) => Int)] = {
    attr.sort.map { sort =>
      (
        sort.last.toString.toInt,
        sort.head match {
  ...
  protected def sortOneByte(attr: Attr, attrIndex: Int): Option[(Int, Int => (RowOLD, RowOLD) => Int)] = {
    attr.sort.map { sort =>
      (
        sort.last.toString.toInt,
        sort.head match {
  ...
  protected def sortOneShort(attr: Attr, attrIndex: Int): Option[(Int, Int => (RowOLD, RowOLD) => Int)] = {
    attr.sort.map { sort =>
      (
        sort.last.toString.toInt,
        sort.head match {
  ...
  protected def sortOneChar(attr: Attr, attrIndex: Int): Option[(Int, Int => (RowOLD, RowOLD) => Int)] = {
    attr.sort.map { sort =>
      (
        sort.last.toString.toInt,
        sort.head match {
