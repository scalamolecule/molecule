...
trait LambdasMap extends LambdasBase with JavaConversions { self: SqlQueryBase =>
  ...
  lazy val resMapId            : ResMap[String]         = ResMap("String", tpeDbId, one2jsonId, sqlJson2mapId) //, null, set2sqlArrayId, set2sqlsId, one2sqlId, array2setId, nestedArray2coalescedSetId, nestedArray2optCoalescedSetId, nestedArray2nestedSetId, array2setFirstId, array2setLastId, nestedArray2setAscId, nestedArray2setDescId, nestedArray2sumId, json2oneId, json2arrayId, json2optArrayId, stringArray2sumId, valueId, sqlArray2sumId, sqlArray2minNId, sqlArray2maxNId, array2optSetId)
  lazy val resMapString        : ResMap[String]         = ResMap("String", tpeDbString, one2jsonString, sqlJson2mapString) //, null, set2sqlArrayString, set2sqlsString, one2sqlString, array2setString, nestedArray2coalescedSetString, nestedArray2optCoalescedSetString, nestedArray2nestedSetString, array2setFirstString, array2setLastString, nestedArray2setAscString, nestedArray2setDescString, nestedArray2sumString, json2oneString, json2arrayString, json2optArrayString, stringArray2sumString, valueString, sqlArray2sumString, sqlArray2minNString, sqlArray2maxNString, array2optSetString)
  lazy val resMapInt           : ResMap[Int]            = ResMap("Int", tpeDbInt, one2jsonInt, sqlJson2mapInt) //, null, set2sqlArrayInt, set2sqlsInt, one2sqlInt, array2setInt, nestedArray2coalescedSetInt, nestedArray2optCoalescedSetInt, nestedArray2nestedSetInt, array2setFirstInt, array2setLastInt, nestedArray2setAscInt, nestedArray2setDescInt, nestedArray2sumInt, json2oneInt, json2arrayInt, json2optArrayInt, stringArray2sumInt, valueInt, sqlArray2sumInt, sqlArray2minNInt, sqlArray2maxNInt, array2optSetInt)
  lazy val resMapLong          : ResMap[Long]           = ResMap("Long", tpeDbLong, one2jsonLong, sqlJson2mapLong) //, null, set2sqlArrayLong, set2sqlsLong, one2sqlLong, array2setLong, nestedArray2coalescedSetLong, nestedArray2optCoalescedSetLong, nestedArray2nestedSetLong, array2setFirstLong, array2setLastLong, nestedArray2setAscLong, nestedArray2setDescLong, nestedArray2sumLong, json2oneLong, json2arrayLong, json2optArrayLong, stringArray2sumLong, valueLong, sqlArray2sumLong, sqlArray2minNLong, sqlArray2maxNLong, array2optSetLong)
  lazy val resMapFloat         : ResMap[Float]          = ResMap("Float", tpeDbFloat, one2jsonFloat, sqlJson2mapFloat) //, null, set2sqlArrayFloat, set2sqlsFloat, one2sqlFloat, array2setFloat, nestedArray2coalescedSetFloat, nestedArray2optCoalescedSetFloat, nestedArray2nestedSetFloat, array2setFirstFloat, array2setLastFloat, nestedArray2setAscFloat, nestedArray2setDescFloat, nestedArray2sumFloat, json2oneFloat, json2arrayFloat, json2optArrayFloat, stringArray2sumFloat, valueFloat, sqlArray2sumFloat, sqlArray2minNFloat, sqlArray2maxNFloat, array2optSetFloat)
  lazy val resMapDouble        : ResMap[Double]         = ResMap("Double", tpeDbDouble, one2jsonDouble, sqlJson2mapDouble) //, null, set2sqlArrayDouble, set2sqlsDouble, one2sqlDouble, array2setDouble, nestedArray2coalescedSetDouble, nestedArray2optCoalescedSetDouble, nestedArray2nestedSetDouble, array2setFirstDouble, array2setLastDouble, nestedArray2setAscDouble, nestedArray2setDescDouble, nestedArray2sumDouble, json2oneDouble, json2arrayDouble, json2optArrayDouble, stringArray2sumDouble, valueDouble, sqlArray2sumDouble, sqlArray2minNDouble, sqlArray2maxNDouble, array2optSetDouble)
  lazy val resMapBoolean       : ResMap[Boolean]        = ResMap("Boolean", tpeDbBoolean, one2jsonBoolean, sqlJson2mapBoolean) //, null, set2sqlArrayBoolean, set2sqlsBoolean, one2sqlBoolean, array2setBoolean, nestedArray2coalescedSetBoolean, nestedArray2optCoalescedSetBoolean, nestedArray2nestedSetBoolean, array2setFirstBoolean, array2setLastBoolean, nestedArray2setAscBoolean, nestedArray2setDescBoolean, nestedArray2sumBoolean, json2oneBoolean, json2arrayBoolean, json2optArrayBoolean, stringArray2sumBoolean, valueBoolean, sqlArray2sumBoolean, sqlArray2minNBoolean, sqlArray2maxNBoolean, array2optSetBoolean)
  lazy val resMapBigInt        : ResMap[BigInt]         = ResMap("BigInt", tpeDbBigInt, one2jsonBigInt, sqlJson2mapBigInt) //, null, set2sqlArrayBigInt, set2sqlsBigInt, one2sqlBigInt, array2setBigInt, nestedArray2coalescedSetBigInt, nestedArray2optCoalescedSetBigInt, nestedArray2nestedSetBigInt, array2setFirstBigInt, array2setLastBigInt, nestedArray2setAscBigInt, nestedArray2setDescBigInt, nestedArray2sumBigInt, json2oneBigInt, json2arrayBigInt, json2optArrayBigInt, stringArray2sumBigInt, valueBigInt, sqlArray2sumBigInt, sqlArray2minNBigInt, sqlArray2maxNBigInt, array2optSetBigInt)
  lazy val resMapBigDecimal    : ResMap[BigDecimal]     = ResMap("BigDecimal", tpeDbBigDecimal, one2jsonBigDecimal, sqlJson2mapBigDecimal) //, null, set2sqlArrayBigDecimal, set2sqlsBigDecimal, one2sqlBigDecimal, array2setBigDecimal, nestedArray2coalescedSetBigDecimal, nestedArray2optCoalescedSetBigDecimal, nestedArray2nestedSetBigDecimal, array2setFirstBigDecimal, array2setLastBigDecimal, nestedArray2setAscBigDecimal, nestedArray2setDescBigDecimal, nestedArray2sumBigDecimal, json2oneBigDecimal, json2arrayBigDecimal, json2optArrayBigDecimal, stringArray2sumBigDecimal, valueBigDecimal, sqlArray2sumBigDecimal, sqlArray2minNBigDecimal, sqlArray2maxNBigDecimal, array2optSetBigDecimal)
  lazy val resMapDate          : ResMap[Date]           = ResMap("Date", tpeDbDate, one2jsonDate, sqlJson2mapDate) //, null, set2sqlArrayDate, set2sqlsDate, one2sqlDate, array2setDate, nestedArray2coalescedSetDate, nestedArray2optCoalescedSetDate, nestedArray2nestedSetDate, array2setFirstDate, array2setLastDate, nestedArray2setAscDate, nestedArray2setDescDate, nestedArray2sumDate, json2oneDate, json2arrayDate, json2optArrayDate, stringArray2sumDate, valueDate, sqlArray2sumDate, sqlArray2minNDate, sqlArray2maxNDate, array2optSetDate)
  lazy val resMapDuration      : ResMap[Duration]       = ResMap("Duration", tpeDbDuration, one2jsonDuration, sqlJson2mapDuration) //, null, set2sqlArrayDuration, set2sqlsDuration, one2sqlDuration, array2setDuration, nestedArray2coalescedSetDuration, nestedArray2optCoalescedSetDuration, nestedArray2nestedSetDuration, array2setFirstDuration, array2setLastDuration, nestedArray2setAscDuration, nestedArray2setDescDuration, nestedArray2sumDuration, json2oneDuration, json2arrayDuration, json2optArrayDuration, stringArray2sumDuration, valueDuration, sqlArray2sumDuration, sqlArray2minNDuration, sqlArray2maxNDuration, array2optSetDuration)
  lazy val resMapInstant       : ResMap[Instant]        = ResMap("Instant", tpeDbInstant, one2jsonInstant, sqlJson2mapInstant) //, null, set2sqlArrayInstant, set2sqlsInstant, one2sqlInstant, array2setInstant, nestedArray2coalescedSetInstant, nestedArray2optCoalescedSetInstant, nestedArray2nestedSetInstant, array2setFirstInstant, array2setLastInstant, nestedArray2setAscInstant, nestedArray2setDescInstant, nestedArray2sumInstant, json2oneInstant, json2arrayInstant, json2optArrayInstant, stringArray2sumInstant, valueInstant, sqlArray2sumInstant, sqlArray2minNInstant, sqlArray2maxNInstant, array2optSetInstant)
  lazy val resMapLocalDate     : ResMap[LocalDate]      = ResMap("LocalDate", tpeDbLocalDate, one2jsonLocalDate, sqlJson2mapLocalDate) //, null, set2sqlArrayLocalDate, set2sqlsLocalDate, one2sqlLocalDate, array2setLocalDate, nestedArray2coalescedSetLocalDate, nestedArray2optCoalescedSetLocalDate, nestedArray2nestedSetLocalDate, array2setFirstLocalDate, array2setLastLocalDate, nestedArray2setAscLocalDate, nestedArray2setDescLocalDate, nestedArray2sumLocalDate, json2oneLocalDate, json2arrayLocalDate, json2optArrayLocalDate, stringArray2sumLocalDate, valueLocalDate, sqlArray2sumLocalDate, sqlArray2minNLocalDate, sqlArray2maxNLocalDate, array2optSetLocalDate)
  lazy val resMapLocalTime     : ResMap[LocalTime]      = ResMap("LocalTime", tpeDbLocalTime, one2jsonLocalTime, sqlJson2mapLocalTime) //, null, set2sqlArrayLocalTime, set2sqlsLocalTime, one2sqlLocalTime, array2setLocalTime, nestedArray2coalescedSetLocalTime, nestedArray2optCoalescedSetLocalTime, nestedArray2nestedSetLocalTime, array2setFirstLocalTime, array2setLastLocalTime, nestedArray2setAscLocalTime, nestedArray2setDescLocalTime, nestedArray2sumLocalTime, json2oneLocalTime, json2arrayLocalTime, json2optArrayLocalTime, stringArray2sumLocalTime, valueLocalTime, sqlArray2sumLocalTime, sqlArray2minNLocalTime, sqlArray2maxNLocalTime, array2optSetLocalTime)
  lazy val resMapLocalDateTime : ResMap[LocalDateTime]  = ResMap("LocalDateTime", tpeDbLocalDateTime, one2jsonLocalDateTime, sqlJson2mapLocalDateTime) //, null, set2sqlArrayLocalDateTime, set2sqlsLocalDateTime, one2sqlLocalDateTime, array2setLocalDateTime, nestedArray2coalescedSetLocalDateTime, nestedArray2optCoalescedSetLocalDateTime, nestedArray2nestedSetLocalDateTime, array2setFirstLocalDateTime, array2setLastLocalDateTime, nestedArray2setAscLocalDateTime, nestedArray2setDescLocalDateTime, nestedArray2sumLocalDateTime, json2oneLocalDateTime, json2arrayLocalDateTime, json2optArrayLocalDateTime, stringArray2sumLocalDateTime, valueLocalDateTime, sqlArray2sumLocalDateTime, sqlArray2minNLocalDateTime, sqlArray2maxNLocalDateTime, array2optSetLocalDateTime)
  lazy val resMapOffsetTime    : ResMap[OffsetTime]     = ResMap("OffsetTime", tpeDbOffsetTime, one2jsonOffsetTime, sqlJson2mapOffsetTime) //, null, set2sqlArrayOffsetTime, set2sqlsOffsetTime, one2sqlOffsetTime, array2setOffsetTime, nestedArray2coalescedSetOffsetTime, nestedArray2optCoalescedSetOffsetTime, nestedArray2nestedSetOffsetTime, array2setFirstOffsetTime, array2setLastOffsetTime, nestedArray2setAscOffsetTime, nestedArray2setDescOffsetTime, nestedArray2sumOffsetTime, json2oneOffsetTime, json2arrayOffsetTime, json2optArrayOffsetTime, stringArray2sumOffsetTime, valueOffsetTime, sqlArray2sumOffsetTime, sqlArray2minNOffsetTime, sqlArray2maxNOffsetTime, array2optSetOffsetTime)
  lazy val resMapOffsetDateTime: ResMap[OffsetDateTime] = ResMap("OffsetDateTime", tpeDbOffsetDateTime, one2jsonOffsetDateTime, sqlJson2mapOffsetDateTime) //, null, set2sqlArrayOffsetDateTime, set2sqlsOffsetDateTime, one2sqlOffsetDateTime, array2setOffsetDateTime, nestedArray2coalescedSetOffsetDateTime, nestedArray2optCoalescedSetOffsetDateTime, nestedArray2nestedSetOffsetDateTime, array2setFirstOffsetDateTime, array2setLastOffsetDateTime, nestedArray2setAscOffsetDateTime, nestedArray2setDescOffsetDateTime, nestedArray2sumOffsetDateTime, json2oneOffsetDateTime, json2arrayOffsetDateTime, json2optArrayOffsetDateTime, stringArray2sumOffsetDateTime, valueOffsetDateTime, sqlArray2sumOffsetDateTime, sqlArray2minNOffsetDateTime, sqlArray2maxNOffsetDateTime, array2optSetOffsetDateTime)
  lazy val resMapZonedDateTime : ResMap[ZonedDateTime]  = ResMap("ZonedDateTime", tpeDbZonedDateTime, one2jsonZonedDateTime, sqlJson2mapZonedDateTime) //, null, set2sqlArrayZonedDateTime, set2sqlsZonedDateTime, one2sqlZonedDateTime, array2setZonedDateTime, nestedArray2coalescedSetZonedDateTime, nestedArray2optCoalescedSetZonedDateTime, nestedArray2nestedSetZonedDateTime, array2setFirstZonedDateTime, array2setLastZonedDateTime, nestedArray2setAscZonedDateTime, nestedArray2setDescZonedDateTime, nestedArray2sumZonedDateTime, json2oneZonedDateTime, json2arrayZonedDateTime, json2optArrayZonedDateTime, stringArray2sumZonedDateTime, valueZonedDateTime, sqlArray2sumZonedDateTime, sqlArray2minNZonedDateTime, sqlArray2maxNZonedDateTime, array2optSetZonedDateTime)
  lazy val resMapUUID          : ResMap[UUID]           = ResMap("UUID", tpeDbUUID, one2jsonUUID, sqlJson2mapUUID) //, null, set2sqlArrayUUID, set2sqlsUUID, one2sqlUUID, array2setUUID, nestedArray2coalescedSetUUID, nestedArray2optCoalescedSetUUID, nestedArray2nestedSetUUID, array2setFirstUUID, array2setLastUUID, nestedArray2setAscUUID, nestedArray2setDescUUID, nestedArray2sumUUID, json2oneUUID, json2arrayUUID, json2optArrayUUID, stringArray2sumUUID, valueUUID, sqlArray2sumUUID, sqlArray2minNUUID, sqlArray2maxNUUID, array2optSetUUID)
  lazy val resMapURI           : ResMap[URI]            = ResMap("URI", tpeDbURI, one2jsonURI, sqlJson2mapURI) //, null, set2sqlArrayURI, set2sqlsURI, one2sqlURI, array2setURI, nestedArray2coalescedSetURI, nestedArray2optCoalescedSetURI, nestedArray2nestedSetURI, array2setFirstURI, array2setLastURI, nestedArray2setAscURI, nestedArray2setDescURI, nestedArray2sumURI, json2oneURI, json2arrayURI, json2optArrayURI, stringArray2sumURI, valueURI, sqlArray2sumURI, sqlArray2minNURI, sqlArray2maxNURI, array2optSetURI)
  lazy val resMapByte          : ResMap[Byte]           = ResMap("Byte", tpeDbByte, one2jsonByte, sqlJson2mapByte) //, null, set2sqlArrayByte, set2sqlsByte, one2sqlByte, array2setByte, nestedArray2coalescedSetByte, nestedArray2optCoalescedSetByte, nestedArray2nestedSetByte, array2setFirstByte, array2setLastByte, nestedArray2setAscByte, nestedArray2setDescByte, nestedArray2sumByte, json2oneByte, json2arrayByte, json2optArrayByte, stringArray2sumByte, valueByte, sqlArray2sumByte, sqlArray2minNByte, sqlArray2maxNByte, array2optSetByte)
  lazy val resMapShort         : ResMap[Short]          = ResMap("Short", tpeDbShort, one2jsonShort, sqlJson2mapShort) //, null, set2sqlArrayShort, set2sqlsShort, one2sqlShort, array2setShort, nestedArray2coalescedSetShort, nestedArray2optCoalescedSetShort, nestedArray2nestedSetShort, array2setFirstShort, array2setLastShort, nestedArray2setAscShort, nestedArray2setDescShort, nestedArray2sumShort, json2oneShort, json2arrayShort, json2optArrayShort, stringArray2sumShort, valueShort, sqlArray2sumShort, sqlArray2minNShort, sqlArray2maxNShort, array2optSetShort)
  lazy val resMapChar          : ResMap[Char]           = ResMap("Char", tpeDbChar, one2jsonChar, sqlJson2mapChar) //, null, set2sqlArrayChar, set2sqlsChar, one2sqlChar, array2setChar, nestedArray2coalescedSetChar, nestedArray2optCoalescedSetChar, nestedArray2nestedSetChar, array2setFirstChar, array2setLastChar, nestedArray2setAscChar, nestedArray2setDescChar, nestedArray2sumChar, json2oneChar, json2arrayChar, json2optArrayChar, stringArray2sumChar, valueChar, sqlArray2sumChar, sqlArray2minNChar, sqlArray2maxNChar, array2optSetChar)
  ...
  private lazy val json2mapDate          : String => Map[String, Date]           = (json: String) => upickle.default.read[Map[String, Long]](json).map { case (k, v) => k -> new Date(v.toLong) }
  ...
  case class ResMapOpt[T](
    tpe: String,
    sql2mapOpt: (RS, ParamIndex) => Option[Map[String, T]],
  ...
  lazy val resOptMapId            : ResMapOpt[String]         = ResMapOpt("String", sql2setOptId) //, set2sqlArrayId, set2sqlsId, one2sqlId, one2jsonId)
  lazy val resOptMapString        : ResMapOpt[String]         = ResMapOpt("String", sql2setOptString) //, set2sqlArrayString, set2sqlsString, one2sqlString, one2jsonString)
  lazy val resOptMapInt           : ResMapOpt[Int]            = ResMapOpt("Int", sql2setOptInt) //, set2sqlArrayInt, set2sqlsInt, one2sqlInt, one2jsonInt)
  lazy val resOptMapLong          : ResMapOpt[Long]           = ResMapOpt("Long", sql2setOptLong) //, set2sqlArrayLong, set2sqlsLong, one2sqlLong, one2jsonLong)
  lazy val resOptMapFloat         : ResMapOpt[Float]          = ResMapOpt("Float", sql2setOptFloat) //, set2sqlArrayFloat, set2sqlsFloat, one2sqlFloat, one2jsonFloat)
  lazy val resOptMapDouble        : ResMapOpt[Double]         = ResMapOpt("Double", sql2setOptDouble) //, set2sqlArrayDouble, set2sqlsDouble, one2sqlDouble, one2jsonDouble)
  lazy val resOptMapBoolean       : ResMapOpt[Boolean]        = ResMapOpt("Boolean", sql2setOptBoolean) //, set2sqlArrayBoolean, set2sqlsBoolean, one2sqlBoolean, one2jsonBoolean)
  lazy val resOptMapBigInt        : ResMapOpt[BigInt]         = ResMapOpt("BigInt", sql2setOptBigInt) //, set2sqlArrayBigInt, set2sqlsBigInt, one2sqlBigInt, one2jsonBigInt)
  lazy val resOptMapBigDecimal    : ResMapOpt[BigDecimal]     = ResMapOpt("BigDecimal", sql2setOptBigDecimal) //, set2sqlArrayBigDecimal, set2sqlsBigDecimal, one2sqlBigDecimal, one2jsonBigDecimal)
  lazy val resOptMapDate          : ResMapOpt[Date]           = ResMapOpt("Date", sql2setOptDate) //, set2sqlArrayDate, set2sqlsDate, one2sqlDate, one2jsonDate)
  lazy val resOptMapDuration      : ResMapOpt[Duration]       = ResMapOpt("Duration", sql2setOptDuration) //, set2sqlArrayDuration, set2sqlsDuration, one2sqlDuration, one2jsonDuration)
  lazy val resOptMapInstant       : ResMapOpt[Instant]        = ResMapOpt("Instant", sql2setOptInstant) //, set2sqlArrayInstant, set2sqlsInstant, one2sqlInstant, one2jsonInstant)
  lazy val resOptMapLocalDate     : ResMapOpt[LocalDate]      = ResMapOpt("LocalDate", sql2setOptLocalDate) //, set2sqlArrayLocalDate, set2sqlsLocalDate, one2sqlLocalDate, one2jsonLocalDate)
  lazy val resOptMapLocalTime     : ResMapOpt[LocalTime]      = ResMapOpt("LocalTime", sql2setOptLocalTime) //, set2sqlArrayLocalTime, set2sqlsLocalTime, one2sqlLocalTime, one2jsonLocalTime)
  lazy val resOptMapLocalDateTime : ResMapOpt[LocalDateTime]  = ResMapOpt("LocalDateTime", sql2setOptLocalDateTime) //, set2sqlArrayLocalDateTime, set2sqlsLocalDateTime, one2sqlLocalDateTime, one2jsonLocalDateTime)
  lazy val resOptMapOffsetTime    : ResMapOpt[OffsetTime]     = ResMapOpt("OffsetTime", sql2setOptOffsetTime) //, set2sqlArrayOffsetTime, set2sqlsOffsetTime, one2sqlOffsetTime, one2jsonOffsetTime)
  lazy val resOptMapOffsetDateTime: ResMapOpt[OffsetDateTime] = ResMapOpt("OffsetDateTime", sql2setOptOffsetDateTime) //, set2sqlArrayOffsetDateTime, set2sqlsOffsetDateTime, one2sqlOffsetDateTime, one2jsonOffsetDateTime)
  lazy val resOptMapZonedDateTime : ResMapOpt[ZonedDateTime]  = ResMapOpt("ZonedDateTime", sql2setOptZonedDateTime) //, set2sqlArrayZonedDateTime, set2sqlsZonedDateTime, one2sqlZonedDateTime, one2jsonZonedDateTime)
  lazy val resOptMapUUID          : ResMapOpt[UUID]           = ResMapOpt("UUID", sql2setOptUUID) //, set2sqlArrayUUID, set2sqlsUUID, one2sqlUUID, one2jsonUUID)
  lazy val resOptMapURI           : ResMapOpt[URI]            = ResMapOpt("URI", sql2setOptURI) //, set2sqlArrayURI, set2sqlsURI, one2sqlURI, one2jsonURI)
  lazy val resOptMapByte          : ResMapOpt[Byte]           = ResMapOpt("Byte", sql2setOptByte) //, set2sqlArrayByte, set2sqlsByte, one2sqlByte, one2jsonByte)
  lazy val resOptMapShort         : ResMapOpt[Short]          = ResMapOpt("Short", sql2setOptShort) //, set2sqlArrayShort, set2sqlsShort, one2sqlShort, one2jsonShort)
  lazy val resOptMapChar          : ResMapOpt[Char]           = ResMapOpt("Char", sql2setOptChar) //, set2sqlArrayChar, set2sqlsChar, one2sqlChar, one2jsonChar)
  ...
  protected def sql2mapOpt[T](row: RS, paramIndex: Int, json2map: String => Map[String, T]): Option[Map[String, T]] = {
    ...
    if (row.wasNull()) {
      ...
      // Add initial size of array so that Boopickle can unpickle it
      val sizedByteArray = byteArray.length.toByte +: byteArray
      val json           = Unpickle.apply[String].fromBytes(ByteBuffer.wrap(sizedByteArray))
      val map            = json2map(json)
      if (map.nonEmpty) Some(map) else None
    }
  }

  private lazy val sql2setOptId            : (RS, Int) => Option[Map[String, String]]         = (row: RS, paramIndex: Int) => sql2mapOpt(row, paramIndex, json2mapID)
  private lazy val sql2setOptString        : (RS, Int) => Option[Map[String, String]]         = (row: RS, paramIndex: Int) => sql2mapOpt(row, paramIndex, json2mapString)
  private lazy val sql2setOptInt           : (RS, Int) => Option[Map[String, Int]]            = (row: RS, paramIndex: Int) => sql2mapOpt(row, paramIndex, json2mapInt)
  private lazy val sql2setOptLong          : (RS, Int) => Option[Map[String, Long]]           = (row: RS, paramIndex: Int) => sql2mapOpt(row, paramIndex, json2mapLong)
  private lazy val sql2setOptFloat         : (RS, Int) => Option[Map[String, Float]]          = (row: RS, paramIndex: Int) => sql2mapOpt(row, paramIndex, json2mapFloat)
  private lazy val sql2setOptDouble        : (RS, Int) => Option[Map[String, Double]]         = (row: RS, paramIndex: Int) => sql2mapOpt(row, paramIndex, json2mapDouble)
  private lazy val sql2setOptBoolean       : (RS, Int) => Option[Map[String, Boolean]]        = (row: RS, paramIndex: Int) => sql2mapOpt(row, paramIndex, json2mapBoolean)
  private lazy val sql2setOptBigInt        : (RS, Int) => Option[Map[String, BigInt]]         = (row: RS, paramIndex: Int) => sql2mapOpt(row, paramIndex, json2mapBigInt)
  private lazy val sql2setOptBigDecimal    : (RS, Int) => Option[Map[String, BigDecimal]]     = (row: RS, paramIndex: Int) => sql2mapOpt(row, paramIndex, json2mapBigDecimal)
  private lazy val sql2setOptDate          : (RS, Int) => Option[Map[String, Date]]           = (row: RS, paramIndex: Int) => sql2mapOpt(row, paramIndex, json2mapDate)
  private lazy val sql2setOptDuration      : (RS, Int) => Option[Map[String, Duration]]       = (row: RS, paramIndex: Int) => sql2mapOpt(row, paramIndex, json2mapDuration)
  private lazy val sql2setOptInstant       : (RS, Int) => Option[Map[String, Instant]]        = (row: RS, paramIndex: Int) => sql2mapOpt(row, paramIndex, json2mapInstant)
  private lazy val sql2setOptLocalDate     : (RS, Int) => Option[Map[String, LocalDate]]      = (row: RS, paramIndex: Int) => sql2mapOpt(row, paramIndex, json2mapLocalDate)
  private lazy val sql2setOptLocalTime     : (RS, Int) => Option[Map[String, LocalTime]]      = (row: RS, paramIndex: Int) => sql2mapOpt(row, paramIndex, json2mapLocalTime)
  private lazy val sql2setOptLocalDateTime : (RS, Int) => Option[Map[String, LocalDateTime]]  = (row: RS, paramIndex: Int) => sql2mapOpt(row, paramIndex, json2mapLocalDateTime)
  private lazy val sql2setOptOffsetTime    : (RS, Int) => Option[Map[String, OffsetTime]]     = (row: RS, paramIndex: Int) => sql2mapOpt(row, paramIndex, json2mapOffsetTime)
  private lazy val sql2setOptOffsetDateTime: (RS, Int) => Option[Map[String, OffsetDateTime]] = (row: RS, paramIndex: Int) => sql2mapOpt(row, paramIndex, json2mapOffsetDateTime)
  private lazy val sql2setOptZonedDateTime : (RS, Int) => Option[Map[String, ZonedDateTime]]  = (row: RS, paramIndex: Int) => sql2mapOpt(row, paramIndex, json2mapZonedDateTime)
  private lazy val sql2setOptUUID          : (RS, Int) => Option[Map[String, UUID]]           = (row: RS, paramIndex: Int) => sql2mapOpt(row, paramIndex, json2mapUUID)
  private lazy val sql2setOptURI           : (RS, Int) => Option[Map[String, URI]]            = (row: RS, paramIndex: Int) => sql2mapOpt(row, paramIndex, json2mapURI)
  private lazy val sql2setOptByte          : (RS, Int) => Option[Map[String, Byte]]           = (row: RS, paramIndex: Int) => sql2mapOpt(row, paramIndex, json2mapByte)
  private lazy val sql2setOptShort         : (RS, Int) => Option[Map[String, Short]]          = (row: RS, paramIndex: Int) => sql2mapOpt(row, paramIndex, json2mapShort)
  private lazy val sql2setOptChar          : (RS, Int) => Option[Map[String, Char]]           = (row: RS, paramIndex: Int) => sql2mapOpt(row, paramIndex, json2mapChar)
}
