...
//          }
  ...
  override protected lazy val handleString         = (v: Any) => (doc: BsonDocument) => doc.append("attr", new BsonString(v.asInstanceOf[String]))
  override protected lazy val handleInt            = (v: Any) => (doc: BsonDocument) => doc.append("attr", new BsonInt32(v.asInstanceOf[Int]))
