...
trait Save_mongodb
  ...
  def getData(elements: List[Element]): Data = {
    ...
    val list = new util.ArrayList[BsonDocument]()
    //    list.add(
    //      new BsonDocument()
    //        .append("i", new BsonInt32(1))
    //    )
  ...
  override protected def addOne[T](
    ...
    optValue.fold {
//      filters.append(attr, BsonNull)
      filters.append(attr, null)
    } { value =>
      filters.append(attr, handleValue(value).asInstanceOf[BsonValue])
    }
  }
