...
//    v2set: String => BsonDocument => Set[T],
  ...
  lazy val resMapID            : ResMap[String]         = ResMap("String") //, castSetID, castOptSetID, v2bsonID, setSetID, v2setID)
  lazy val resMapString        : ResMap[String]         = ResMap("String") //, castSetString, castOptSetString, v2bsonString, setSetString, v2setString)
  lazy val resMapInt           : ResMap[Int]            = ResMap("Int") //, castSetInt, castOptSetInt, v2bsonInt, setSetInt, v2setInt)
  lazy val resMapLong          : ResMap[Long]           = ResMap("Long") //, castSetLong, castOptSetLong, v2bsonLong, setSetLong, v2setLong)
  lazy val resMapFloat         : ResMap[Float]          = ResMap("Float") //, castSetFloat, castOptSetFloat, v2bsonFloat, setSetFloat, v2setFloat)
  lazy val resMapDouble        : ResMap[Double]         = ResMap("Double") //, castSetDouble, castOptSetDouble, v2bsonDouble, setSetDouble, v2setDouble)
  lazy val resMapBoolean       : ResMap[Boolean]        = ResMap("Boolean") //, castSetBoolean, castOptSetBoolean, v2bsonBoolean, setSetBoolean, v2setBoolean)
  lazy val resMapBigInt        : ResMap[BigInt]         = ResMap("BigInt") //, castSetBigInt, castOptSetBigInt, v2bsonBigInt, setSetBigInt, v2setBigInt)
  lazy val resMapBigDecimal    : ResMap[BigDecimal]     = ResMap("BigDecimal") //, castSetBigDecimal, castOptSetBigDecimal, v2bsonBigDecimal, setSetBigDecimal, v2setBigDecimal)
  lazy val resMapDate          : ResMap[Date]           = ResMap("Date") //, castSetDate, castOptSetDate, v2bsonDate, setSetDate, v2setDate)
  lazy val resMapDuration      : ResMap[Duration]       = ResMap("Duration") //, castSetDuration, castOptSetDuration, v2bsonDuration, setSetDuration, v2setDuration)
  lazy val resMapInstant       : ResMap[Instant]        = ResMap("Instant") //, castSetInstant, castOptSetInstant, v2bsonInstant, setSetInstant, v2setInstant)
  lazy val resMapLocalDate     : ResMap[LocalDate]      = ResMap("LocalDate") //, castSetLocalDate, castOptSetLocalDate, v2bsonLocalDate, setSetLocalDate, v2setLocalDate)
  lazy val resMapLocalTime     : ResMap[LocalTime]      = ResMap("LocalTime") //, castSetLocalTime, castOptSetLocalTime, v2bsonLocalTime, setSetLocalTime, v2setLocalTime)
  lazy val resMapLocalDateTime : ResMap[LocalDateTime]  = ResMap("LocalDateTime") //, castSetLocalDateTime, castOptSetLocalDateTime, v2bsonLocalDateTime, setSetLocalDateTime, v2setLocalDateTime)
  lazy val resMapOffsetTime    : ResMap[OffsetTime]     = ResMap("OffsetTime") //, castSetOffsetTime, castOptSetOffsetTime, v2bsonOffsetTime, setSetOffsetTime, v2setOffsetTime)
  lazy val resMapOffsetDateTime: ResMap[OffsetDateTime] = ResMap("OffsetDateTime") //, castSetOffsetDateTime, castOptSetOffsetDateTime, v2bsonOffsetDateTime, setSetOffsetDateTime, v2setOffsetDateTime)
  lazy val resMapZonedDateTime : ResMap[ZonedDateTime]  = ResMap("ZonedDateTime") //, castSetZonedDateTime, castOptSetZonedDateTime, v2bsonZonedDateTime, setSetZonedDateTime, v2setZonedDateTime)
  lazy val resMapUUID          : ResMap[UUID]           = ResMap("UUID") //, castSetUUID, castOptSetUUID, v2bsonUUID, setSetUUID, v2setUUID)
  lazy val resMapURI           : ResMap[URI]            = ResMap("URI") //, castSetURI, castOptSetURI, v2bsonURI, setSetURI, v2setURI)
  lazy val resMapByte          : ResMap[Byte]           = ResMap("Byte") //, castSetByte, castOptSetByte, v2bsonByte, setSetByte, v2setByte)
  lazy val resMapShort         : ResMap[Short]          = ResMap("Short") //, castSetShort, castOptSetShort, v2bsonShort, setSetShort, v2setShort)
  lazy val resMapChar          : ResMap[Char]           = ResMap("Char") //, castSetChar, castOptSetChar, v2bsonChar, setSetChar, v2setChar)
