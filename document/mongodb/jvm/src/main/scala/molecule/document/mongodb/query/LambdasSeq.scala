...
//    v2set: String => BsonDocument => Set[T],
  ...
  lazy val resSeqID            : ResSeq[String]         = ResSeq("String") //, castSetID, castOptSetID, v2bsonID, setSetID, v2setID)
  lazy val resSeqString        : ResSeq[String]         = ResSeq("String") //, castSetString, castOptSetString, v2bsonString, setSetString, v2setString)
  lazy val resSeqInt           : ResSeq[Int]            = ResSeq("Int") //, castSetInt, castOptSetInt, v2bsonInt, setSetInt, v2setInt)
  lazy val resSeqLong          : ResSeq[Long]           = ResSeq("Long") //, castSetLong, castOptSetLong, v2bsonLong, setSetLong, v2setLong)
  lazy val resSeqFloat         : ResSeq[Float]          = ResSeq("Float") //, castSetFloat, castOptSetFloat, v2bsonFloat, setSetFloat, v2setFloat)
  lazy val resSeqDouble        : ResSeq[Double]         = ResSeq("Double") //, castSetDouble, castOptSetDouble, v2bsonDouble, setSetDouble, v2setDouble)
  lazy val resSeqBoolean       : ResSeq[Boolean]        = ResSeq("Boolean") //, castSetBoolean, castOptSetBoolean, v2bsonBoolean, setSetBoolean, v2setBoolean)
  lazy val resSeqBigInt        : ResSeq[BigInt]         = ResSeq("BigInt") //, castSetBigInt, castOptSetBigInt, v2bsonBigInt, setSetBigInt, v2setBigInt)
  lazy val resSeqBigDecimal    : ResSeq[BigDecimal]     = ResSeq("BigDecimal") //, castSetBigDecimal, castOptSetBigDecimal, v2bsonBigDecimal, setSetBigDecimal, v2setBigDecimal)
  lazy val resSeqDate          : ResSeq[Date]           = ResSeq("Date") //, castSetDate, castOptSetDate, v2bsonDate, setSetDate, v2setDate)
  lazy val resSeqDuration      : ResSeq[Duration]       = ResSeq("Duration") //, castSetDuration, castOptSetDuration, v2bsonDuration, setSetDuration, v2setDuration)
  lazy val resSeqInstant       : ResSeq[Instant]        = ResSeq("Instant") //, castSetInstant, castOptSetInstant, v2bsonInstant, setSetInstant, v2setInstant)
  lazy val resSeqLocalDate     : ResSeq[LocalDate]      = ResSeq("LocalDate") //, castSetLocalDate, castOptSetLocalDate, v2bsonLocalDate, setSetLocalDate, v2setLocalDate)
  lazy val resSeqLocalTime     : ResSeq[LocalTime]      = ResSeq("LocalTime") //, castSetLocalTime, castOptSetLocalTime, v2bsonLocalTime, setSetLocalTime, v2setLocalTime)
  lazy val resSeqLocalDateTime : ResSeq[LocalDateTime]  = ResSeq("LocalDateTime") //, castSetLocalDateTime, castOptSetLocalDateTime, v2bsonLocalDateTime, setSetLocalDateTime, v2setLocalDateTime)
  lazy val resSeqOffsetTime    : ResSeq[OffsetTime]     = ResSeq("OffsetTime") //, castSetOffsetTime, castOptSetOffsetTime, v2bsonOffsetTime, setSetOffsetTime, v2setOffsetTime)
  lazy val resSeqOffsetDateTime: ResSeq[OffsetDateTime] = ResSeq("OffsetDateTime") //, castSetOffsetDateTime, castOptSetOffsetDateTime, v2bsonOffsetDateTime, setSetOffsetDateTime, v2setOffsetDateTime)
  lazy val resSeqZonedDateTime : ResSeq[ZonedDateTime]  = ResSeq("ZonedDateTime") //, castSetZonedDateTime, castOptSetZonedDateTime, v2bsonZonedDateTime, setSetZonedDateTime, v2setZonedDateTime)
  lazy val resSeqUUID          : ResSeq[UUID]           = ResSeq("UUID") //, castSetUUID, castOptSetUUID, v2bsonUUID, setSetUUID, v2setUUID)
  lazy val resSeqURI           : ResSeq[URI]            = ResSeq("URI") //, castSetURI, castOptSetURI, v2bsonURI, setSetURI, v2setURI)
  lazy val resSeqByte          : ResSeq[Byte]           = ResSeq("Byte") //, castSetByte, castOptSetByte, v2bsonByte, setSetByte, v2setByte)
  lazy val resSeqShort         : ResSeq[Short]          = ResSeq("Short") //, castSetShort, castOptSetShort, v2bsonShort, setSetShort, v2setShort)
  lazy val resSeqChar          : ResSeq[Char]           = ResSeq("Char") //, castSetChar, castOptSetChar, v2bsonChar, setSetChar, v2setChar)
