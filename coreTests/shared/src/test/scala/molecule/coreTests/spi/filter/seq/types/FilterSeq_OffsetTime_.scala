  ...
  override lazy val tests = Tests {
    ...
    "Mandatory" - {
      ...
      "has" - types { implicit conn =>
        for {
          _ <- Ns.i.offsetTimeSeq.insert(a, b).transact
          ...
          // "Has this OR that"
          _ <- Ns.i.a1.offsetTimeSeq.has(offsetTime0, offsetTime1).query.get.map(_ ==> List(a))
          ...
          // Same as
          _ <- Ns.i.a1.offsetTimeSeq.has(List(offsetTime0, offsetTime1)).query.get.map(_ ==> List(a))
    ...
    "Tacit" - {
      ...
      "has" - types { implicit conn =>
        for {
          ...
          // "Has this OR that"
          _ <- Ns.i.a1.offsetTimeSeq_.has(offsetTime0, offsetTime1).query.get.map(_ ==> List(1))
          ...
          _ <- Ns.i.a1.offsetTimeSeq_.has(offsetTime3, offsetTime4).query.get.map(_ ==> List(2))
          // Same as
          _ <- Ns.i.a1.offsetTimeSeq_.has(List(offsetTime0, offsetTime1)).query.get.map(_ ==> List(1))
          ...
          _ <- Ns.i.a1.offsetTimeSeq_.has(List(offsetTime3, offsetTime4)).query.get.map(_ ==> List(2))
