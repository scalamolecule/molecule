...
trait FilterSeq_ZonedDateTime_ extends CoreTestSuite with Api_async { spi: Spi_async =>
  ...
  override lazy val tests = Tests {
    ...
    "Mandatory" - {
      ...
      "has" - types { implicit conn =>
        for {
          _ <- Ns.i.zonedDateTimeSeq.insert(a, b).transact
          ...
          // "Has this OR that"
          _ <- Ns.i.a1.zonedDateTimeSeq.has(zonedDateTime0, zonedDateTime1).query.get.map(_ ==> List(a))
          ...
          // Same as
          _ <- Ns.i.a1.zonedDateTimeSeq.has(List(zonedDateTime0, zonedDateTime1)).query.get.map(_ ==> List(a))
    ...
    "Tacit" - {
      ...
      "has" - types { implicit conn =>
        for {
          ...
          // "Has this OR that"
          _ <- Ns.i.a1.zonedDateTimeSeq_.has(zonedDateTime0, zonedDateTime1).query.get.map(_ ==> List(1))
          ...
          _ <- Ns.i.a1.zonedDateTimeSeq_.has(zonedDateTime3, zonedDateTime4).query.get.map(_ ==> List(2))
          // Same as
          _ <- Ns.i.a1.zonedDateTimeSeq_.has(List(zonedDateTime0, zonedDateTime1)).query.get.map(_ ==> List(1))
          ...
          _ <- Ns.i.a1.zonedDateTimeSeq_.has(List(zonedDateTime3, zonedDateTime4)).query.get.map(_ ==> List(2))
