    ...
    "Mandatory" - {
      ...
      "attr" - types { implicit conn =>
        ...
        for {
          ...
          _ <- Ns.i.a1.zonedDateTimeSet.query.get.map(_ ==> List(a, b))
        } yield ()
      }
      ...
      "apply (equal)" - types { implicit conn =>
        ...
        for {
          ...
          _ <- Ns.i.a1.zonedDateTimeSet(Set(zonedDateTime1)).query.get.map(_ ==> List())
          _ <- Ns.i.a1.zonedDateTimeSet(Set(zonedDateTime1, zonedDateTime2)).query.get.map(_ ==> List(a)) // include exact match
          _ <- Ns.i.a1.zonedDateTimeSet(Set(zonedDateTime1, zonedDateTime2, zonedDateTime3)).query.get.map(_ ==> List())
          // Same as
          _ <- Ns.i.a1.zonedDateTimeSet(Seq(Set(zonedDateTime1))).query.get.map(_ ==> List())
          _ <- Ns.i.a1.zonedDateTimeSet(Seq(Set(zonedDateTime1, zonedDateTime2))).query.get.map(_ ==> List(a))
          _ <- Ns.i.a1.zonedDateTimeSet(Seq(Set(zonedDateTime1, zonedDateTime2, zonedDateTime3))).query.get.map(_ ==> List())


          // AND/OR semantics with multiple Sets

          // "(exactly this AND that) OR (exactly this AND that)"
          _ <- Ns.i.a1.zonedDateTimeSet(Set(zonedDateTime1), Set(zonedDateTime2, zonedDateTime3)).query.get.map(_ ==> List())
          _ <- Ns.i.a1.zonedDateTimeSet(Set(zonedDateTime1, zonedDateTime2), Set(zonedDateTime2, zonedDateTime3)).query.get.map(_ ==> List(a))
          _ <- Ns.i.a1.zonedDateTimeSet(Set(zonedDateTime1, zonedDateTime2), Set(zonedDateTime2, zonedDateTime3, zonedDateTime4)).query.get.map(_ ==> List(a, b))
          // Same as
          _ <- Ns.i.a1.zonedDateTimeSet(Seq(Set(zonedDateTime1), Set(zonedDateTime2, zonedDateTime3))).query.get.map(_ ==> List())
          _ <- Ns.i.a1.zonedDateTimeSet(Seq(Set(zonedDateTime1, zonedDateTime2), Set(zonedDateTime2, zonedDateTime3))).query.get.map(_ ==> List(a))
          _ <- Ns.i.a1.zonedDateTimeSet(Seq(Set(zonedDateTime1, zonedDateTime2), Set(zonedDateTime2, zonedDateTime3, zonedDateTime4))).query.get.map(_ ==> List(a, b))


          // Empty Seq/Sets match nothing
          _ <- Ns.i.a1.zonedDateTimeSet(Set(zonedDateTime1, zonedDateTime2), Set.empty[ZonedDateTime]).query.get.map(_ ==> List(a))
          _ <- Ns.i.a1.zonedDateTimeSet(Set.empty[ZonedDateTime], Set(zonedDateTime1, zonedDateTime2)).query.get.map(_ ==> List(a))
          _ <- Ns.i.a1.zonedDateTimeSet(Set.empty[ZonedDateTime], Set.empty[ZonedDateTime]).query.get.map(_ ==> List())
          _ <- Ns.i.a1.zonedDateTimeSet(Set.empty[ZonedDateTime]).query.get.map(_ ==> List())
          _ <- Ns.i.a1.zonedDateTimeSet(Seq.empty[Set[ZonedDateTime]]).query.get.map(_ ==> List())
          _ <- Ns.i.a1.zonedDateTimeSet(Seq(Set.empty[ZonedDateTime])).query.get.map(_ ==> List())
      ...
      "not equal" - types { implicit conn =>
        ...
        for {
          ...
          _ <- Ns.i.a1.zonedDateTimeSet.not(Set(zonedDateTime1)).query.get.map(_ ==> List(a, b))
          _ <- Ns.i.a1.zonedDateTimeSet.not(Set(zonedDateTime1, zonedDateTime2)).query.get.map(_ ==> List(b)) // exclude exact match
          _ <- Ns.i.a1.zonedDateTimeSet.not(Set(zonedDateTime1, zonedDateTime2, zonedDateTime3)).query.get.map(_ ==> List(a, b))
          // Same as
          _ <- Ns.i.a1.zonedDateTimeSet.not(Seq(Set(zonedDateTime1))).query.get.map(_ ==> List(a, b))
          _ <- Ns.i.a1.zonedDateTimeSet.not(Seq(Set(zonedDateTime1, zonedDateTime2))).query.get.map(_ ==> List(b))
          _ <- Ns.i.a1.zonedDateTimeSet.not(Seq(Set(zonedDateTime1, zonedDateTime2))).query.get.map(_ ==> List(b))
          _ <- Ns.i.a1.zonedDateTimeSet.not(Seq(Set(zonedDateTime1, zonedDateTime2, zonedDateTime3))).query.get.map(_ ==> List(a, b))


          // AND/OR semantics with multiple Sets

          // "NEITHER (exactly this AND that) NOR (exactly this AND that)"
          _ <- Ns.i.a1.zonedDateTimeSet.not(Set(zonedDateTime1), Set(zonedDateTime2, zonedDateTime3)).query.get.map(_ ==> List(a, b))
          _ <- Ns.i.a1.zonedDateTimeSet.not(Set(zonedDateTime1, zonedDateTime2), Set(zonedDateTime2, zonedDateTime3)).query.get.map(_ ==> List(b))
          _ <- Ns.i.a1.zonedDateTimeSet.not(Set(zonedDateTime1, zonedDateTime2), Set(zonedDateTime2, zonedDateTime3, zonedDateTime4)).query.get.map(_ ==> List())
          // Same as
          _ <- Ns.i.a1.zonedDateTimeSet.not(Seq(Set(zonedDateTime1), Set(zonedDateTime2, zonedDateTime3))).query.get.map(_ ==> List(a, b))
          _ <- Ns.i.a1.zonedDateTimeSet.not(Seq(Set(zonedDateTime1, zonedDateTime2), Set(zonedDateTime2, zonedDateTime3))).query.get.map(_ ==> List(b))
          _ <- Ns.i.a1.zonedDateTimeSet.not(Seq(Set(zonedDateTime1, zonedDateTime2), Set(zonedDateTime2, zonedDateTime3, zonedDateTime4))).query.get.map(_ ==> List())


          // Empty Seq/Sets
          _ <- Ns.i.a1.zonedDateTimeSet.not(Seq(Set(zonedDateTime1, zonedDateTime2), Set.empty[ZonedDateTime])).query.get.map(_ ==> List(b))
          _ <- Ns.i.a1.zonedDateTimeSet.not(Set.empty[ZonedDateTime]).query.get.map(_ ==> List(a, b))
          _ <- Ns.i.a1.zonedDateTimeSet.not(Seq.empty[Set[ZonedDateTime]]).query.get.map(_ ==> List(a, b))
        } yield ()
      }
    ...
    "Tacit" - {
      ...
      "attr" - types { implicit conn =>
        for {
          ...
          // zonedDateTimeSet not asserted for i = 0
          _ <- Ns.i.a1.zonedDateTimeSet_.query.get.map(_ ==> List(1, 2))
        } yield ()
      }
      ...
      "apply (equal)" - types { implicit conn =>
        for {
          _ <- Ns.i.zonedDateTimeSet_?.insert(List(
            (0, None),
          ...
          _ <- Ns.i.a1.zonedDateTimeSet_().query.get.map(_ ==> List(0))

          // Exact Set matches

          // AND semantics
          // "Is exactly this AND that"
          _ <- Ns.i.a1.zonedDateTimeSet_(Set(zonedDateTime1)).query.get.map(_ ==> List())
          _ <- Ns.i.a1.zonedDateTimeSet_(Set(zonedDateTime1, zonedDateTime2)).query.get.map(_ ==> List(1)) // include exact match
          _ <- Ns.i.a1.zonedDateTimeSet_(Set(zonedDateTime1, zonedDateTime2, zonedDateTime3)).query.get.map(_ ==> List())
          // Same as
          _ <- Ns.i.a1.zonedDateTimeSet_(Seq(Set(zonedDateTime1))).query.get.map(_ ==> List())
          _ <- Ns.i.a1.zonedDateTimeSet_(Seq(Set(zonedDateTime1, zonedDateTime2))).query.get.map(_ ==> List(1))
          _ <- Ns.i.a1.zonedDateTimeSet_(Seq(Set(zonedDateTime1, zonedDateTime2, zonedDateTime3))).query.get.map(_ ==> List())


          // AND/OR semantics with multiple Sets

          // "(exactly this AND that) OR (exactly this AND that)"
          _ <- Ns.i.a1.zonedDateTimeSet_(Set(zonedDateTime1), Set(zonedDateTime2, zonedDateTime3)).query.get.map(_ ==> List())
          _ <- Ns.i.a1.zonedDateTimeSet_(Set(zonedDateTime1, zonedDateTime2), Set(zonedDateTime2, zonedDateTime3)).query.get.map(_ ==> List(1))
          _ <- Ns.i.a1.zonedDateTimeSet_(Set(zonedDateTime1, zonedDateTime2), Set(zonedDateTime2, zonedDateTime3, zonedDateTime4)).query.get.map(_ ==> List(1, 2))
          // Same as
          _ <- Ns.i.a1.zonedDateTimeSet_(Seq(Set(zonedDateTime1), Set(zonedDateTime2, zonedDateTime3))).query.get.map(_ ==> List())
          _ <- Ns.i.a1.zonedDateTimeSet_(Seq(Set(zonedDateTime1, zonedDateTime2), Set(zonedDateTime2, zonedDateTime3))).query.get.map(_ ==> List(1))
          _ <- Ns.i.a1.zonedDateTimeSet_(Seq(Set(zonedDateTime1, zonedDateTime2), Set(zonedDateTime2, zonedDateTime3, zonedDateTime4))).query.get.map(_ ==> List(1, 2))


          // Empty Seq/Sets match nothing
          _ <- Ns.i.a1.zonedDateTimeSet_(Set(zonedDateTime1, zonedDateTime2), Set.empty[ZonedDateTime]).query.get.map(_ ==> List(1))
          _ <- Ns.i.a1.zonedDateTimeSet_(Set.empty[ZonedDateTime]).query.get.map(_ ==> List())
          _ <- Ns.i.a1.zonedDateTimeSet_(Seq.empty[Set[ZonedDateTime]]).query.get.map(_ ==> List())
          _ <- Ns.i.a1.zonedDateTimeSet_(Seq(Set.empty[ZonedDateTime])).query.get.map(_ ==> List())
        } yield ()
      }
      ...
      "not equal" - types { implicit conn =>
        for {
          ...
          // AND semantics
          // "Not (exactly this AND that)"
          _ <- Ns.i.a1.zonedDateTimeSet_.not(Set(zonedDateTime1)).query.get.map(_ ==> List(1, 2))
          _ <- Ns.i.a1.zonedDateTimeSet_.not(Set(zonedDateTime1, zonedDateTime2)).query.get.map(_ ==> List(2)) // exclude exact match
          _ <- Ns.i.a1.zonedDateTimeSet_.not(Set(zonedDateTime1, zonedDateTime2, zonedDateTime3)).query.get.map(_ ==> List(1, 2))
          // Same as
          _ <- Ns.i.a1.zonedDateTimeSet_.not(Seq(Set(zonedDateTime1))).query.get.map(_ ==> List(1, 2))
          _ <- Ns.i.a1.zonedDateTimeSet_.not(Seq(Set(zonedDateTime1, zonedDateTime2))).query.get.map(_ ==> List(2))
          _ <- Ns.i.a1.zonedDateTimeSet_.not(Seq(Set(zonedDateTime1, zonedDateTime2, zonedDateTime3))).query.get.map(_ ==> List(1, 2))


          // AND/OR semantics with multiple Sets

          // "NEITHER (exactly this AND that) NOR (exactly this AND that)"
          _ <- Ns.i.a1.zonedDateTimeSet_.not(Set(zonedDateTime1), Set(zonedDateTime2, zonedDateTime3)).query.get.map(_ ==> List(1, 2))
          _ <- Ns.i.a1.zonedDateTimeSet_.not(Set(zonedDateTime1, zonedDateTime2), Set(zonedDateTime2, zonedDateTime3)).query.get.map(_ ==> List(2))
          _ <- Ns.i.a1.zonedDateTimeSet_.not(Set(zonedDateTime1, zonedDateTime2), Set(zonedDateTime2, zonedDateTime3, zonedDateTime4)).query.get.map(_ ==> List())
          // Same as
          _ <- Ns.i.a1.zonedDateTimeSet_.not(Seq(Set(zonedDateTime1), Set(zonedDateTime2, zonedDateTime3))).query.get.map(_ ==> List(1, 2))
          _ <- Ns.i.a1.zonedDateTimeSet_.not(Seq(Set(zonedDateTime1, zonedDateTime2), Set(zonedDateTime2, zonedDateTime3))).query.get.map(_ ==> List(2))
          _ <- Ns.i.a1.zonedDateTimeSet_.not(Seq(Set(zonedDateTime1, zonedDateTime2), Set(zonedDateTime2, zonedDateTime3, zonedDateTime4))).query.get.map(_ ==> List())


          // Empty Seq/Sets
          _ <- Ns.i.a1.zonedDateTimeSet_.not(Seq(Set(zonedDateTime1, zonedDateTime2), Set.empty[ZonedDateTime])).query.get.map(_ ==> List(2))
          _ <- Ns.i.a1.zonedDateTimeSet_.not(Set.empty[ZonedDateTime]).query.get.map(_ ==> List(1, 2))
          _ <- Ns.i.a1.zonedDateTimeSet_.not(Seq.empty[Set[ZonedDateTime]]).query.get.map(_ ==> List(1, 2))
        } yield ()
      }
    ...
    "Optional" - {
      ...
      "attr" - types { implicit conn =>
        ...
        for {
          ...
          _ <- Ns.i.a1.zonedDateTimeSet_?.query.get.map(_ ==> List(a, b, c))

          // Distinct result even with redundant None's (two i = 3 with no zonedDateTime value)
          _ <- Ns.i.insert(3).transact
          _ <- Ns.i.>=(2).a1.zonedDateTimeSet_?.query.get.map(_ ==> List(
            (2, Some(Set(zonedDateTime2, zonedDateTime3, zonedDateTime4))),
            (3, None),
          ))
        } yield ()
      ...
      "apply (equal)" - types { implicit conn =>
        ...
        for {
          ...
          // AND semantics
          // "Is exactly this AND that"
          _ <- Ns.i.a1.zonedDateTimeSet_?(Some(Set(zonedDateTime1))).query.get.map(_ ==> List())
          _ <- Ns.i.a1.zonedDateTimeSet_?(Some(Set(zonedDateTime1, zonedDateTime2))).query.get.map(_ ==> List(a)) // include exact match
          _ <- Ns.i.a1.zonedDateTimeSet_?(Some(Set(zonedDateTime1, zonedDateTime2, zonedDateTime3))).query.get.map(_ ==> List())
          // Same as
          _ <- Ns.i.a1.zonedDateTimeSet_?(Some(Seq(Set(zonedDateTime1)))).query.get.map(_ ==> List())
          _ <- Ns.i.a1.zonedDateTimeSet_?(Some(Seq(Set(zonedDateTime1, zonedDateTime2)))).query.get.map(_ ==> List(a))
          _ <- Ns.i.a1.zonedDateTimeSet_?(Some(Seq(Set(zonedDateTime1, zonedDateTime2, zonedDateTime3)))).query.get.map(_ ==> List())
          ...
          // Empty Seq/Sets match nothing
          _ <- Ns.i.a1.zonedDateTimeSet_?(Some(Set.empty[ZonedDateTime])).query.get.map(_ ==> List())
          _ <- Ns.i.a1.zonedDateTimeSet_?(Some(Seq.empty[Set[ZonedDateTime]])).query.get.map(_ ==> List())
          _ <- Ns.i.a1.zonedDateTimeSet_?(Some(Seq(Set.empty[ZonedDateTime]))).query.get.map(_ ==> List())


          // None matches non-asserted values
          _ <- Ns.i.a1.zonedDateTimeSet_?(Option.empty[Set[ZonedDateTime]]).query.get.map(_ ==> List(c))
          _ <- Ns.i.a1.zonedDateTimeSet_?(Option.empty[Seq[Set[ZonedDateTime]]]).query.get.map(_ ==> List(c))
        } yield ()
      }
      ...
      "not equal" - types { implicit conn =>
        ...
        for {
          ...
          // AND semantics
          // "Not (exactly this AND that)"
          _ <- Ns.i.a1.zonedDateTimeSet_?.not(Some(Set(zonedDateTime1))).query.get.map(_ ==> List(a, b))
          _ <- Ns.i.a1.zonedDateTimeSet_?.not(Some(Set(zonedDateTime1, zonedDateTime2))).query.get.map(_ ==> List(b)) // exclude exact match
          _ <- Ns.i.a1.zonedDateTimeSet_?.not(Some(Set(zonedDateTime1, zonedDateTime2, zonedDateTime3))).query.get.map(_ ==> List(a, b))
          // Same as
          _ <- Ns.i.a1.zonedDateTimeSet_?.not(Some(Seq(Set(zonedDateTime1)))).query.get.map(_ ==> List(a, b))
          _ <- Ns.i.a1.zonedDateTimeSet_?.not(Some(Seq(Set(zonedDateTime1, zonedDateTime2)))).query.get.map(_ ==> List(b))
          _ <- Ns.i.a1.zonedDateTimeSet_?.not(Some(Seq(Set(zonedDateTime1, zonedDateTime2, zonedDateTime3)))).query.get.map(_ ==> List(a, b))


          // AND/OR semantics with multiple Sets

          // "NEITHER (exactly this AND that) NOR (exactly this AND that)"
          _ <- Ns.i.a1.zonedDateTimeSet_?.not(Some(Seq(Set(zonedDateTime1), Set(zonedDateTime2, zonedDateTime3)))).query.get.map(_ ==> List(a, b))
          _ <- Ns.i.a1.zonedDateTimeSet_?.not(Some(Seq(Set(zonedDateTime1, zonedDateTime2), Set(zonedDateTime2, zonedDateTime3)))).query.get.map(_ ==> List(b))
          _ <- Ns.i.a1.zonedDateTimeSet_?.not(Some(Seq(Set(zonedDateTime1, zonedDateTime2), Set(zonedDateTime2, zonedDateTime3, zonedDateTime4)))).query.get.map(_ ==> List())

          // Empty Sets are ignored
          _ <- Ns.i.a1.zonedDateTimeSet_?.not(Some(Seq(Set(zonedDateTime1, zonedDateTime2), Set.empty[ZonedDateTime]))).query.get.map(_ ==> List(b))
          _ <- Ns.i.a1.zonedDateTimeSet_?.not(Some(Set.empty[ZonedDateTime])).query.get.map(_ ==> List(a, b))
          _ <- Ns.i.a1.zonedDateTimeSet_?.not(Some(Seq.empty[Set[ZonedDateTime]])).query.get.map(_ ==> List(a, b))

          // Negation of None matches all asserted
          _ <- Ns.i.a1.zonedDateTimeSet_?.not(Option.empty[Set[ZonedDateTime]]).query.get.map(_ ==> List(a, b))
          _ <- Ns.i.a1.zonedDateTimeSet_?.not(Option.empty[Seq[Set[ZonedDateTime]]]).query.get.map(_ ==> List(a, b))
        } yield ()
      }
