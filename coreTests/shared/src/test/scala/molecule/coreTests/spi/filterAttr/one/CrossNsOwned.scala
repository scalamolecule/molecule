  ...
  override lazy val tests = Tests {
    ...
    "<=" - refs { implicit conn =>
      for {
        ...
        // Filter compare attribute itself
        _ <- A.s.i.<=(B.i_).OwnB.i(2).query.get.map(_ ==> List(("a", 1, 2)))
        _ <- A.s.i.<=(B.i_).OwnB.i.not(2).query.get.map(_ ==> List(("b", 3, 3)))
        _ <- A.s.i.<=(B.i_).OwnB.i.>(2).query.get.map(_ ==> List(("b", 3, 3)))
        _ <- A.s.i.<=(B.i_).OwnB.i.>=(2).query.get.map(_ ==> List(("a", 1, 2), ("b", 3, 3)))
        _ <- A.s.i.<=(B.i_).OwnB.i.<(2).query.get.map(_ ==> List())
        _ <- A.s.i.<=(B.i_).OwnB.i.<=(2).query.get.map(_ ==> List(("a", 1, 2)))

        _ <- A.s.i.<=(B.i_).OwnB.i_(2).query.get.map(_ ==> List(("a", 1)))
        _ <- A.s.i.<=(B.i_).OwnB.i_.not(2).query.get.map(_ ==> List(("b", 3)))
        _ <- A.s.i.<=(B.i_).OwnB.i_.>(2).query.get.map(_ ==> List(("b", 3)))
        _ <- A.s.i.<=(B.i_).OwnB.i_.>=(2).query.get.map(_ ==> List(("a", 1), ("b", 3)))
        _ <- A.s.i.<=(B.i_).OwnB.i_.<(2).query.get.map(_ ==> List())
        _ <- A.s.i.<=(B.i_).OwnB.i_.<=(2).query.get.map(_ ==> List(("a", 1)))

        _ <- A.s.i_.<=(B.i_).OwnB.i(2).query.get.map(_ ==> List(("a", 2)))
        _ <- A.s.i_.<=(B.i_).OwnB.i.not(2).query.get.map(_ ==> List(("b", 3)))
        _ <- A.s.i_.<=(B.i_).OwnB.i.>(2).query.get.map(_ ==> List(("b", 3)))
        _ <- A.s.i_.<=(B.i_).OwnB.i.>=(2).query.get.map(_ ==> List(("a", 2), ("b", 3)))
        _ <- A.s.i_.<=(B.i_).OwnB.i.<(2).query.get.map(_ ==> List())
        _ <- A.s.i_.<=(B.i_).OwnB.i.<=(2).query.get.map(_ ==> List(("a", 2)))

        _ <- A.s.i_.<=(B.i_).OwnB.i_(2).query.get.map(_ ==> List("a"))
        _ <- A.s.i_.<=(B.i_).OwnB.i_.not(2).query.get.map(_ ==> List("b"))
        _ <- A.s.i_.<=(B.i_).OwnB.i_.>(2).query.get.map(_ ==> List("b"))
        _ <- A.s.i_.<=(B.i_).OwnB.i_.>=(2).query.get.map(_ ==> List("a", "b"))
        _ <- A.s.i_.<=(B.i_).OwnB.i_.<(2).query.get.map(_ ==> List())
        _ <- A.s.i_.<=(B.i_).OwnB.i_.<=(2).query.get.map(_ ==> List("a"))
        ...
        // Filter compare attribute itself
        _ <- A.s.i(5).OwnB.i.<=(A.i_).query.get.map(_ ==> List(("c", 5, 4)))
        _ <- A.s.i.not(5).OwnB.i.<=(A.i_).query.get.map(_ ==> List(("b", 3, 3)))
        _ <- A.s.i.>(5).OwnB.i.<=(A.i_).query.get.map(_ ==> List())
        _ <- A.s.i.>=(5).OwnB.i.<=(A.i_).query.get.map(_ ==> List(("c", 5, 4)))
        _ <- A.s.i.<(5).OwnB.i.<=(A.i_).query.get.map(_ ==> List(("b", 3, 3)))
        _ <- A.s.i.<=(5).OwnB.i.<=(A.i_).query.get.map(_ ==> List(("b", 3, 3), ("c", 5, 4)))

        _ <- A.s.i(5).OwnB.i_.<=(A.i_).query.get.map(_ ==> List(("c", 5)))
        _ <- A.s.i.not(5).OwnB.i_.<=(A.i_).query.get.map(_ ==> List(("b", 3)))
        _ <- A.s.i.>(5).OwnB.i_.<=(A.i_).query.get.map(_ ==> List())
        _ <- A.s.i.>=(5).OwnB.i_.<=(A.i_).query.get.map(_ ==> List(("c", 5)))
        _ <- A.s.i.<(5).OwnB.i_.<=(A.i_).query.get.map(_ ==> List(("b", 3)))
        _ <- A.s.i.<=(5).OwnB.i_.<=(A.i_).query.get.map(_ ==> List(("b", 3), ("c", 5)))

        _ <- A.s.i_(5).OwnB.i.<=(A.i_).query.get.map(_ ==> List(("c", 4)))
        _ <- A.s.i_.not(5).OwnB.i.<=(A.i_).query.get.map(_ ==> List(("b", 3)))
        _ <- A.s.i_.>(5).OwnB.i.<=(A.i_).query.get.map(_ ==> List())
        _ <- A.s.i_.>=(5).OwnB.i.<=(A.i_).query.get.map(_ ==> List(("c", 4)))
        _ <- A.s.i_.<(5).OwnB.i.<=(A.i_).query.get.map(_ ==> List(("b", 3)))
        _ <- A.s.i_.<=(5).OwnB.i.<=(A.i_).query.get.map(_ ==> List(("b", 3), ("c", 4)))

        _ <- A.s.i_(5).OwnB.i_.<=(A.i_).query.get.map(_ ==> List("c"))
        _ <- A.s.i_.not(5).OwnB.i_.<=(A.i_).query.get.map(_ ==> List("b"))
        _ <- A.s.i_.>(5).OwnB.i_.<=(A.i_).query.get.map(_ ==> List())
        _ <- A.s.i_.>=(5).OwnB.i_.<=(A.i_).query.get.map(_ ==> List("c"))
        _ <- A.s.i_.<(5).OwnB.i_.<=(A.i_).query.get.map(_ ==> List("b"))
        _ <- A.s.i_.<=(5).OwnB.i_.<=(A.i_).query.get.map(_ ==> List("b", "c"))
      } yield ()
    }
