  ...
  override lazy val tests = Tests {
    ...
    "Basic types, ascending" - types { implicit conn =>
      ...
      for {
        ...
        _ <- Ref.i.Nss.*(Ns.ref).insert((23, List(ref1, ref2))).transact
        ...
        _ <- Ref.i_(23).Nss.*(Ns.ref.a1).query.get.map(_ ==> List(List(ref1, ref2)))
    ...
    "Basic types, descending" - types { implicit conn =>
      ...
      for {
        ...
        _ <- Ref.i_(10).Nss.*(Ns.duration.d1).query.get.map(_ ==> List(List(duration2, duration1)))
        _ <- Ref.i_(11).Nss.*(Ns.instant.d1).query.get.map(_ ==> List(List(instant2, instant1)))
        _ <- Ref.i_(12).Nss.*(Ns.localDate.d1).query.get.map(_ ==> List(List(localDate2, localDate1)))
        _ <- Ref.i_(13).Nss.*(Ns.localTime.d1).query.get.map(_ ==> List(List(localTime2, localTime1)))
        _ <- Ref.i_(14).Nss.*(Ns.localDateTime.d1).query.get.map(_ ==> List(List(localDateTime2, localDateTime1)))
        _ <- Ref.i_(15).Nss.*(Ns.offsetTime.d1).query.get.map(_ ==> List(List(offsetTime2, offsetTime1)))
        _ <- Ref.i_(16).Nss.*(Ns.offsetDateTime.d1).query.get.map(_ ==> List(List(offsetDateTime2, offsetDateTime1)))
        _ <- Ref.i_(17).Nss.*(Ns.zonedDateTime.d1).query.get.map(_ ==> List(List(zonedDateTime2, zonedDateTime1)))
        _ <- Ref.i_(18).Nss.*(Ns.uuid.d1).query.get.map(_ ==> List(List(uuid2, uuid1)))
        _ <- Ref.i_(19).Nss.*(Ns.uri.d1).query.get.map(_ ==> List(List(uri2, uri1)))
        _ <- Ref.i_(20).Nss.*(Ns.byte.d1).query.get.map(_ ==> List(List(byte2, byte1)))
        _ <- Ref.i_(21).Nss.*(Ns.short.d1).query.get.map(_ ==> List(List(short2, short1)))
        _ <- Ref.i_(22).Nss.*(Ns.char.d1).query.get.map(_ ==> List(List(char2, char1)))
        _ <- Ref.i_(23).Nss.*(Ns.ref.d1).query.get.map(_ ==> List(List(ref2, ref1)))
    ...
    "OptNested type, optional" - types { implicit conn =>
      ...
      for {
        ...
        _ <- Ref.i.Nss.*(Ns.i.duration_?).insert((10, List(
          (1, Some(duration1)),
          (2, Some(duration2)),
          (3, None)))).transact
        _ <- Ref.i_(10).Nss.*?(Ns.i.a2.duration_?.a1).query.get.map(_ ==> List(List(
          (3, None),
          (1, Some(duration1)),
          (2, Some(duration2)))))
        _ <- Ref.i_(10).Nss.*?(Ns.i.d2.duration_?.d1).query.get.map(_ ==> List(List(
          (2, Some(duration2)),
          (1, Some(duration1)),
          (3, None))))

        _ <- Ref.i.Nss.*(Ns.i.instant_?).insert((11, List(
          (1, Some(instant1)),
          (2, Some(instant2)),
          (3, None)))).transact
        _ <- Ref.i_(11).Nss.*?(Ns.i.a2.instant_?.a1).query.get.map(_ ==> List(List(
          (3, None),
          (1, Some(instant1)),
          (2, Some(instant2)))))
        _ <- Ref.i_(11).Nss.*?(Ns.i.d2.instant_?.d1).query.get.map(_ ==> List(List(
          (2, Some(instant2)),
          (1, Some(instant1)),
          (3, None))))

        _ <- Ref.i.Nss.*(Ns.i.localDate_?).insert((12, List(
          (1, Some(localDate1)),
          (2, Some(localDate2)),
          (3, None)))).transact
        _ <- Ref.i_(12).Nss.*?(Ns.i.a2.localDate_?.a1).query.get.map(_ ==> List(List(
          (3, None),
          (1, Some(localDate1)),
          (2, Some(localDate2)))))
        _ <- Ref.i_(12).Nss.*?(Ns.i.d2.localDate_?.d1).query.get.map(_ ==> List(List(
          (2, Some(localDate2)),
          (1, Some(localDate1)),
          (3, None))))

        _ <- Ref.i.Nss.*(Ns.i.localTime_?).insert((13, List(
          (1, Some(localTime1)),
          (2, Some(localTime2)),
          (3, None)))).transact
        _ <- Ref.i_(13).Nss.*?(Ns.i.a2.localTime_?.a1).query.get.map(_ ==> List(List(
          (3, None),
          (1, Some(localTime1)),
          (2, Some(localTime2)))))
        _ <- Ref.i_(13).Nss.*?(Ns.i.d2.localTime_?.d1).query.get.map(_ ==> List(List(
          (2, Some(localTime2)),
          (1, Some(localTime1)),
          (3, None))))

        _ <- Ref.i.Nss.*(Ns.i.localDateTime_?).insert((14, List(
          (1, Some(localDateTime1)),
          (2, Some(localDateTime2)),
          (3, None)))).transact
        _ <- Ref.i_(14).Nss.*?(Ns.i.a2.localDateTime_?.a1).query.get.map(_ ==> List(List(
          (3, None),
          (1, Some(localDateTime1)),
          (2, Some(localDateTime2)))))
        _ <- Ref.i_(14).Nss.*?(Ns.i.d2.localDateTime_?.d1).query.get.map(_ ==> List(List(
          (2, Some(localDateTime2)),
          (1, Some(localDateTime1)),
          (3, None))))

        _ <- Ref.i.Nss.*(Ns.i.offsetTime_?).insert((15, List(
          (1, Some(offsetTime1)),
          (2, Some(offsetTime2)),
          (3, None)))).transact
        _ <- Ref.i_(15).Nss.*?(Ns.i.a2.offsetTime_?.a1).query.get.map(_ ==> List(List(
          (3, None),
          (1, Some(offsetTime1)),
          (2, Some(offsetTime2)))))
        _ <- Ref.i_(15).Nss.*?(Ns.i.d2.offsetTime_?.d1).query.get.map(_ ==> List(List(
          (2, Some(offsetTime2)),
          (1, Some(offsetTime1)),
          (3, None))))

        _ <- Ref.i.Nss.*(Ns.i.offsetDateTime_?).insert((16, List(
          (1, Some(offsetDateTime1)),
          (2, Some(offsetDateTime2)),
          (3, None)))).transact
        _ <- Ref.i_(16).Nss.*?(Ns.i.a2.offsetDateTime_?.a1).query.get.map(_ ==> List(List(
          (3, None),
          (1, Some(offsetDateTime1)),
          (2, Some(offsetDateTime2)))))
        _ <- Ref.i_(16).Nss.*?(Ns.i.d2.offsetDateTime_?.d1).query.get.map(_ ==> List(List(
          (2, Some(offsetDateTime2)),
          (1, Some(offsetDateTime1)),
          (3, None))))

        _ <- Ref.i.Nss.*(Ns.i.zonedDateTime_?).insert((17, List(
          (1, Some(zonedDateTime1)),
          (2, Some(zonedDateTime2)),
          (3, None)))).transact
        _ <- Ref.i_(17).Nss.*?(Ns.i.a2.zonedDateTime_?.a1).query.get.map(_ ==> List(List(
          (3, None),
          (1, Some(zonedDateTime1)),
          (2, Some(zonedDateTime2)))))
        _ <- Ref.i_(17).Nss.*?(Ns.i.d2.zonedDateTime_?.d1).query.get.map(_ ==> List(List(
          (2, Some(zonedDateTime2)),
          (1, Some(zonedDateTime1)),
          (3, None))))

        _ <- Ref.i.Nss.*(Ns.i.uuid_?).insert((18, List(
          (1, Some(uuid1)),
          (2, Some(uuid2)),
          (3, None)))).transact
        _ <- Ref.i_(18).Nss.*?(Ns.i.a2.uuid_?.a1).query.get.map(_ ==> List(List(
          (3, None),
          (1, Some(uuid1)),
          (2, Some(uuid2)))))
        _ <- Ref.i_(18).Nss.*?(Ns.i.d2.uuid_?.d1).query.get.map(_ ==> List(List(
          (2, Some(uuid2)),
          (1, Some(uuid1)),
          (3, None))))

        _ <- Ref.i.Nss.*(Ns.i.uri_?).insert((19, List(
          (1, Some(uri1)),
          (2, Some(uri2)),
          (3, None)))).transact
        _ <- Ref.i_(19).Nss.*?(Ns.i.a2.uri_?.a1).query.get.map(_ ==> List(List(
          (3, None),
          (1, Some(uri1)),
          (2, Some(uri2)))))
        _ <- Ref.i_(19).Nss.*?(Ns.i.d2.uri_?.d1).query.get.map(_ ==> List(List(
          (2, Some(uri2)),
          (1, Some(uri1)),
          (3, None))))

        _ <- Ref.i.Nss.*(Ns.i.byte_?).insert((20, List(
          (1, Some(byte1)),
          (2, Some(byte2)),
          (3, None)))).transact
        _ <- Ref.i_(20).Nss.*?(Ns.i.a2.byte_?.a1).query.get.map(_ ==> List(List(
          (3, None),
          (1, Some(byte1)),
          (2, Some(byte2)))))
        _ <- Ref.i_(20).Nss.*?(Ns.i.d2.byte_?.d1).query.get.map(_ ==> List(List(
          (2, Some(byte2)),
          (1, Some(byte1)),
          (3, None))))

        _ <- Ref.i.Nss.*(Ns.i.short_?).insert((21, List(
          (1, Some(short1)),
          (2, Some(short2)),
          (3, None)))).transact
        _ <- Ref.i_(21).Nss.*?(Ns.i.a2.short_?.a1).query.get.map(_ ==> List(List(
          (3, None),
          (1, Some(short1)),
          (2, Some(short2)))))
        _ <- Ref.i_(21).Nss.*?(Ns.i.d2.short_?.d1).query.get.map(_ ==> List(List(
          (2, Some(short2)),
          (1, Some(short1)),
          (3, None))))

        _ <- Ref.i.Nss.*(Ns.i.char_?).insert((22, List(
          (1, Some(char1)),
          (2, Some(char2)),
          (3, None)))).transact
        _ <- Ref.i_(22).Nss.*?(Ns.i.a2.char_?.a1).query.get.map(_ ==> List(List(
          (3, None),
          (1, Some(char1)),
          (2, Some(char2)))))
        _ <- Ref.i_(22).Nss.*?(Ns.i.d2.char_?.d1).query.get.map(_ ==> List(List(
          (2, Some(char2)),
          (1, Some(char1)),
          (3, None))))

        _ <- Ref.i.Nss.*(Ns.i.ref_?).insert((23, List(
          (1, Some(ref1)),
          (2, Some(ref2)),
          (3, None)))).transact
        _ <- Ref.i_(23).Nss.*?(Ns.i.a2.ref_?.a1).query.get.map(_ ==> List(List(
          (3, None),
          (1, Some(ref1)),
          (2, Some(ref2)))))
        _ <- Ref.i_(23).Nss.*?(Ns.i.d2.ref_?.d1).query.get.map(_ ==> List(List(
          (2, Some(ref2)),
          (1, Some(ref1)),
          (3, None))))
      } yield ()
