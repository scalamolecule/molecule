...
trait FilterSeq_BigDecimal_ extends CoreTestSuite with Api_async { spi: Spi_async =>
  ...
  override lazy val tests = Tests {
    ...
    "Mandatory" - {
      ...
      "has" - types { implicit conn =>
        for {
          _ <- Ns.i.bigDecimalSeq.insert(a, b).transact
          ...
          // "Has this OR that"
          _ <- Ns.i.a1.bigDecimalSeq.has(bigDecimal0, bigDecimal1).query.get.map(_ ==> List(a))
          ...
          // Same as
          _ <- Ns.i.a1.bigDecimalSeq.has(List(bigDecimal0, bigDecimal1)).query.get.map(_ ==> List(a))
    ...
    "Tacit" - {
      ...
      "has" - types { implicit conn =>
        for {
          ...
          // "Has this OR that"
          _ <- Ns.i.a1.bigDecimalSeq_.has(bigDecimal0, bigDecimal1).query.get.map(_ ==> List(1))
          ...
          _ <- Ns.i.a1.bigDecimalSeq_.has(bigDecimal3, bigDecimal4).query.get.map(_ ==> List(2))
          // Same as
          _ <- Ns.i.a1.bigDecimalSeq_.has(List(bigDecimal0, bigDecimal1)).query.get.map(_ ==> List(1))
          ...
          _ <- Ns.i.a1.bigDecimalSeq_.has(List(bigDecimal3, bigDecimal4)).query.get.map(_ ==> List(2))
