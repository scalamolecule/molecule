...
trait FilterMap_Int extends CoreTestSuite with Api_async { spi: Spi_async =>
    ...
    "Mandatory" - {
      ...
      "Map with certain keys" - types { implicit conn =>
        for {
          ...
          _ <- Ns.i.a1.intMap("_").query.get.map(_ ==> List())
      ...
      "Map with certain values" - types { implicit conn =>
        for {
          ...
          _ <- Ns.i.a1.intMap.has(int4).query.get.map(_ ==> List(b))
          // Same as
          _ <- Ns.i.a1.intMap.has(Seq(int0)).query.get.map(_ ==> List())
          _ <- Ns.i.a1.intMap.has(Seq(int1)).query.get.map(_ ==> List(a))
          _ <- Ns.i.a1.intMap.has(Seq(int2)).query.get.map(_ ==> List(a, b))
          _ <- Ns.i.a1.intMap.has(Seq(int3)).query.get.map(_ ==> List(b))
          _ <- Ns.i.a1.intMap.has(Seq(int4)).query.get.map(_ ==> List(b))
          ...
          _ <- Ns.i.a1.intMap.has(int4, int5).query.get.map(_ ==> List(b))
          _ <- Ns.i.a1.intMap.has(int5, int6).query.get.map(_ ==> List())
          // Same as
          _ <- Ns.i.a1.intMap.has(Seq(int0, int1)).query.get.map(_ ==> List(a))
          _ <- Ns.i.a1.intMap.has(Seq(int1, int2)).query.get.map(_ ==> List(a, b))
          _ <- Ns.i.a1.intMap.has(Seq(int2, int3)).query.get.map(_ ==> List(a, b))
          _ <- Ns.i.a1.intMap.has(Seq(int3, int4)).query.get.map(_ ==> List(b))
          _ <- Ns.i.a1.intMap.has(Seq(int4, int5)).query.get.map(_ ==> List(b))
          _ <- Ns.i.a1.intMap.has(Seq(int5, int6)).query.get.map(_ ==> List())

          // No values match nothing
          _ <- Ns.i.a1.intMap.has(Seq.empty[Int]).query.get.map(_ ==> List())
        } yield ()
      }
      ...
      "Map without certain values" - types { implicit conn =>
        for {
          ...
          _ <- Ns.i.a1.intMap.hasNo(int1, int3).query.get.map(_ ==> List())
          _ <- Ns.i.a1.intMap.hasNo(int1, int3).query.get.map(_ ==> List())
          _ <- Ns.i.a1.intMap.hasNo(int1, int5).query.get.map(_ ==> List(b))
          // Same as
          _ <- Ns.i.a1.intMap.hasNo(List(int1, int2)).query.get.map(_ ==> List())
          _ <- Ns.i.a1.intMap.hasNo(List(int1, int3)).query.get.map(_ ==> List())
          _ <- Ns.i.a1.intMap.hasNo(List(int1, int3)).query.get.map(_ ==> List())
          _ <- Ns.i.a1.intMap.hasNo(List(int1, int5)).query.get.map(_ ==> List(b))
    ...
    "Tacit" - {
      ...
      "Match map with certain keys" - types { implicit conn =>
        for {
          ...
          _ <- Ns.i.a1.intMap_("_").query.get.map(_ ==> List())
          _ <- Ns.i.a1.intMap_("a").query.get.map(_ ==> List(1, 2))
          ...
          _ <- Ns.i.a1.intMap_("_", "c").query.get.map(_ ==> List(2))
          // Same as
          _ <- Ns.i.a1.intMap_(List("_")).query.get.map(_ ==> List())
          _ <- Ns.i.a1.intMap_(List("a")).query.get.map(_ ==> List(1, 2))
          ...
          _ <- Ns.i.a1.intMap_(List("_", "c")).query.get.map(_ ==> List(2))
      ...
      "Match map without certain keys" - types { implicit conn =>
        for {
          ...
          _ <- Ns.i.a1.intMap_.not("a").query.get.map(_ ==> List())
          _ <- Ns.i.a1.intMap_.not("b").query.get.map(_ ==> List())
          _ <- Ns.i.a1.intMap_.not("c").query.get.map(_ ==> List(1))
          _ <- Ns.i.a1.intMap_.not("a", "c").query.get.map(_ ==> List())
          _ <- Ns.i.a1.intMap_.not("_", "c").query.get.map(_ ==> List(1))
          // Same as
          _ <- Ns.i.a1.intMap_.not(List("_")).query.get.map(_ ==> List(1, 2))
          _ <- Ns.i.a1.intMap_.not(List("a")).query.get.map(_ ==> List())
          _ <- Ns.i.a1.intMap_.not(List("b")).query.get.map(_ ==> List())
          _ <- Ns.i.a1.intMap_.not(List("c")).query.get.map(_ ==> List(1))
          _ <- Ns.i.a1.intMap_.not(List("a", "c")).query.get.map(_ ==> List())
          _ <- Ns.i.a1.intMap_.not(List("_", "c")).query.get.map(_ ==> List(1))
