  ...
  override lazy val tests = Tests {
    ...
    "apply (replace/add all)" - types { implicit conn =>
      for {
        ...
        _ <- Ns(id).shorts(Set.empty[Short]).update.transact
    ...
    "add" - types { implicit conn =>
      for {
        ...
        _ <- Ns(id).shorts.add(Seq(short5, short6)).update.transact
    ...
    "remove" - types { implicit conn =>
      for {
        id <- Ns.shorts(Set(short1, short2, short3, short4, short5, short6, short7)).save.transact.map(_.id)
        ...
        _ <- Ns(id).shorts.remove(short9).update.transact
        _ <- Ns.shorts.query.get.map(_.head ==> Set(short1, short2, short3, short4, short5, short6))

        // Removing duplicate values removes the distinct value
        _ <- Ns(id).shorts.remove(short6, short6).update.transact
        _ <- Ns.shorts.query.get.map(_.head ==> Set(short1, short2, short3, short4, short5))

        // Remove multiple values (vararg)
        _ <- Ns(id).shorts.remove(short4, short5).update.transact
        _ <- Ns.shorts.query.get.map(_.head ==> Set(short1, short2, short3))

        // Remove multiple values (Seq)
        _ <- Ns(id).shorts.remove(Seq(short2, short3)).update.transact
