    ...
    "Mandatory" - {
      ...
      "apply (equal)" - types { implicit conn =>
        ...
        for {
          ...
          _ <- Ns.i.a1.durations(Set(duration1, duration2), Set(duration2, duration3, duration4)).query.get.map(_ ==> List(a, b))
          // Same as
          ...
          _ <- Ns.i.a1.durations(Seq(Set(duration1, duration2), Set(duration2, duration3, duration4))).query.get.map(_ ==> List(a, b))


          // Empty Seq/Sets match nothing
          _ <- Ns.i.a1.durations(Set(duration1, duration2), Set.empty[Duration]).query.get.map(_ ==> List(a))
          _ <- Ns.i.a1.durations(Set.empty[Duration], Set(duration1, duration2)).query.get.map(_ ==> List(a))
      ...
      "not equal" - types { implicit conn =>
        ...
        for {
          ...
          _ <- Ns.i.a1.durations.not(Set(duration1, duration2), Set(duration2, duration3, duration4)).query.get.map(_ ==> List())
          // Same as
          ...
          _ <- Ns.i.a1.durations.not(Seq(Set(duration1, duration2), Set(duration2, duration3, duration4))).query.get.map(_ ==> List())
    ...
    "Tacit" - {
      ...
      "attr" - types { implicit conn =>
        for {
          ...
          // durations not asserted for i = 0
      ...
      "apply (equal)" - types { implicit conn =>
        for {
          ...
          _ <- Ns.i.a1.durations_().query.get.map(_ ==> List(0))
          ...
          _ <- Ns.i.a1.durations_(Set(duration1, duration2), Set(duration2, duration3, duration4)).query.get.map(_ ==> List(1, 2))
          // Same as
          ...
          _ <- Ns.i.a1.durations_(Seq(Set(duration1, duration2), Set(duration2, duration3, duration4))).query.get.map(_ ==> List(1, 2))
      ...
      "not equal" - types { implicit conn =>
        for {
          ...
          _ <- Ns.i.a1.durations_.not(Set(duration1, duration2), Set(duration2, duration3, duration4)).query.get.map(_ ==> List())
          // Same as
          ...
          _ <- Ns.i.a1.durations_.not(Seq(Set(duration1, duration2), Set(duration2, duration3, duration4))).query.get.map(_ ==> List())
    ...
    "Optional" - {
      ...
      "apply (equal)" - types { implicit conn =>
        ...
        for {
          ...
          _ <- Ns.i.a1.durations_?(Some(Seq(Set(duration1, duration2), Set(duration2, duration3, duration4)))).query.get.map(_ ==> List(a, b))
      ...
      "not equal" - types { implicit conn =>
        ...
        for {
          ...
          _ <- Ns.i.a1.durations_?.not(Some(Seq(Set(duration1, duration2), Set(duration2, duration3, duration4)))).query.get.map(_ ==> List())
          ...
          _ <- Ns.i.a1.durations_?.not(Option.empty[Set[Duration]]).query.get.map(_ ==> List(a, b))
          _ <- Ns.i.a1.durations_?.not(Option.empty[Seq[Set[Duration]]]).query.get.map(_ ==> List(a, b))
        } yield ()
      }
