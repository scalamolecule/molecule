  ...
  override lazy val tests = Tests {
    ...
    "Mandatory" - {
      ...
      "has" - types { implicit conn =>
        for {
          _ <- Ns.i.byteSet.insert(a, b).transact
    ...
    "Tacit" - {
      ...
      "has" - types { implicit conn =>
        for {
          ...
          // Same as
          _ <- Ns.i.a1.byteSet_.has(Seq(byte0, byte1)).query.get.map(_ ==> List(1))
          ...
          _ <- Ns.i.a1.byteSet_.has(Seq(byte3, byte4)).query.get.map(_ ==> List(2))
