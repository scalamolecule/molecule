    ...
    "Mandatory" - {
      ...
      "Map without certain keys" - types { implicit conn =>
        for {
          ...
          _ <- Ns.i.a1.floatMap.not("_").query.get.map(_ ==> List(a, b))
          _ <- Ns.i.a1.floatMap.not("a").query.get.map(_ ==> List())
          _ <- Ns.i.a1.floatMap.not("b").query.get.map(_ ==> List())
          _ <- Ns.i.a1.floatMap.not("c").query.get.map(_ ==> List(a))
          _ <- Ns.i.a1.floatMap.not("a", "c").query.get.map(_ ==> List())
          _ <- Ns.i.a1.floatMap.not("_", "c").query.get.map(_ ==> List(a))
          // Same as
          _ <- Ns.i.a1.floatMap.not(List("_")).query.get.map(_ ==> List(a, b))
          _ <- Ns.i.a1.floatMap.not(List("a")).query.get.map(_ ==> List())
          _ <- Ns.i.a1.floatMap.not(List("b")).query.get.map(_ ==> List())
          _ <- Ns.i.a1.floatMap.not(List("c")).query.get.map(_ ==> List(a))
          _ <- Ns.i.a1.floatMap.not(List("a", "c")).query.get.map(_ ==> List())
          _ <- Ns.i.a1.floatMap.not(List("_", "c")).query.get.map(_ ==> List(a))

          // Negating empty Seq of keys matches all
          _ <- Ns.i.a1.floatMap.not(List.empty[String]).query.get.map(_ ==> List(a, b))
        } yield ()
      }
