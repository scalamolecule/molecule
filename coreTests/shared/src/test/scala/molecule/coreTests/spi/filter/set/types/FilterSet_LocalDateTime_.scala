    ...
    "Mandatory" - {
      ...
      "apply (equal)" - types { implicit conn =>
        ...
        for {
          ...
          _ <- Ns.i.a1.localDateTimes(Set(localDateTime1, localDateTime2), Set(localDateTime2, localDateTime3, localDateTime4)).query.get.map(_ ==> List(a, b))
          // Same as
          ...
          _ <- Ns.i.a1.localDateTimes(Seq(Set(localDateTime1, localDateTime2), Set(localDateTime2, localDateTime3, localDateTime4))).query.get.map(_ ==> List(a, b))


          // Empty Seq/Sets match nothing
          _ <- Ns.i.a1.localDateTimes(Set(localDateTime1, localDateTime2), Set.empty[LocalDateTime]).query.get.map(_ ==> List(a))
          _ <- Ns.i.a1.localDateTimes(Set.empty[LocalDateTime], Set(localDateTime1, localDateTime2)).query.get.map(_ ==> List(a))
      ...
      "not equal" - types { implicit conn =>
        ...
        for {
          ...
          _ <- Ns.i.a1.localDateTimes.not(Set(localDateTime1, localDateTime2), Set(localDateTime2, localDateTime3, localDateTime4)).query.get.map(_ ==> List())
          // Same as
          ...
          _ <- Ns.i.a1.localDateTimes.not(Seq(Set(localDateTime1, localDateTime2), Set(localDateTime2, localDateTime3, localDateTime4))).query.get.map(_ ==> List())
    ...
    "Tacit" - {
      ...
      "attr" - types { implicit conn =>
        for {
          ...
          // localDateTimes not asserted for i = 0
      ...
      "apply (equal)" - types { implicit conn =>
        for {
          ...
          _ <- Ns.i.a1.localDateTimes_().query.get.map(_ ==> List(0))
          ...
          _ <- Ns.i.a1.localDateTimes_(Set(localDateTime1, localDateTime2), Set(localDateTime2, localDateTime3, localDateTime4)).query.get.map(_ ==> List(1, 2))
          // Same as
          ...
          _ <- Ns.i.a1.localDateTimes_(Seq(Set(localDateTime1, localDateTime2), Set(localDateTime2, localDateTime3, localDateTime4))).query.get.map(_ ==> List(1, 2))
      ...
      "not equal" - types { implicit conn =>
        for {
          ...
          _ <- Ns.i.a1.localDateTimes_.not(Set(localDateTime1, localDateTime2), Set(localDateTime2, localDateTime3, localDateTime4)).query.get.map(_ ==> List())
          // Same as
          ...
          _ <- Ns.i.a1.localDateTimes_.not(Seq(Set(localDateTime1, localDateTime2), Set(localDateTime2, localDateTime3, localDateTime4))).query.get.map(_ ==> List())
    ...
    "Optional" - {
      ...
      "apply (equal)" - types { implicit conn =>
        ...
        for {
          ...
          _ <- Ns.i.a1.localDateTimes_?(Some(Seq(Set(localDateTime1, localDateTime2), Set(localDateTime2, localDateTime3, localDateTime4)))).query.get.map(_ ==> List(a, b))
      ...
      "not equal" - types { implicit conn =>
        ...
        for {
          ...
          _ <- Ns.i.a1.localDateTimes_?.not(Some(Seq(Set(localDateTime1, localDateTime2), Set(localDateTime2, localDateTime3, localDateTime4)))).query.get.map(_ ==> List())
          ...
          _ <- Ns.i.a1.localDateTimes_?.not(Option.empty[Set[LocalDateTime]]).query.get.map(_ ==> List(a, b))
          _ <- Ns.i.a1.localDateTimes_?.not(Option.empty[Seq[Set[LocalDateTime]]]).query.get.map(_ ==> List(a, b))
        } yield ()
      }
