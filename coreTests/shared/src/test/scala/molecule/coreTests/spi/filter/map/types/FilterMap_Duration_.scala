    ...
    "Mandatory" - {
      ...
      "Get value by key" - types { implicit conn =>
        ...
        for {
          ...
          _ <- Ns.i.a1.durationMap("_").query.get.map(_ ==> Nil) // When no map is saved
    ...
    "Tacit" - {
      ...
      "contains key(s)" - types { implicit conn =>
        for {
          ...
          _ <- Ns.i.a1.durationMap_(List("a", "_")).query.get.map(_ ==> List(1))
          ...
          _ <- Ns.i.a1.durationMap.durationMap_("_").query.get.map(_ ==> Nil)
          ...
          _ <- Ns.i.a1.durationMap.durationMap_("a", "_").query.get.map(_ ==> List((1, Map(a1, b2))))
        } yield ()
      }
      ...
      "doesn't contain key(s)" - types { implicit conn =>
        for {
          ...
          _ <- Ns.i.a1.durationMap_.not(List("a", "_")).query.get.map(_ ==> List(2))

          // Negating empty Seq of keys matches all
          _ <- Ns.i.a1.durationMap_.not(List.empty[String]).query.get.map(_ ==> List(1, 2))

          // Combine with retrieval
          _ <- Ns.i.a1.durationMap.durationMap_.not("_").query.get.map(_ ==> List((1, Map(a1, b2)), (2, Map(b3, c4))))
          ...
          _ <- Ns.i.a1.durationMap.durationMap_.not("a", "_").query.get.map(_ ==> List((2, Map(b3, c4))))
        } yield ()
      }
      ...
      "has value(s)" - types { implicit conn =>
        for {
          ...
          _ <- Ns.i.a1.durationMap.durationMap_.has(duration0, duration1).query.get.map(_ ==> List((1, Map(a1, b2))))
          ...
          _ <- Ns.i.a1.durationMap.durationMap_.has(duration4, duration5).query.get.map(_ ==> List((2, Map(b3, c4))))
          _ <- Ns.i.a1.durationMap.durationMap_.has(duration5, duration6).query.get.map(_ ==> List())
        } yield ()
      }
      ...
      "doesn't have value(s)" - types { implicit conn =>
        for {
          ...
          _ <- Ns.i.a1.durationMap.durationMap_.hasNo(duration0, duration1).query.get.map(_ ==> List((2, Map(b3, c4))))
          ...
          _ <- Ns.i.a1.durationMap.durationMap_.hasNo(duration4, duration5).query.get.map(_ ==> List((1, Map(a1, b2))))
          _ <- Ns.i.a1.durationMap.durationMap_.hasNo(duration5, duration6).query.get.map(_ ==> List((1, Map(a1, b2)), (2, Map(b3, c4))))
        } yield ()
      }
    }
  }
