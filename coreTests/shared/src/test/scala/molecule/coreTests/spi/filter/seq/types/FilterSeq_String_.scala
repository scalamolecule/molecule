  ...
  override lazy val tests = Tests {
    ...
    "Mandatory" - {
      ...
      "has" - types { implicit conn =>
        for {
          _ <- Ns.i.stringSeq.insert(a, b).transact
          ...
          // "Has this OR that"
          _ <- Ns.i.a1.stringSeq.has(string0, string1).query.get.map(_ ==> List(a))
          ...
          // Same as
          _ <- Ns.i.a1.stringSeq.has(List(string0, string1)).query.get.map(_ ==> List(a))
    ...
    "Tacit" - {
      ...
      "has" - types { implicit conn =>
        for {
          ...
          // "Has this OR that"
          _ <- Ns.i.a1.stringSeq_.has(string0, string1).query.get.map(_ ==> List(1))
          ...
          _ <- Ns.i.a1.stringSeq_.has(string3, string4).query.get.map(_ ==> List(2))
          // Same as
          _ <- Ns.i.a1.stringSeq_.has(List(string0, string1)).query.get.map(_ ==> List(1))
          ...
          _ <- Ns.i.a1.stringSeq_.has(List(string3, string4)).query.get.map(_ ==> List(2))
