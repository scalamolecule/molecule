...
trait FilterMap_BigDecimal_ extends CoreTestSuite with Api_async { spi: Spi_async =>
  ...
  override lazy val tests = Tests {
    ...
    "Mandatory" - {
      ...
      "Map with certain keys" - types { implicit conn =>
        for {
          ...
          _ <- Ns.i.a1.bigDecimalMap("_").query.get.map(_ ==> List())
      ...
      "Map with certain values" - types { implicit conn =>
        for {
          ...
          _ <- Ns.i.a1.bigDecimalMap.has(bigDecimal0).query.get.map(_ ==> List())
          _ <- Ns.i.a1.bigDecimalMap.has(bigDecimal1).query.get.map(_ ==> List(a))
          _ <- Ns.i.a1.bigDecimalMap.has(bigDecimal2).query.get.map(_ ==> List(a, b))
          _ <- Ns.i.a1.bigDecimalMap.has(bigDecimal3).query.get.map(_ ==> List(b))
          _ <- Ns.i.a1.bigDecimalMap.has(bigDecimal4).query.get.map(_ ==> List(b))
          // Same as
          _ <- Ns.i.a1.bigDecimalMap.has(Seq(bigDecimal0)).query.get.map(_ ==> List())
          _ <- Ns.i.a1.bigDecimalMap.has(Seq(bigDecimal1)).query.get.map(_ ==> List(a))
          _ <- Ns.i.a1.bigDecimalMap.has(Seq(bigDecimal2)).query.get.map(_ ==> List(a, b))
          _ <- Ns.i.a1.bigDecimalMap.has(Seq(bigDecimal3)).query.get.map(_ ==> List(b))
          _ <- Ns.i.a1.bigDecimalMap.has(Seq(bigDecimal4)).query.get.map(_ ==> List(b))

          // OR semantics when multiple values

          // "Has this OR that" value
          _ <- Ns.i.a1.bigDecimalMap.has(bigDecimal0, bigDecimal1).query.get.map(_ ==> List(a))
          _ <- Ns.i.a1.bigDecimalMap.has(bigDecimal1, bigDecimal2).query.get.map(_ ==> List(a, b))
          _ <- Ns.i.a1.bigDecimalMap.has(bigDecimal2, bigDecimal3).query.get.map(_ ==> List(a, b))
          _ <- Ns.i.a1.bigDecimalMap.has(bigDecimal3, bigDecimal4).query.get.map(_ ==> List(b))
          _ <- Ns.i.a1.bigDecimalMap.has(bigDecimal4, bigDecimal5).query.get.map(_ ==> List(b))
          _ <- Ns.i.a1.bigDecimalMap.has(bigDecimal5, bigDecimal6).query.get.map(_ ==> List())
          // Same as
          _ <- Ns.i.a1.bigDecimalMap.has(Seq(bigDecimal0, bigDecimal1)).query.get.map(_ ==> List(a))
          _ <- Ns.i.a1.bigDecimalMap.has(Seq(bigDecimal1, bigDecimal2)).query.get.map(_ ==> List(a, b))
          _ <- Ns.i.a1.bigDecimalMap.has(Seq(bigDecimal2, bigDecimal3)).query.get.map(_ ==> List(a, b))
          _ <- Ns.i.a1.bigDecimalMap.has(Seq(bigDecimal3, bigDecimal4)).query.get.map(_ ==> List(b))
          _ <- Ns.i.a1.bigDecimalMap.has(Seq(bigDecimal4, bigDecimal5)).query.get.map(_ ==> List(b))
          _ <- Ns.i.a1.bigDecimalMap.has(Seq(bigDecimal5, bigDecimal6)).query.get.map(_ ==> List())

          // No values match nothing
          _ <- Ns.i.a1.bigDecimalMap.has(Seq.empty[BigDecimal]).query.get.map(_ ==> List())
        } yield ()
      }
      ...
      "Map without certain values" - types { implicit conn =>
        for {
          ...
          // "Doesn't have this"
          _ <- Ns.i.a1.bigDecimalMap.hasNo(bigDecimal0).query.get.map(_ ==> List(a, b))
          _ <- Ns.i.a1.bigDecimalMap.hasNo(bigDecimal1).query.get.map(_ ==> List(b))
          _ <- Ns.i.a1.bigDecimalMap.hasNo(bigDecimal2).query.get.map(_ ==> List())
          _ <- Ns.i.a1.bigDecimalMap.hasNo(bigDecimal3).query.get.map(_ ==> List(a))
          _ <- Ns.i.a1.bigDecimalMap.hasNo(bigDecimal3).query.get.map(_ ==> List(a))
          _ <- Ns.i.a1.bigDecimalMap.hasNo(bigDecimal5).query.get.map(_ ==> List(a, b))
          // Same as
          _ <- Ns.i.a1.bigDecimalMap.hasNo(List(bigDecimal0)).query.get.map(_ ==> List(a, b))
          _ <- Ns.i.a1.bigDecimalMap.hasNo(List(bigDecimal1)).query.get.map(_ ==> List(b))
          _ <- Ns.i.a1.bigDecimalMap.hasNo(List(bigDecimal2)).query.get.map(_ ==> List())
          _ <- Ns.i.a1.bigDecimalMap.hasNo(List(bigDecimal3)).query.get.map(_ ==> List(a))
          _ <- Ns.i.a1.bigDecimalMap.hasNo(List(bigDecimal3)).query.get.map(_ ==> List(a))
          _ <- Ns.i.a1.bigDecimalMap.hasNo(List(bigDecimal5)).query.get.map(_ ==> List(a, b))

          // OR semantics when multiple values

          // "Has neither this OR that"
          _ <- Ns.i.a1.bigDecimalMap.hasNo(bigDecimal1, bigDecimal2).query.get.map(_ ==> List())
          _ <- Ns.i.a1.bigDecimalMap.hasNo(bigDecimal1, bigDecimal3).query.get.map(_ ==> List())
          _ <- Ns.i.a1.bigDecimalMap.hasNo(bigDecimal1, bigDecimal3).query.get.map(_ ==> List())
          _ <- Ns.i.a1.bigDecimalMap.hasNo(bigDecimal1, bigDecimal5).query.get.map(_ ==> List(b))
          // Same as
          _ <- Ns.i.a1.bigDecimalMap.hasNo(List(bigDecimal1, bigDecimal2)).query.get.map(_ ==> List())
          _ <- Ns.i.a1.bigDecimalMap.hasNo(List(bigDecimal1, bigDecimal3)).query.get.map(_ ==> List())
          _ <- Ns.i.a1.bigDecimalMap.hasNo(List(bigDecimal1, bigDecimal3)).query.get.map(_ ==> List())
          _ <- Ns.i.a1.bigDecimalMap.hasNo(List(bigDecimal1, bigDecimal5)).query.get.map(_ ==> List(b))

          // No values match nothing
          _ <- Ns.i.a1.bigDecimalMap.hasNo(List.empty[BigDecimal]).query.get.map(_ ==> List(a, b))
        } yield ()
      }
    }
    ...
    "Tacit" - {
      ...
      "Match map with certain keys" - types { implicit conn =>
        for {
          ...
          _ <- Ns.i.a1.bigDecimalMap_("_").query.get.map(_ ==> List())
          _ <- Ns.i.a1.bigDecimalMap_("a").query.get.map(_ ==> List(1, 2))
          ...
          _ <- Ns.i.a1.bigDecimalMap_("_", "c").query.get.map(_ ==> List(2))
          // Same as
          _ <- Ns.i.a1.bigDecimalMap_(List("_")).query.get.map(_ ==> List())
          _ <- Ns.i.a1.bigDecimalMap_(List("a")).query.get.map(_ ==> List(1, 2))
          ...
          _ <- Ns.i.a1.bigDecimalMap_(List("_", "c")).query.get.map(_ ==> List(2))

          // Empty Seq of keys matches nothing
          _ <- Ns.i.a1.bigDecimalMap_(List.empty[String]).query.get.map(_ ==> List())
      ...
      "Match map without certain keys" - types { implicit conn =>
        for {
          ...
          _ <- Ns.i.a1.bigDecimalMap_.not("a").query.get.map(_ ==> List())
          _ <- Ns.i.a1.bigDecimalMap_.not("b").query.get.map(_ ==> List())
          _ <- Ns.i.a1.bigDecimalMap_.not("c").query.get.map(_ ==> List(1))
          _ <- Ns.i.a1.bigDecimalMap_.not("a", "c").query.get.map(_ ==> List())
          _ <- Ns.i.a1.bigDecimalMap_.not("_", "c").query.get.map(_ ==> List(1))
          // Same as
          _ <- Ns.i.a1.bigDecimalMap_.not(List("_")).query.get.map(_ ==> List(1, 2))
          _ <- Ns.i.a1.bigDecimalMap_.not(List("a")).query.get.map(_ ==> List())
          _ <- Ns.i.a1.bigDecimalMap_.not(List("b")).query.get.map(_ ==> List())
          _ <- Ns.i.a1.bigDecimalMap_.not(List("c")).query.get.map(_ ==> List(1))
          _ <- Ns.i.a1.bigDecimalMap_.not(List("a", "c")).query.get.map(_ ==> List())
          _ <- Ns.i.a1.bigDecimalMap_.not(List("_", "c")).query.get.map(_ ==> List(1))
      ...
      "Match map with certain values" - types { implicit conn =>
        for {
          ...
          _ <- Ns.i.a1.bigDecimalMap_.has(bigDecimal0).query.get.map(_ ==> List())
          _ <- Ns.i.a1.bigDecimalMap_.has(bigDecimal1).query.get.map(_ ==> List(1))
          _ <- Ns.i.a1.bigDecimalMap_.has(bigDecimal2).query.get.map(_ ==> List(1, 2))
          ...
          _ <- Ns.i.a1.bigDecimalMap_.has(bigDecimal1, bigDecimal2).query.get.map(_ ==> List(1, 2))
          ...
          // Same as
          _ <- Ns.i.a1.bigDecimalMap_.has(List(bigDecimal0)).query.get.map(_ ==> List())
          _ <- Ns.i.a1.bigDecimalMap_.has(List(bigDecimal1)).query.get.map(_ ==> List(1))
          _ <- Ns.i.a1.bigDecimalMap_.has(List(bigDecimal2)).query.get.map(_ ==> List(1, 2))
          ...
          _ <- Ns.i.a1.bigDecimalMap_.has(List(bigDecimal1, bigDecimal2)).query.get.map(_ ==> List(1, 2))
          ...
          _ <- Ns.i.a1.bigDecimalMap_.has(List.empty[BigDecimal]).query.get.map(_ ==> List())
        } yield ()
      }
      ...
      "Match map without certain values" - types { implicit conn =>
        for {
          ...
          _ <- Ns.i.a1.bigDecimalMap_.hasNo(bigDecimal2).query.get.map(_ ==> List())
          ...
          _ <- Ns.i.a1.bigDecimalMap_.hasNo(bigDecimal1, bigDecimal2).query.get.map(_ ==> List())
          ...
          _ <- Ns.i.a1.bigDecimalMap_.hasNo(List(bigDecimal2)).query.get.map(_ ==> List())
          ...
          _ <- Ns.i.a1.bigDecimalMap_.hasNo(List(bigDecimal1, bigDecimal2)).query.get.map(_ ==> List())
    ...
    "Optional" - {
      ...
      "Optional map values by key" - types { implicit conn =>
        ...
        for {
          _ <- Ns.i.bigDecimalMap.insert(a, b).transact
          _ <- Ns.i(3).save.transact // entity without bigDecimalMap
