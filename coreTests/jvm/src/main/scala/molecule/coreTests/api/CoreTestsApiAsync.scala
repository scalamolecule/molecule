...
//    abstract class saveApiAsync[Tpl](save: Save) extends SaveTransaction {
  implicit class saveApiAsync[Tpl](save: Save) extends SaveTransaction {
