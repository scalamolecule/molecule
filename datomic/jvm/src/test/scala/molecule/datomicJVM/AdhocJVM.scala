...
import molecule.datomic._
import molecule.datomic.facade.{Conn_Peer, Datomic_Peer}
...
object AdhocJVM extends App {
  ...
  implicit val conn: Conn_Peer = Datomic_Peer.recreateDbFromEdn(schemaTx.datomicPeer)
