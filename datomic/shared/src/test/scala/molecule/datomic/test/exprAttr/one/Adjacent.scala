package molecule.datomic.test.exprAttr.one
  ...
  override lazy val tests = Tests {
    ...
    ">=" - types { implicit conn =>
      for {
        ...
        _ <- Ns.s.i.>=(Ns.int).query.get.map(_ ==> List(("b", 3, 3), ("c", 5, 4)))
        _ <- Ns.s.i.>=(Ns.int_).query.get.map(_ ==> List(("b", 3), ("c", 5)))
        _ <- Ns.s.i_.>=(Ns.int).query.get.map(_ ==> List(("b", 3), ("c", 4)))
        _ <- Ns.s.i_.>=(Ns.int_).query.get.map(_ ==> List("b", "c"))

        // With expression on expression attribute itself
        _ <- Ns.s.i.>=(Ns.int(3)).query.get.map(_    ==> List(("b", 3, 3)))
        _ <- Ns.s.i.>=(Ns.int.not(3)).query.get.map(_ ==> List(("c", 5, 4)))
        _ <- Ns.s.i.>=(Ns.int.>(3)).query.get.map(_ ==> List(("c", 5, 4)))
        _ <- Ns.s.i.>=(Ns.int.>=(3)).query.get.map(_ ==> List(("b", 3, 3), ("c", 5, 4)))
        _ <- Ns.s.i.>=(Ns.int.<(3)).query.get.map(_ ==> List())
        _ <- Ns.s.i.>=(Ns.int.<=(3)).query.get.map(_ ==> List(("b", 3, 3)))

        _ <- Ns.s.i.>=(Ns.int_(3)).query.get.map(_    ==> List(("b", 3)))
        _ <- Ns.s.i.>=(Ns.int_.not(3)).query.get.map(_ ==> List(("c", 5)))
        _ <- Ns.s.i.>=(Ns.int_.>(3)).query.get.map(_ ==> List(("c", 5)))
        _ <- Ns.s.i.>=(Ns.int_.>=(3)).query.get.map(_ ==> List(("b", 3), ("c", 5)))
        _ <- Ns.s.i.>=(Ns.int_.<(3)).query.get.map(_ ==> List())
        _ <- Ns.s.i.>=(Ns.int_.<=(3)).query.get.map(_ ==> List(("b", 3)))

        _ <- Ns.s.i_.>=(Ns.int(3)).query.get.map(_    ==> List(("b", 3)))
        _ <- Ns.s.i_.>=(Ns.int.not(3)).query.get.map(_ ==> List(("c", 4)))
        _ <- Ns.s.i_.>=(Ns.int.>(3)).query.get.map(_ ==> List(("c", 4)))
        _ <- Ns.s.i_.>=(Ns.int.>=(3)).query.get.map(_ ==> List(("b", 3), ("c", 4)))
        _ <- Ns.s.i_.>=(Ns.int.<(3)).query.get.map(_ ==> List())
        _ <- Ns.s.i_.>=(Ns.int.<=(3)).query.get.map(_ ==> List(("b", 3)))

        _ <- Ns.s.i_.>=(Ns.int_(3)).query.get.map(_    ==> List("b"))
        _ <- Ns.s.i_.>=(Ns.int_.not(3)).query.get.map(_ ==> List("c"))
        _ <- Ns.s.i_.>=(Ns.int_.>(3)).query.get.map(_ ==> List("c"))
        _ <- Ns.s.i_.>=(Ns.int_.>=(3)).query.get.map(_ ==> List("b", "c"))
        _ <- Ns.s.i_.>=(Ns.int_.<(3)).query.get.map(_ ==> List())
        _ <- Ns.s.i_.>=(Ns.int_.<=(3)).query.get.map(_ ==> List("b"))
      } yield ()
    }
