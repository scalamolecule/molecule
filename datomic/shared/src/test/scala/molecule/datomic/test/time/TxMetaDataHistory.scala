...
//
//
//object TxMetaDataHistory extends DatomicTestSuite {
//
//  lazy val tests = Tests {
//
//
//    "1 entity, 2 tx meta, vararg" - types { implicit conn =>
//      for {
//        eid <- Ns.int(1).save.transact.map(_.eid)
//
//        // Retract entity with two tx meta data molecules applied as separate arguments
//        tx2 <- Ns(eid).Tx(Ref2.str2("meta2"), Ref1.str1("meta1")).map(_.tx)
//
//        // What was retracted and with what tx meta data
//        //        _ <- if (system == SystemPeerServer) {
//        //          Ns.e.int.tx.txOp.Tx(Ref2.str2 + Ref1.str1).query.history.get.map(_.filter(_._3 >= basisTx) ==> List(
//        //            // 1 was retracted with tx meta data "meta2" and "meta1"
//        //            (eid, 1, tx2, false, "meta2", "meta1")
//        //          ))
//        //        } else {
//        //          Ns.e.int.tx.txOp.Tx(Ref2.str2 + Ref1.str1).query.history.get.map(_ ==> List(
//        //            // 1 was retracted with tx meta data "meta2" and "meta1"
//        //            (eid, 1, tx2, false, "meta2", "meta1")
//        //          ))
//        //        }
//        _ <- Ns.e.int.tx.txOp.Tx(Ref2.str2 + Ref1.str1).query.history.get.map(_ ==> List(
//          // 1 was retracted with tx meta data "meta2" and "meta1"
//          (eid, 1, tx2, false, "meta2", "meta1")
//        ))
//      } yield ()
//    }
//
//    "1 entity, 2 tx meta, composite" - types { implicit conn =>
//      for {
//        eid <- Ns.int(1).save.transact.map(_.eid)
//
...
//
//
//    "Multiple entities with tx meta data" - types { implicit conn =>
//      for {
...
//        //            _ <- Ns.int.tx.t.txOp.Tx(Ref2.str2).query.history.get.map(
...
//        //            _ <- Ns.e.int.tx.op(false).Tx(Ref2.str2("b")).query.history.get
...
//        //            res <- Ns.int.tx.op_(false).Tx(Ref2.str2_("b")).query.history.get
...
//        //        _ <-  for {
//        // History with transaction data
//        _ <- Ns.int.a2.tx.a1.txOp.a3.Tx(Ref2.str2).query.history.get.map(_ ==> List(
//          (1, tx1, true, "a"),
//          (2, tx1, true, "a"),
//          (3, tx1, true, "a"),
//
...
//
//        // Entities and int values that were retracted with tx meta data "b"
//        _ <- Ns.e.a1.int.op(false).Tx(Ref2.str2("b")).query.history.get.map(_ ==> List(
//          (e1, 1, false, "b"),
//          (e2, 2, false, "b")
//        ))
//
//        // Or: What int values were retracted with tx meta data "b"?
//        _ <- Ns.int.op_(false).Tx(Ref2.str2_("b")).query.history.get.map(_ ==> List(1, 2))
//        //          } yield res
//        //        }
//      } yield ()
//    }
//
//
//    "Multiple entities with tx meta data including ref" - types { implicit conn =>
//      for {
...
//        //          for {
//        //            // History with transaction data
//        //            _ <- Ns.int.tx.txOp.Tx(Ns.str.Ref1.int1).query.history.get.map(
...
//        //            _ <- Ns.e.int.tx.op(false).Tx(Ns.str("b").Ref1.int1(8)).query.history.get
//        //              .map(_.filter(_._3 >= basisTx).sortBy(_._2) ==> List(
//        //                (e1, 1, tx2, false, "b", 8),
//        //                (e2, 2, tx2, false, "b", 8)
//        //              ))
...
//        //            _ <- Ns.int.tx.op_(false).Tx(Ns.str_("b").Ref1.int1_(8)).query.history.get
//        //              .map(_.filter(_._2 >= basisTx).sortBy(_._1) ==> List(
//        //                (1, tx2),
//        //                (2, tx2)
//        //              ))
...
//        //            _ <- Ns.e.int.tx.op(false).Tx(Ref1.int1(8)).query.history.get.map(_.filter(_._3 >= basisTx) ==> Nil)
//        //            // While Ns.str is:
//        //            res <- Ns.e.int.tx.op(false).Tx(Ns.str("b")).query.history.get
//        //              .map(_.filter(_._3 >= basisTx).sortBy(_._2) ==> List(
//        //                (e1, 1, tx2, false, "b"),
//        //                (e2, 2, tx2, false, "b")
//        //              ))
...
//        //          for {
//        // History with transaction data
//        _ <- Ns.int.a2.tx.a1.txOp.a3.Tx(Ns.str.Ref1.int1).query.history.get.map(_ ==> List(
//          (1, tx1, true, "a", 7),
//          (2, tx1, true, "a", 7),
//          (3, tx1, true, "a", 7),
//
...
//
//        // Entities and int values that was retracted in tx "b"
//        _ <- Ns.e.a1.int.op(false).Tx(Ns.str("b").Ref1.int1(8)).query.history.get.map(_ ==> List(
//          (e1, 1, false, "b", 8),
//          (e2, 2, false, "b", 8)
//        ))
//
//        // Or: What int values where retracted in tx "b"?
//        _ <- Ns.int.op_(false).Tx(Ns.str_("b").Ref1.int1_(8)).query.history.get.map(_ ==> List(1, 2))
//
//        // OBS: Note how referenced tx meta data is not asserted directly with the tx entity:
//        _ <- Ns.e.int.op(false).Tx(Ref1.int1(8)).query.history.get.map(_ ==> Nil)
//        // While Ns.str is:
//        _ <- Ns.e.a1.int.op(false).Tx(Ns.str("b")).query.history.get.map(_ ==> List(
//          (e1, 1, false, "b"),
//          (e2, 2, false, "b")
//        ))
//        //          } yield res
...
//
//
//    "Inspect retracting 1 entity" - types { implicit conn =>
//      for {
//        eid <- Ns.int(1).save.transact.map(_.eid)
//
...
//    }
//
//    "Inspect retracting multiple entities" - types { implicit conn =>
//      for {
...
//        _ <- Ns(eid).int.tx.a1.txOp.a2.query.history.get.map(_ ==> List(
//          // tx 1
...
//        _ <- Ns(eid).int.tx.a1.txOp.a2.Tx(Other.s).query.history.get.map(_ ==> List(
//          // tx 1
//          (1, tx1, true, "meta"), // 1 asserted (save)
//
