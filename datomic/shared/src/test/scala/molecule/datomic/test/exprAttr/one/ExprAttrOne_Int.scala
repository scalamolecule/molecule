...
//import utest._
//
//object ExprAttrOne_Int extends DatomicTestSuite {
//
//
...
//        ).transact
//
//        _ <- Ns.i.<(Ns.int).query.get.map(_ ==> List())
//
//
//
//
//
//
////        _ <- Ns.int.Other.int.insert(
////          (1, 2),
////          (2, 2),
////          (3, 2),
////        ).transact
////
////        _ <- Ns.int.<(2).query.get.map(_ ==> List())
////        _ <- Ns.int.<(Ns.i).query.get.map(_ ==> List())
////
////        _ <- Ns.int.<(Other.int).Other.int.query.get.map(_ ==> List())
//
//
//
//
