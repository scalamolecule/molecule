package molecule.datomicShared

import molecule.MoleculeImplicits
import molecule.base.api.SchemaTransaction
import molecule.base.ast.schemaAST
import molecule.boilerplate.ast.moleculeModel._
import molecule.core.Ns
import molecule.core.api.Connection
//import molecule.MoleculeImplicits._

object Adhoc extends App with MoleculeImplicits{
//object Adhoc extends App {
  ...
  object CoreTestSchema extends SchemaTransaction {
    ...
    override val datomicClient: Seq[String]                   = null
    override val metaSchema   : schemaAST.MetaSchema          = null
    override val nsMap        : Map[String, schemaAST.MetaNs] = null
    override val attrMap      : Map[String, (Int, String)]    = null
  }

  val schemaTx = CoreTestSchema

  //  implicit val conn: Connection = Datomic_Peer.recreateDbFromEdn(schemaTx.datomicPeer)
...
//  Ns.str.int.insert.apply(("Bob", 42), ("Liz", 35)).run.eids.foreach(println)

  Ns.str.int.query.run == List(("Bob", 42), ("Liz", 35))
