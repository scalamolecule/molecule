...
//    def datalog(maxLength: Int = 30): String = ???
//    def datalog: String = datalog(30)
//
//    def rules: String = ???
////    def rules: String = if (i.rules.isEmpty)
////      "none\n\n"
////    else
...
//      val inputs = if (i.inputs.isEmpty) "" else i.inputs.mkString("\n      ", ",\n      ", "")
//      val rules  = if (i.rules.isEmpty) "" else i.rules.mkString("\n      ", ",\n      ", "")
//      val ds     = if (i.ds.size == 1) i.ds.head.toString + "" else i.ds.mkString("\n      ", ",\n      ", "")
...
////  case class AggrExpr(fn: String, args: Seq[OneValue], v: Var) extends Output {
////    override def toString: String = s"""AggrExpr("$fn", $args, $v)"""
////  }
//
...
//  }
//  case class Val(v: String) extends QueryValue with Output {
...
//    nsFull: String,
//    attr: String
//  ) extends QueryValue with Output {
//    override def toString: String = s"""Pull("$e", "$nsFull", "$attr")"""
//  }
//
...
////    override def toString: String =
////      s"""Rule("$name", ${sq(vars)}, Seq(""" + clauses.mkString("\n        ", ",\n        ", "))")
//  }
//
//  sealed trait Input extends QueryTerm
//  case class InVar(binding: QueryTerm, tpe: String) extends Input {
//    override def toString: String = s"""InVar($binding, "$tpe")"""
//  }
//
//
//  sealed trait Binding extends QueryTerm
//  case object NoBinding extends Binding
////  case class ScalarBinding(inVar: Var, arg: OneValue = Null) extends Binding
////  case class TupleBinding(inVars: Seq[Var], tuple: Seq[OneValue] = Nil) extends Binding
////  case class CollectionBinding(inVar: Var, args: Seq[OneValue] = Nil) extends Binding
////  case class RelationBinding(inVars: Seq[Var], tuples: Seq[Seq[OneValue]] = Nil) extends Binding
//
//  sealed trait Clause extends QueryExpr
//
//  case class DataClause(
//    ds: DataSource,
//    e: QueryValue,
//    a: QueryValue,
//    v: QueryValue,
//    tx: QueryTerm,
//    op: QueryTerm = NoBinding
//  ) extends Clause {
...
//    override def toString: String =
//      "NotJoinClauses(Seq(" + nonUnifyingVars.mkString(", ") + "), Seq(\n      " + clauses.mkString(",\n      ") + "))"
//  }
