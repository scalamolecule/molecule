...
class ResolveInsert
  ...
  private def resolveAttrSeqMan(a: AttrSeqMan, tplIndex: Int): Product => Unit = {
    val (ns, attr, refNs) = (a.ns, a.attr, a.refNs)
    a match {
      case _: AttrSeqManID             => addSeq(ns, attr, refNs, tplIndex, transformID, seq2arrayID, extsID, value2jsonID)
      case _: AttrSeqManString         => addSeq(ns, attr, refNs, tplIndex, transformString, seq2arrayString, extsString, value2jsonString)
      case _: AttrSeqManInt            => addSeq(ns, attr, refNs, tplIndex, transformInt, seq2arrayInt, extsInt, value2jsonInt)
      case _: AttrSeqManLong           => addSeq(ns, attr, refNs, tplIndex, transformLong, seq2arrayLong, extsLong, value2jsonLong)
      case _: AttrSeqManFloat          => addSeq(ns, attr, refNs, tplIndex, transformFloat, seq2arrayFloat, extsFloat, value2jsonFloat)
      case _: AttrSeqManDouble         => addSeq(ns, attr, refNs, tplIndex, transformDouble, seq2arrayDouble, extsDouble, value2jsonDouble)
      case _: AttrSeqManBoolean        => addSeq(ns, attr, refNs, tplIndex, transformBoolean, seq2arrayBoolean, extsBoolean, value2jsonBoolean)
      case _: AttrSeqManBigInt         => addSeq(ns, attr, refNs, tplIndex, transformBigInt, seq2arrayBigInt, extsBigInt, value2jsonBigInt)
      case _: AttrSeqManBigDecimal     => addSeq(ns, attr, refNs, tplIndex, transformBigDecimal, seq2arrayBigDecimal, extsBigDecimal, value2jsonBigDecimal)
      case _: AttrSeqManDate           => addSeq(ns, attr, refNs, tplIndex, transformDate, seq2arrayDate, extsDate, value2jsonDate)
      case _: AttrSeqManDuration       => addSeq(ns, attr, refNs, tplIndex, transformDuration, seq2arrayDuration, extsDuration, value2jsonDuration)
      case _: AttrSeqManInstant        => addSeq(ns, attr, refNs, tplIndex, transformInstant, seq2arrayInstant, extsInstant, value2jsonInstant)
      case _: AttrSeqManLocalDate      => addSeq(ns, attr, refNs, tplIndex, transformLocalDate, seq2arrayLocalDate, extsLocalDate, value2jsonLocalDate)
      case _: AttrSeqManLocalTime      => addSeq(ns, attr, refNs, tplIndex, transformLocalTime, seq2arrayLocalTime, extsLocalTime, value2jsonLocalTime)
      case _: AttrSeqManLocalDateTime  => addSeq(ns, attr, refNs, tplIndex, transformLocalDateTime, seq2arrayLocalDateTime, extsLocalDateTime, value2jsonLocalDateTime)
      case _: AttrSeqManOffsetTime     => addSeq(ns, attr, refNs, tplIndex, transformOffsetTime, seq2arrayOffsetTime, extsOffsetTime, value2jsonOffsetTime)
      case _: AttrSeqManOffsetDateTime => addSeq(ns, attr, refNs, tplIndex, transformOffsetDateTime, seq2arrayOffsetDateTime, extsOffsetDateTime, value2jsonOffsetDateTime)
      case _: AttrSeqManZonedDateTime  => addSeq(ns, attr, refNs, tplIndex, transformZonedDateTime, seq2arrayZonedDateTime, extsZonedDateTime, value2jsonZonedDateTime)
      case _: AttrSeqManUUID           => addSeq(ns, attr, refNs, tplIndex, transformUUID, seq2arrayUUID, extsUUID, value2jsonUUID)
      case _: AttrSeqManURI            => addSeq(ns, attr, refNs, tplIndex, transformURI, seq2arrayURI, extsURI, value2jsonURI)
      case a: AttrSeqManByte           => addByteArray(ns, attr, tplIndex, optArray(a.vs)) //, set2arrayByte, extsByte, value2jsonByte)
      case _: AttrSeqManShort          => addSeq(ns, attr, refNs, tplIndex, transformShort, seq2arrayShort, extsShort, value2jsonShort)
      case _: AttrSeqManChar           => addSeq(ns, attr, refNs, tplIndex, transformChar, seq2arrayChar, extsChar, value2jsonChar)
    }
  }
  ...
  private def resolveAttrSeqOpt(a: AttrSeqOpt, tplIndex: Int): Product => Unit = {
    val (ns, attr, refNs) = (a.ns, a.attr, a.refNs)
    a match {
      case _: AttrSeqOptID             => addSeqOpt(ns, attr, refNs, tplIndex, transformID, seq2arrayID,  extsID, value2jsonID)
      case _: AttrSeqOptString         => addSeqOpt(ns, attr, refNs, tplIndex, transformString, seq2arrayString,  extsString, value2jsonString)
      case _: AttrSeqOptInt            => addSeqOpt(ns, attr, refNs, tplIndex, transformInt, seq2arrayInt,  extsInt, value2jsonInt)
      case _: AttrSeqOptLong           => addSeqOpt(ns, attr, refNs, tplIndex, transformLong, seq2arrayLong,  extsLong, value2jsonLong)
      case _: AttrSeqOptFloat          => addSeqOpt(ns, attr, refNs, tplIndex, transformFloat, seq2arrayFloat,  extsFloat, value2jsonFloat)
      case _: AttrSeqOptDouble         => addSeqOpt(ns, attr, refNs, tplIndex, transformDouble, seq2arrayDouble,  extsDouble, value2jsonDouble)
      case _: AttrSeqOptBoolean        => addSeqOpt(ns, attr, refNs, tplIndex, transformBoolean, seq2arrayBoolean,  extsBoolean, value2jsonBoolean)
      case _: AttrSeqOptBigInt         => addSeqOpt(ns, attr, refNs, tplIndex, transformBigInt, seq2arrayBigInt,  extsBigInt, value2jsonBigInt)
      case _: AttrSeqOptBigDecimal     => addSeqOpt(ns, attr, refNs, tplIndex, transformBigDecimal, seq2arrayBigDecimal,  extsBigDecimal, value2jsonBigDecimal)
      case _: AttrSeqOptDate           => addSeqOpt(ns, attr, refNs, tplIndex, transformDate, seq2arrayDate,  extsDate, value2jsonDate)
      case _: AttrSeqOptDuration       => addSeqOpt(ns, attr, refNs, tplIndex, transformDuration, seq2arrayDuration,  extsDuration, value2jsonDuration)
      case _: AttrSeqOptInstant        => addSeqOpt(ns, attr, refNs, tplIndex, transformInstant, seq2arrayInstant,  extsInstant, value2jsonInstant)
      case _: AttrSeqOptLocalDate      => addSeqOpt(ns, attr, refNs, tplIndex, transformLocalDate, seq2arrayLocalDate,  extsLocalDate, value2jsonLocalDate)
      case _: AttrSeqOptLocalTime      => addSeqOpt(ns, attr, refNs, tplIndex, transformLocalTime, seq2arrayLocalTime,  extsLocalTime, value2jsonLocalTime)
      case _: AttrSeqOptLocalDateTime  => addSeqOpt(ns, attr, refNs, tplIndex, transformLocalDateTime, seq2arrayLocalDateTime,  extsLocalDateTime, value2jsonLocalDateTime)
      case _: AttrSeqOptOffsetTime     => addSeqOpt(ns, attr, refNs, tplIndex, transformOffsetTime, seq2arrayOffsetTime,  extsOffsetTime, value2jsonOffsetTime)
      case _: AttrSeqOptOffsetDateTime => addSeqOpt(ns, attr, refNs, tplIndex, transformOffsetDateTime, seq2arrayOffsetDateTime,  extsOffsetDateTime, value2jsonOffsetDateTime)
      case _: AttrSeqOptZonedDateTime  => addSeqOpt(ns, attr, refNs, tplIndex, transformZonedDateTime, seq2arrayZonedDateTime,  extsZonedDateTime, value2jsonZonedDateTime)
      case _: AttrSeqOptUUID           => addSeqOpt(ns, attr, refNs, tplIndex, transformUUID, seq2arrayUUID,  extsUUID, value2jsonUUID)
      case _: AttrSeqOptURI            => addSeqOpt(ns, attr, refNs, tplIndex, transformURI, seq2arrayURI,  extsURI, value2jsonURI)
      case a: AttrSeqOptByte           => addByteArray(ns, attr, tplIndex, a.vs) //, set2arrayByte, extsByte, value2jsonByte)
      case _: AttrSeqOptShort          => addSeqOpt(ns, attr, refNs, tplIndex, transformShort, seq2arrayShort,  extsShort, value2jsonShort)
      case _: AttrSeqOptChar           => addSeqOpt(ns, attr, refNs, tplIndex, transformChar, seq2arrayChar,  extsChar, value2jsonChar)
    }
  }
  ...
  private def resolveAttrMapMan(a: AttrMapMan, tplIndex: Int): Product => Unit = {
    val (ns, attr, refNs) = (a.ns, a.attr, a.refNs)
    a match {
      case _: AttrMapManID             => addMap(ns, attr, refNs, tplIndex, transformID) //, set2arrayID, extsID, value2jsonID)
      case _: AttrMapManString         => addMap(ns, attr, refNs, tplIndex, transformString) //, set2arrayString, extsString, value2jsonString)
      case _: AttrMapManInt            => addMap(ns, attr, refNs, tplIndex, transformInt) //, set2arrayInt, extsInt, value2jsonInt)
      case _: AttrMapManLong           => addMap(ns, attr, refNs, tplIndex, transformLong) //, set2arrayLong, extsLong, value2jsonLong)
      case _: AttrMapManFloat          => addMap(ns, attr, refNs, tplIndex, transformFloat) //, set2arrayFloat, extsFloat, value2jsonFloat)
      case _: AttrMapManDouble         => addMap(ns, attr, refNs, tplIndex, transformDouble) //, set2arrayDouble, extsDouble, value2jsonDouble)
      case _: AttrMapManBoolean        => addMap(ns, attr, refNs, tplIndex, transformBoolean) //, set2arrayBoolean, extsBoolean, value2jsonBoolean)
      case _: AttrMapManBigInt         => addMap(ns, attr, refNs, tplIndex, transformBigInt) //, set2arrayBigInt, extsBigInt, value2jsonBigInt)
      case _: AttrMapManBigDecimal     => addMap(ns, attr, refNs, tplIndex, transformBigDecimal) //, set2arrayBigDecimal, extsBigDecimal, value2jsonBigDecimal)
      case _: AttrMapManDate           => addMap(ns, attr, refNs, tplIndex, transformDate) //, set2arrayDate, extsDate, value2jsonDate)
      case _: AttrMapManDuration       => addMap(ns, attr, refNs, tplIndex, transformDuration) //, set2arrayDuration, extsDuration, value2jsonDuration)
      case _: AttrMapManInstant        => addMap(ns, attr, refNs, tplIndex, transformInstant) //, set2arrayInstant, extsInstant, value2jsonInstant)
      case _: AttrMapManLocalDate      => addMap(ns, attr, refNs, tplIndex, transformLocalDate) //, set2arrayLocalDate, extsLocalDate, value2jsonLocalDate)
      case _: AttrMapManLocalTime      => addMap(ns, attr, refNs, tplIndex, transformLocalTime) //, set2arrayLocalTime, extsLocalTime, value2jsonLocalTime)
      case _: AttrMapManLocalDateTime  => addMap(ns, attr, refNs, tplIndex, transformLocalDateTime) //, set2arrayLocalDateTime, extsLocalDateTime, value2jsonLocalDateTime)
      case _: AttrMapManOffsetTime     => addMap(ns, attr, refNs, tplIndex, transformOffsetTime) //, set2arrayOffsetTime, extsOffsetTime, value2jsonOffsetTime)
      case _: AttrMapManOffsetDateTime => addMap(ns, attr, refNs, tplIndex, transformOffsetDateTime) //, set2arrayOffsetDateTime, extsOffsetDateTime, value2jsonOffsetDateTime)
      case _: AttrMapManZonedDateTime  => addMap(ns, attr, refNs, tplIndex, transformZonedDateTime) //, set2arrayZonedDateTime, extsZonedDateTime, value2jsonZonedDateTime)
      case _: AttrMapManUUID           => addMap(ns, attr, refNs, tplIndex, transformUUID) //, set2arrayUUID, extsUUID, value2jsonUUID)
      case _: AttrMapManURI            => addMap(ns, attr, refNs, tplIndex, transformURI) //, set2arrayURI, extsURI, value2jsonURI)
      case _: AttrMapManByte           => addMap(ns, attr, refNs, tplIndex, transformByte) //, set2arrayByte, extsByte, value2jsonByte)
      case _: AttrMapManShort          => addMap(ns, attr, refNs, tplIndex, transformShort) //, set2arrayShort, extsShort, value2jsonShort)
      case _: AttrMapManChar           => addMap(ns, attr, refNs, tplIndex, transformChar) //, set2arrayChar, extsChar, value2jsonChar)
    }
  }
  ...
  private def resolveAttrMapOpt(a: AttrMapOpt, tplIndex: Int): Product => Unit = {
    val (ns, attr, refNs) = (a.ns, a.attr, a.refNs)
    a match {
      case _: AttrMapOptID             => addMapOpt(ns, attr, refNs, tplIndex, transformID) //, set2arrayID, extsID, value2jsonID)
      case _: AttrMapOptString         => addMapOpt(ns, attr, refNs, tplIndex, transformString) //, set2arrayString, extsString, value2jsonString)
      case _: AttrMapOptInt            => addMapOpt(ns, attr, refNs, tplIndex, transformInt) //, set2arrayInt, extsInt, value2jsonInt)
      case _: AttrMapOptLong           => addMapOpt(ns, attr, refNs, tplIndex, transformLong) //, set2arrayLong, extsLong, value2jsonLong)
      case _: AttrMapOptFloat          => addMapOpt(ns, attr, refNs, tplIndex, transformFloat) //, set2arrayFloat, extsFloat, value2jsonFloat)
      case _: AttrMapOptDouble         => addMapOpt(ns, attr, refNs, tplIndex, transformDouble) //, set2arrayDouble, extsDouble, value2jsonDouble)
      case _: AttrMapOptBoolean        => addMapOpt(ns, attr, refNs, tplIndex, transformBoolean) //, set2arrayBoolean, extsBoolean, value2jsonBoolean)
      case _: AttrMapOptBigInt         => addMapOpt(ns, attr, refNs, tplIndex, transformBigInt) //, set2arrayBigInt, extsBigInt, value2jsonBigInt)
      case _: AttrMapOptBigDecimal     => addMapOpt(ns, attr, refNs, tplIndex, transformBigDecimal) //, set2arrayBigDecimal, extsBigDecimal, value2jsonBigDecimal)
      case _: AttrMapOptDate           => addMapOpt(ns, attr, refNs, tplIndex, transformDate) //, set2arrayDate, extsDate, value2jsonDate)
      case _: AttrMapOptDuration       => addMapOpt(ns, attr, refNs, tplIndex, transformDuration) //, set2arrayDuration, extsDuration, value2jsonDuration)
      case _: AttrMapOptInstant        => addMapOpt(ns, attr, refNs, tplIndex, transformInstant) //, set2arrayInstant, extsInstant, value2jsonInstant)
      case _: AttrMapOptLocalDate      => addMapOpt(ns, attr, refNs, tplIndex, transformLocalDate) //, set2arrayLocalDate, extsLocalDate, value2jsonLocalDate)
      case _: AttrMapOptLocalTime      => addMapOpt(ns, attr, refNs, tplIndex, transformLocalTime) //, set2arrayLocalTime, extsLocalTime, value2jsonLocalTime)
      case _: AttrMapOptLocalDateTime  => addMapOpt(ns, attr, refNs, tplIndex, transformLocalDateTime) //, set2arrayLocalDateTime, extsLocalDateTime, value2jsonLocalDateTime)
      case _: AttrMapOptOffsetTime     => addMapOpt(ns, attr, refNs, tplIndex, transformOffsetTime) //, set2arrayOffsetTime, extsOffsetTime, value2jsonOffsetTime)
      case _: AttrMapOptOffsetDateTime => addMapOpt(ns, attr, refNs, tplIndex, transformOffsetDateTime) //, set2arrayOffsetDateTime, extsOffsetDateTime, value2jsonOffsetDateTime)
      case _: AttrMapOptZonedDateTime  => addMapOpt(ns, attr, refNs, tplIndex, transformZonedDateTime) //, set2arrayZonedDateTime, extsZonedDateTime, value2jsonZonedDateTime)
      case _: AttrMapOptUUID           => addMapOpt(ns, attr, refNs, tplIndex, transformUUID) //, set2arrayUUID, extsUUID, value2jsonUUID)
      case _: AttrMapOptURI            => addMapOpt(ns, attr, refNs, tplIndex, transformURI) //, set2arrayURI, extsURI, value2jsonURI)
      case _: AttrMapOptByte           => addMapOpt(ns, attr, refNs, tplIndex, transformByte) //, set2arrayByte, extsByte, value2jsonByte)
      case _: AttrMapOptShort          => addMapOpt(ns, attr, refNs, tplIndex, transformShort) //, set2arrayShort, extsShort, value2jsonShort)
      case _: AttrMapOptChar           => addMapOpt(ns, attr, refNs, tplIndex, transformChar) //, set2arrayChar, extsChar, value2jsonChar)
    }
  }
}