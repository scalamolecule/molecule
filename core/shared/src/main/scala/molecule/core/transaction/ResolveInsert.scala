...
class ResolveInsert
  ...
  private def resolveAttrMapMan(a: AttrMapMan, tplIndex: Int): Product => Unit = {
    val (ns, attr, refNs) = (a.ns, a.attr, a.refNs)
    a match {
      case _: AttrMapManID             => addMap(ns, attr, refNs, tplIndex, transformID, value2jsonID) //, set2arrayID, extsID)
      case _: AttrMapManString         => addMap(ns, attr, refNs, tplIndex, transformString, value2jsonString) //, set2arrayString, extsString)
      case _: AttrMapManInt            => addMap(ns, attr, refNs, tplIndex, transformInt, value2jsonInt) //, set2arrayInt, extsInt)
      case _: AttrMapManLong           => addMap(ns, attr, refNs, tplIndex, transformLong, value2jsonLong) //, set2arrayLong, extsLong)
      case _: AttrMapManFloat          => addMap(ns, attr, refNs, tplIndex, transformFloat, value2jsonFloat) //, set2arrayFloat, extsFloat)
      case _: AttrMapManDouble         => addMap(ns, attr, refNs, tplIndex, transformDouble, value2jsonDouble) //, set2arrayDouble, extsDouble)
      case _: AttrMapManBoolean        => addMap(ns, attr, refNs, tplIndex, transformBoolean, value2jsonBoolean) //, set2arrayBoolean, extsBoolean)
      case _: AttrMapManBigInt         => addMap(ns, attr, refNs, tplIndex, transformBigInt, value2jsonBigInt) //, set2arrayBigInt, extsBigInt)
      case _: AttrMapManBigDecimal     => addMap(ns, attr, refNs, tplIndex, transformBigDecimal, value2jsonBigDecimal) //, set2arrayBigDecimal, extsBigDecimal)
      case _: AttrMapManDate           => addMap(ns, attr, refNs, tplIndex, transformDate, value2jsonDate) //, set2arrayDate, extsDate)
      case _: AttrMapManDuration       => addMap(ns, attr, refNs, tplIndex, transformDuration, value2jsonDuration) //, set2arrayDuration, extsDuration)
      case _: AttrMapManInstant        => addMap(ns, attr, refNs, tplIndex, transformInstant, value2jsonInstant) //, set2arrayInstant, extsInstant)
      case _: AttrMapManLocalDate      => addMap(ns, attr, refNs, tplIndex, transformLocalDate, value2jsonLocalDate) //, set2arrayLocalDate, extsLocalDate)
      case _: AttrMapManLocalTime      => addMap(ns, attr, refNs, tplIndex, transformLocalTime, value2jsonLocalTime) //, set2arrayLocalTime, extsLocalTime)
      case _: AttrMapManLocalDateTime  => addMap(ns, attr, refNs, tplIndex, transformLocalDateTime, value2jsonLocalDateTime) //, set2arrayLocalDateTime, extsLocalDateTime)
      case _: AttrMapManOffsetTime     => addMap(ns, attr, refNs, tplIndex, transformOffsetTime, value2jsonOffsetTime) //, set2arrayOffsetTime, extsOffsetTime)
      case _: AttrMapManOffsetDateTime => addMap(ns, attr, refNs, tplIndex, transformOffsetDateTime, value2jsonOffsetDateTime) //, set2arrayOffsetDateTime, extsOffsetDateTime)
      case _: AttrMapManZonedDateTime  => addMap(ns, attr, refNs, tplIndex, transformZonedDateTime, value2jsonZonedDateTime) //, set2arrayZonedDateTime, extsZonedDateTime)
      case _: AttrMapManUUID           => addMap(ns, attr, refNs, tplIndex, transformUUID, value2jsonUUID) //, set2arrayUUID, extsUUID)
      case _: AttrMapManURI            => addMap(ns, attr, refNs, tplIndex, transformURI, value2jsonURI) //, set2arrayURI, extsURI)
      case _: AttrMapManByte           => addMap(ns, attr, refNs, tplIndex, transformByte, value2jsonByte) //, set2arrayByte, extsByte)
      case _: AttrMapManShort          => addMap(ns, attr, refNs, tplIndex, transformShort, value2jsonShort) //, set2arrayShort, extsShort)
      case _: AttrMapManChar           => addMap(ns, attr, refNs, tplIndex, transformChar, value2jsonChar) //, set2arrayChar, extsChar)
    }
  }
  ...
  private def resolveAttrMapOpt(a: AttrMapOpt, tplIndex: Int): Product => Unit = {
    val (ns, attr, refNs) = (a.ns, a.attr, a.refNs)
    a match {
      case _: AttrMapOptID             => addMapOpt(ns, attr, refNs, tplIndex, transformID, value2jsonID) //, set2arrayID, extsID)
      case _: AttrMapOptString         => addMapOpt(ns, attr, refNs, tplIndex, transformString, value2jsonString) //, set2arrayString, extsString)
      case _: AttrMapOptInt            => addMapOpt(ns, attr, refNs, tplIndex, transformInt, value2jsonInt) //, set2arrayInt, extsInt)
      case _: AttrMapOptLong           => addMapOpt(ns, attr, refNs, tplIndex, transformLong, value2jsonLong) //, set2arrayLong, extsLong)
      case _: AttrMapOptFloat          => addMapOpt(ns, attr, refNs, tplIndex, transformFloat, value2jsonFloat) //, set2arrayFloat, extsFloat)
      case _: AttrMapOptDouble         => addMapOpt(ns, attr, refNs, tplIndex, transformDouble, value2jsonDouble) //, set2arrayDouble, extsDouble)
      case _: AttrMapOptBoolean        => addMapOpt(ns, attr, refNs, tplIndex, transformBoolean, value2jsonBoolean) //, set2arrayBoolean, extsBoolean)
      case _: AttrMapOptBigInt         => addMapOpt(ns, attr, refNs, tplIndex, transformBigInt, value2jsonBigInt) //, set2arrayBigInt, extsBigInt)
      case _: AttrMapOptBigDecimal     => addMapOpt(ns, attr, refNs, tplIndex, transformBigDecimal, value2jsonBigDecimal) //, set2arrayBigDecimal, extsBigDecimal)
      case _: AttrMapOptDate           => addMapOpt(ns, attr, refNs, tplIndex, transformDate, value2jsonDate) //, set2arrayDate, extsDate)
      case _: AttrMapOptDuration       => addMapOpt(ns, attr, refNs, tplIndex, transformDuration, value2jsonDuration) //, set2arrayDuration, extsDuration)
      case _: AttrMapOptInstant        => addMapOpt(ns, attr, refNs, tplIndex, transformInstant, value2jsonInstant) //, set2arrayInstant, extsInstant)
      case _: AttrMapOptLocalDate      => addMapOpt(ns, attr, refNs, tplIndex, transformLocalDate, value2jsonLocalDate) //, set2arrayLocalDate, extsLocalDate)
      case _: AttrMapOptLocalTime      => addMapOpt(ns, attr, refNs, tplIndex, transformLocalTime, value2jsonLocalTime) //, set2arrayLocalTime, extsLocalTime)
      case _: AttrMapOptLocalDateTime  => addMapOpt(ns, attr, refNs, tplIndex, transformLocalDateTime, value2jsonLocalDateTime) //, set2arrayLocalDateTime, extsLocalDateTime)
      case _: AttrMapOptOffsetTime     => addMapOpt(ns, attr, refNs, tplIndex, transformOffsetTime, value2jsonOffsetTime) //, set2arrayOffsetTime, extsOffsetTime)
      case _: AttrMapOptOffsetDateTime => addMapOpt(ns, attr, refNs, tplIndex, transformOffsetDateTime, value2jsonOffsetDateTime) //, set2arrayOffsetDateTime, extsOffsetDateTime)
      case _: AttrMapOptZonedDateTime  => addMapOpt(ns, attr, refNs, tplIndex, transformZonedDateTime, value2jsonZonedDateTime) //, set2arrayZonedDateTime, extsZonedDateTime)
      case _: AttrMapOptUUID           => addMapOpt(ns, attr, refNs, tplIndex, transformUUID, value2jsonUUID) //, set2arrayUUID, extsUUID)
      case _: AttrMapOptURI            => addMapOpt(ns, attr, refNs, tplIndex, transformURI, value2jsonURI) //, set2arrayURI, extsURI)
      case _: AttrMapOptByte           => addMapOpt(ns, attr, refNs, tplIndex, transformByte, value2jsonByte) //, set2arrayByte, extsByte)
      case _: AttrMapOptShort          => addMapOpt(ns, attr, refNs, tplIndex, transformShort, value2jsonShort) //, set2arrayShort, extsShort)
      case _: AttrMapOptChar           => addMapOpt(ns, attr, refNs, tplIndex, transformChar, value2jsonChar) //, set2arrayChar, extsChar)
    }
  }
}