...
class ResolveSave
  ...
  private def resolveAttrMapMan(a: AttrMapMan): Unit = a match {
    case a: AttrMapManID             => addMap(a.ns, a.attr, oneMap(a.map), transformID, value2jsonID)
    case a: AttrMapManString         => addMap(a.ns, a.attr, oneMap(a.map), transformString, value2jsonString)
    case a: AttrMapManInt            => addMap(a.ns, a.attr, oneMap(a.map), transformInt, value2jsonInt)
    case a: AttrMapManLong           => addMap(a.ns, a.attr, oneMap(a.map), transformLong, value2jsonLong)
    case a: AttrMapManFloat          => addMap(a.ns, a.attr, oneMap(a.map), transformFloat, value2jsonFloat)
    case a: AttrMapManDouble         => addMap(a.ns, a.attr, oneMap(a.map), transformDouble, value2jsonDouble)
    case a: AttrMapManBoolean        => addMap(a.ns, a.attr, oneMap(a.map), transformBoolean, value2jsonBoolean)
    case a: AttrMapManBigInt         => addMap(a.ns, a.attr, oneMap(a.map), transformBigInt, value2jsonBigInt)
    case a: AttrMapManBigDecimal     => addMap(a.ns, a.attr, oneMap(a.map), transformBigDecimal, value2jsonBigDecimal)
    case a: AttrMapManDate           => addMap(a.ns, a.attr, oneMap(a.map), transformDate, value2jsonDate)
    case a: AttrMapManDuration       => addMap(a.ns, a.attr, oneMap(a.map), transformDuration, value2jsonDuration)
    case a: AttrMapManInstant        => addMap(a.ns, a.attr, oneMap(a.map), transformInstant, value2jsonInstant)
    case a: AttrMapManLocalDate      => addMap(a.ns, a.attr, oneMap(a.map), transformLocalDate, value2jsonLocalDate)
    case a: AttrMapManLocalTime      => addMap(a.ns, a.attr, oneMap(a.map), transformLocalTime, value2jsonLocalTime)
    case a: AttrMapManLocalDateTime  => addMap(a.ns, a.attr, oneMap(a.map), transformLocalDateTime, value2jsonLocalDateTime)
    case a: AttrMapManOffsetTime     => addMap(a.ns, a.attr, oneMap(a.map), transformOffsetTime, value2jsonOffsetTime)
    case a: AttrMapManOffsetDateTime => addMap(a.ns, a.attr, oneMap(a.map), transformOffsetDateTime, value2jsonOffsetDateTime)
    case a: AttrMapManZonedDateTime  => addMap(a.ns, a.attr, oneMap(a.map), transformZonedDateTime, value2jsonZonedDateTime)
    case a: AttrMapManUUID           => addMap(a.ns, a.attr, oneMap(a.map), transformUUID, value2jsonUUID)
    case a: AttrMapManURI            => addMap(a.ns, a.attr, oneMap(a.map), transformURI, value2jsonURI)
    case a: AttrMapManByte           => addMap(a.ns, a.attr, oneMap(a.map), transformByte, value2jsonByte)
    case a: AttrMapManShort          => addMap(a.ns, a.attr, oneMap(a.map), transformShort, value2jsonShort)
    case a: AttrMapManChar           => addMap(a.ns, a.attr, oneMap(a.map), transformChar, value2jsonChar)
  }
  private def resolveAttrMapTac(a: AttrMapTac): Unit = a match {
    case a: AttrMapTacID             => addMap(a.ns, a.attr, oneMap(a.map), transformID, value2jsonID)
    case a: AttrMapTacString         => addMap(a.ns, a.attr, oneMap(a.map), transformString, value2jsonString)
    case a: AttrMapTacInt            => addMap(a.ns, a.attr, oneMap(a.map), transformInt, value2jsonInt)
    case a: AttrMapTacLong           => addMap(a.ns, a.attr, oneMap(a.map), transformLong, value2jsonLong)
    case a: AttrMapTacFloat          => addMap(a.ns, a.attr, oneMap(a.map), transformFloat, value2jsonFloat)
    case a: AttrMapTacDouble         => addMap(a.ns, a.attr, oneMap(a.map), transformDouble, value2jsonDouble)
    case a: AttrMapTacBoolean        => addMap(a.ns, a.attr, oneMap(a.map), transformBoolean, value2jsonBoolean)
    case a: AttrMapTacBigInt         => addMap(a.ns, a.attr, oneMap(a.map), transformBigInt, value2jsonBigInt)
    case a: AttrMapTacBigDecimal     => addMap(a.ns, a.attr, oneMap(a.map), transformBigDecimal, value2jsonBigDecimal)
    case a: AttrMapTacDate           => addMap(a.ns, a.attr, oneMap(a.map), transformDate, value2jsonDate)
    case a: AttrMapTacDuration       => addMap(a.ns, a.attr, oneMap(a.map), transformDuration, value2jsonDuration)
    case a: AttrMapTacInstant        => addMap(a.ns, a.attr, oneMap(a.map), transformInstant, value2jsonInstant)
    case a: AttrMapTacLocalDate      => addMap(a.ns, a.attr, oneMap(a.map), transformLocalDate, value2jsonLocalDate)
    case a: AttrMapTacLocalTime      => addMap(a.ns, a.attr, oneMap(a.map), transformLocalTime, value2jsonLocalTime)
    case a: AttrMapTacLocalDateTime  => addMap(a.ns, a.attr, oneMap(a.map), transformLocalDateTime, value2jsonLocalDateTime)
    case a: AttrMapTacOffsetTime     => addMap(a.ns, a.attr, oneMap(a.map), transformOffsetTime, value2jsonOffsetTime)
    case a: AttrMapTacOffsetDateTime => addMap(a.ns, a.attr, oneMap(a.map), transformOffsetDateTime, value2jsonOffsetDateTime)
    case a: AttrMapTacZonedDateTime  => addMap(a.ns, a.attr, oneMap(a.map), transformZonedDateTime, value2jsonZonedDateTime)
    case a: AttrMapTacUUID           => addMap(a.ns, a.attr, oneMap(a.map), transformUUID, value2jsonUUID)
    case a: AttrMapTacURI            => addMap(a.ns, a.attr, oneMap(a.map), transformURI, value2jsonURI)
    case a: AttrMapTacByte           => addMap(a.ns, a.attr, oneMap(a.map), transformByte, value2jsonByte)
    case a: AttrMapTacShort          => addMap(a.ns, a.attr, oneMap(a.map), transformShort, value2jsonShort)
    case a: AttrMapTacChar           => addMap(a.ns, a.attr, oneMap(a.map), transformChar, value2jsonChar)
  }

  private def resolveAttrMapOpt(a: AttrMapOpt): Unit = {
    a match {
      case a: AttrMapOptID             => addMap(a.ns, a.attr, a.map, transformID, value2jsonID)
      case a: AttrMapOptString         => addMap(a.ns, a.attr, a.map, transformString, value2jsonString)
      case a: AttrMapOptInt            => addMap(a.ns, a.attr, a.map, transformInt, value2jsonInt)
      case a: AttrMapOptLong           => addMap(a.ns, a.attr, a.map, transformLong, value2jsonLong)
      case a: AttrMapOptFloat          => addMap(a.ns, a.attr, a.map, transformFloat, value2jsonFloat)
      case a: AttrMapOptDouble         => addMap(a.ns, a.attr, a.map, transformDouble, value2jsonDouble)
      case a: AttrMapOptBoolean        => addMap(a.ns, a.attr, a.map, transformBoolean, value2jsonBoolean)
      case a: AttrMapOptBigInt         => addMap(a.ns, a.attr, a.map, transformBigInt, value2jsonBigInt)
      case a: AttrMapOptBigDecimal     => addMap(a.ns, a.attr, a.map, transformBigDecimal, value2jsonBigDecimal)
      case a: AttrMapOptDate           => addMap(a.ns, a.attr, a.map, transformDate, value2jsonDate)
      case a: AttrMapOptDuration       => addMap(a.ns, a.attr, a.map, transformDuration, value2jsonDuration)
      case a: AttrMapOptInstant        => addMap(a.ns, a.attr, a.map, transformInstant, value2jsonInstant)
      case a: AttrMapOptLocalDate      => addMap(a.ns, a.attr, a.map, transformLocalDate, value2jsonLocalDate)
      case a: AttrMapOptLocalTime      => addMap(a.ns, a.attr, a.map, transformLocalTime, value2jsonLocalTime)
      case a: AttrMapOptLocalDateTime  => addMap(a.ns, a.attr, a.map, transformLocalDateTime, value2jsonLocalDateTime)
      case a: AttrMapOptOffsetTime     => addMap(a.ns, a.attr, a.map, transformOffsetTime, value2jsonOffsetTime)
      case a: AttrMapOptOffsetDateTime => addMap(a.ns, a.attr, a.map, transformOffsetDateTime, value2jsonOffsetDateTime)
      case a: AttrMapOptZonedDateTime  => addMap(a.ns, a.attr, a.map, transformZonedDateTime, value2jsonZonedDateTime)
      case a: AttrMapOptUUID           => addMap(a.ns, a.attr, a.map, transformUUID, value2jsonUUID)
      case a: AttrMapOptURI            => addMap(a.ns, a.attr, a.map, transformURI, value2jsonURI)
      case a: AttrMapOptByte           => addMap(a.ns, a.attr, a.map, transformByte, value2jsonByte)
      case a: AttrMapOptShort          => addMap(a.ns, a.attr, a.map, transformShort, value2jsonShort)
      case a: AttrMapOptChar           => addMap(a.ns, a.attr, a.map, transformChar, value2jsonChar)
    }
  }
}