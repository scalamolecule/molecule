...
class ResolveSave
  ...
  private def resolveAttrSeqMan(a: AttrSeqMan): Unit = {
    ...
    a match {
      ...
      case a: AttrSeqManByte           => addByteArray(ns, attr, optArray(a.vs))
  ...
  private def resolveAttrSeqTac(a: AttrSeqTac): Unit = {
    ...
    a match {
      ...
      case a: AttrSeqTacByte           => addByteArray(ns, attr, optArray(a.vs))
  ...
  private def resolveAttrSeqOpt(a: AttrSeqOpt): Unit = {
    ...
    a match {
      ...
      case a: AttrSeqOptByte           => addByteArray(ns, attr, a.vs)
  ...
  private def resolveAttrMapMan(a: AttrMapMan): Unit = a match {
    case a: AttrMapManID             => addMap(a.ns, a.attr, oneMap(a.vs), transformID, value2jsonID) //, set2arrayID, refNs, extsID)
    case a: AttrMapManString         => addMap(a.ns, a.attr, oneMap(a.vs), transformString, value2jsonString) //, set2arrayString, refNs, extsString)
    case a: AttrMapManInt            => addMap(a.ns, a.attr, oneMap(a.vs), transformInt, value2jsonInt) //, set2arrayInt, refNs, extsInt)
    case a: AttrMapManLong           => addMap(a.ns, a.attr, oneMap(a.vs), transformLong, value2jsonLong) //, set2arrayLong, refNs, extsLong)
    case a: AttrMapManFloat          => addMap(a.ns, a.attr, oneMap(a.vs), transformFloat, value2jsonFloat) //, set2arrayFloat, refNs, extsFloat)
    case a: AttrMapManDouble         => addMap(a.ns, a.attr, oneMap(a.vs), transformDouble, value2jsonDouble) //, set2arrayDouble, refNs, extsDouble)
    case a: AttrMapManBoolean        => addMap(a.ns, a.attr, oneMap(a.vs), transformBoolean, value2jsonBoolean) //, set2arrayBoolean, refNs, extsBoolean)
    case a: AttrMapManBigInt         => addMap(a.ns, a.attr, oneMap(a.vs), transformBigInt, value2jsonBigInt) //, set2arrayBigInt, refNs, extsBigInt)
    case a: AttrMapManBigDecimal     => addMap(a.ns, a.attr, oneMap(a.vs), transformBigDecimal, value2jsonBigDecimal) //, set2arrayBigDecimal, refNs, extsBigDecimal)
    case a: AttrMapManDate           => addMap(a.ns, a.attr, oneMap(a.vs), transformDate, value2jsonDate) //, set2arrayDate, refNs, extsDate)
    case a: AttrMapManDuration       => addMap(a.ns, a.attr, oneMap(a.vs), transformDuration, value2jsonDuration) //, set2arrayDuration, refNs, extsDuration)
    case a: AttrMapManInstant        => addMap(a.ns, a.attr, oneMap(a.vs), transformInstant, value2jsonInstant) //, set2arrayInstant, refNs, extsInstant)
    case a: AttrMapManLocalDate      => addMap(a.ns, a.attr, oneMap(a.vs), transformLocalDate, value2jsonLocalDate) //, set2arrayLocalDate, refNs, extsLocalDate)
    case a: AttrMapManLocalTime      => addMap(a.ns, a.attr, oneMap(a.vs), transformLocalTime, value2jsonLocalTime) //, set2arrayLocalTime, refNs, extsLocalTime)
    case a: AttrMapManLocalDateTime  => addMap(a.ns, a.attr, oneMap(a.vs), transformLocalDateTime, value2jsonLocalDateTime) //, set2arrayLocalDateTime, refNs, extsLocalDateTime)
    case a: AttrMapManOffsetTime     => addMap(a.ns, a.attr, oneMap(a.vs), transformOffsetTime, value2jsonOffsetTime) //, set2arrayOffsetTime, refNs, extsOffsetTime)
    case a: AttrMapManOffsetDateTime => addMap(a.ns, a.attr, oneMap(a.vs), transformOffsetDateTime, value2jsonOffsetDateTime) //, set2arrayOffsetDateTime, refNs, extsOffsetDateTime)
    case a: AttrMapManZonedDateTime  => addMap(a.ns, a.attr, oneMap(a.vs), transformZonedDateTime, value2jsonZonedDateTime) //, set2arrayZonedDateTime, refNs, extsZonedDateTime)
    case a: AttrMapManUUID           => addMap(a.ns, a.attr, oneMap(a.vs), transformUUID, value2jsonUUID) //, set2arrayUUID, refNs, extsUUID)
    case a: AttrMapManURI            => addMap(a.ns, a.attr, oneMap(a.vs), transformURI, value2jsonURI) //, set2arrayURI, refNs, extsURI)
    case a: AttrMapManByte           => addMap(a.ns, a.attr, oneMap(a.vs), transformByte, value2jsonByte) //, set2arrayByte, refNs, extsByte)
    case a: AttrMapManShort          => addMap(a.ns, a.attr, oneMap(a.vs), transformShort, value2jsonShort) //, set2arrayShort, refNs, extsShort)
    case a: AttrMapManChar           => addMap(a.ns, a.attr, oneMap(a.vs), transformChar, value2jsonChar) //, set2arrayChar, refNs, extsChar)
  }
  private def resolveAttrMapTac(a: AttrMapTac): Unit = a match {
    case a: AttrMapTacID             => addMap(a.ns, a.attr, oneMap(a.vs), transformID, value2jsonID) //, set2arrayID, refNs, extsID)
    case a: AttrMapTacString         => addMap(a.ns, a.attr, oneMap(a.vs), transformString, value2jsonString) //, set2arrayString, refNs, extsString)
    case a: AttrMapTacInt            => addMap(a.ns, a.attr, oneMap(a.vs), transformInt, value2jsonInt) //, set2arrayInt, refNs, extsInt)
    case a: AttrMapTacLong           => addMap(a.ns, a.attr, oneMap(a.vs), transformLong, value2jsonLong) //, set2arrayLong, refNs, extsLong)
    case a: AttrMapTacFloat          => addMap(a.ns, a.attr, oneMap(a.vs), transformFloat, value2jsonFloat) //, set2arrayFloat, refNs, extsFloat)
    case a: AttrMapTacDouble         => addMap(a.ns, a.attr, oneMap(a.vs), transformDouble, value2jsonDouble) //, set2arrayDouble, refNs, extsDouble)
    case a: AttrMapTacBoolean        => addMap(a.ns, a.attr, oneMap(a.vs), transformBoolean, value2jsonBoolean) //, set2arrayBoolean, refNs, extsBoolean)
    case a: AttrMapTacBigInt         => addMap(a.ns, a.attr, oneMap(a.vs), transformBigInt, value2jsonBigInt) //, set2arrayBigInt, refNs, extsBigInt)
    case a: AttrMapTacBigDecimal     => addMap(a.ns, a.attr, oneMap(a.vs), transformBigDecimal, value2jsonBigDecimal) //, set2arrayBigDecimal, refNs, extsBigDecimal)
    case a: AttrMapTacDate           => addMap(a.ns, a.attr, oneMap(a.vs), transformDate, value2jsonDate) //, set2arrayDate, refNs, extsDate)
    case a: AttrMapTacDuration       => addMap(a.ns, a.attr, oneMap(a.vs), transformDuration, value2jsonDuration) //, set2arrayDuration, refNs, extsDuration)
    case a: AttrMapTacInstant        => addMap(a.ns, a.attr, oneMap(a.vs), transformInstant, value2jsonInstant) //, set2arrayInstant, refNs, extsInstant)
    case a: AttrMapTacLocalDate      => addMap(a.ns, a.attr, oneMap(a.vs), transformLocalDate, value2jsonLocalDate) //, set2arrayLocalDate, refNs, extsLocalDate)
    case a: AttrMapTacLocalTime      => addMap(a.ns, a.attr, oneMap(a.vs), transformLocalTime, value2jsonLocalTime) //, set2arrayLocalTime, refNs, extsLocalTime)
    case a: AttrMapTacLocalDateTime  => addMap(a.ns, a.attr, oneMap(a.vs), transformLocalDateTime, value2jsonLocalDateTime) //, set2arrayLocalDateTime, refNs, extsLocalDateTime)
    case a: AttrMapTacOffsetTime     => addMap(a.ns, a.attr, oneMap(a.vs), transformOffsetTime, value2jsonOffsetTime) //, set2arrayOffsetTime, refNs, extsOffsetTime)
    case a: AttrMapTacOffsetDateTime => addMap(a.ns, a.attr, oneMap(a.vs), transformOffsetDateTime, value2jsonOffsetDateTime) //, set2arrayOffsetDateTime, refNs, extsOffsetDateTime)
    case a: AttrMapTacZonedDateTime  => addMap(a.ns, a.attr, oneMap(a.vs), transformZonedDateTime, value2jsonZonedDateTime) //, set2arrayZonedDateTime, refNs, extsZonedDateTime)
    case a: AttrMapTacUUID           => addMap(a.ns, a.attr, oneMap(a.vs), transformUUID, value2jsonUUID) //, set2arrayUUID, refNs, extsUUID)
    case a: AttrMapTacURI            => addMap(a.ns, a.attr, oneMap(a.vs), transformURI, value2jsonURI) //, set2arrayURI, refNs, extsURI)
    case a: AttrMapTacByte           => addMap(a.ns, a.attr, oneMap(a.vs), transformByte, value2jsonByte) //, set2arrayByte, refNs, extsByte)
    case a: AttrMapTacShort          => addMap(a.ns, a.attr, oneMap(a.vs), transformShort, value2jsonShort) //, set2arrayShort, refNs, extsShort)
    case a: AttrMapTacChar           => addMap(a.ns, a.attr, oneMap(a.vs), transformChar, value2jsonChar) //, set2arrayChar, refNs, extsChar)
  }

  private def resolveAttrMapOpt(a: AttrMapOpt): Unit = {
    a match {
      case a: AttrMapOptID             => addMap(a.ns, a.attr, a.vs, transformID, value2jsonID) //, set2arrayID, refNs, extsID)
      case a: AttrMapOptString         => addMap(a.ns, a.attr, a.vs, transformString, value2jsonString) //, set2arrayString, refNs, extsString)
      case a: AttrMapOptInt            => addMap(a.ns, a.attr, a.vs, transformInt, value2jsonInt) //, set2arrayInt, refNs, extsInt)
      case a: AttrMapOptLong           => addMap(a.ns, a.attr, a.vs, transformLong, value2jsonLong) //, set2arrayLong, refNs, extsLong)
      case a: AttrMapOptFloat          => addMap(a.ns, a.attr, a.vs, transformFloat, value2jsonFloat) //, set2arrayFloat, refNs, extsFloat)
      case a: AttrMapOptDouble         => addMap(a.ns, a.attr, a.vs, transformDouble, value2jsonDouble) //, set2arrayDouble, refNs, extsDouble)
      case a: AttrMapOptBoolean        => addMap(a.ns, a.attr, a.vs, transformBoolean, value2jsonBoolean) //, set2arrayBoolean, refNs, extsBoolean)
      case a: AttrMapOptBigInt         => addMap(a.ns, a.attr, a.vs, transformBigInt, value2jsonBigInt) //, set2arrayBigInt, refNs, extsBigInt)
      case a: AttrMapOptBigDecimal     => addMap(a.ns, a.attr, a.vs, transformBigDecimal, value2jsonBigDecimal) //, set2arrayBigDecimal, refNs, extsBigDecimal)
      case a: AttrMapOptDate           => addMap(a.ns, a.attr, a.vs, transformDate, value2jsonDate) //, set2arrayDate, refNs, extsDate)
      case a: AttrMapOptDuration       => addMap(a.ns, a.attr, a.vs, transformDuration, value2jsonDuration) //, set2arrayDuration, refNs, extsDuration)
      case a: AttrMapOptInstant        => addMap(a.ns, a.attr, a.vs, transformInstant, value2jsonInstant) //, set2arrayInstant, refNs, extsInstant)
      case a: AttrMapOptLocalDate      => addMap(a.ns, a.attr, a.vs, transformLocalDate, value2jsonLocalDate) //, set2arrayLocalDate, refNs, extsLocalDate)
      case a: AttrMapOptLocalTime      => addMap(a.ns, a.attr, a.vs, transformLocalTime, value2jsonLocalTime) //, set2arrayLocalTime, refNs, extsLocalTime)
      case a: AttrMapOptLocalDateTime  => addMap(a.ns, a.attr, a.vs, transformLocalDateTime, value2jsonLocalDateTime) //, set2arrayLocalDateTime, refNs, extsLocalDateTime)
      case a: AttrMapOptOffsetTime     => addMap(a.ns, a.attr, a.vs, transformOffsetTime, value2jsonOffsetTime) //, set2arrayOffsetTime, refNs, extsOffsetTime)
      case a: AttrMapOptOffsetDateTime => addMap(a.ns, a.attr, a.vs, transformOffsetDateTime, value2jsonOffsetDateTime) //, set2arrayOffsetDateTime, refNs, extsOffsetDateTime)
      case a: AttrMapOptZonedDateTime  => addMap(a.ns, a.attr, a.vs, transformZonedDateTime, value2jsonZonedDateTime) //, set2arrayZonedDateTime, refNs, extsZonedDateTime)
      case a: AttrMapOptUUID           => addMap(a.ns, a.attr, a.vs, transformUUID, value2jsonUUID) //, set2arrayUUID, refNs, extsUUID)
      case a: AttrMapOptURI            => addMap(a.ns, a.attr, a.vs, transformURI, value2jsonURI) //, set2arrayURI, refNs, extsURI)
      case a: AttrMapOptByte           => addMap(a.ns, a.attr, a.vs, transformByte, value2jsonByte) //, set2arrayByte, refNs, extsByte)
      case a: AttrMapOptShort          => addMap(a.ns, a.attr, a.vs, transformShort, value2jsonShort) //, set2arrayShort, refNs, extsShort)
      case a: AttrMapOptChar           => addMap(a.ns, a.attr, a.vs, transformChar, value2jsonChar) //, set2arrayChar, refNs, extsChar)
    }
  }
}