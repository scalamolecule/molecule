...
class ResolveUpdate(
  ...
  private def resolveAttrSetRemove(a: AttrSetMan): Unit = {
    val (ns, attr, refNs, owner) = (a.ns, a.attr, a.refNs, a.owner)
    a match {
      case a: AttrSetManID             => updateSetRemove(ns, attr, refNs, owner, a.vs, transformID, extsID, one2jsonID, set2arrayID)
      case a: AttrSetManString         => updateSetRemove(ns, attr, refNs, owner, a.vs, transformString, extsString, one2jsonString, set2arrayString)
      case a: AttrSetManInt            => updateSetRemove(ns, attr, refNs, owner, a.vs, transformInt, extsInt, one2jsonInt, set2arrayInt)
      case a: AttrSetManLong           => updateSetRemove(ns, attr, refNs, owner, a.vs, transformLong, extsLong, one2jsonLong, set2arrayLong)
      case a: AttrSetManFloat          => updateSetRemove(ns, attr, refNs, owner, a.vs, transformFloat, extsFloat, one2jsonFloat, set2arrayFloat)
      case a: AttrSetManDouble         => updateSetRemove(ns, attr, refNs, owner, a.vs, transformDouble, extsDouble, one2jsonDouble, set2arrayDouble)
      case a: AttrSetManBoolean        => updateSetRemove(ns, attr, refNs, owner, a.vs, transformBoolean, extsBoolean, one2jsonBoolean, set2arrayBoolean)
      case a: AttrSetManBigInt         => updateSetRemove(ns, attr, refNs, owner, a.vs, transformBigInt, extsBigInt, one2jsonBigInt, set2arrayBigInt)
      case a: AttrSetManBigDecimal     => updateSetRemove(ns, attr, refNs, owner, a.vs, transformBigDecimal, extsBigDecimal, one2jsonBigDecimal, set2arrayBigDecimal)
      case a: AttrSetManDate           => updateSetRemove(ns, attr, refNs, owner, a.vs, transformDate, extsDate, one2jsonDate, set2arrayDate)
      case a: AttrSetManDuration       => updateSetRemove(ns, attr, refNs, owner, a.vs, transformDuration, extsDuration, one2jsonDuration, set2arrayDuration)
      case a: AttrSetManInstant        => updateSetRemove(ns, attr, refNs, owner, a.vs, transformInstant, extsInstant, one2jsonInstant, set2arrayInstant)
      case a: AttrSetManLocalDate      => updateSetRemove(ns, attr, refNs, owner, a.vs, transformLocalDate, extsLocalDate, one2jsonLocalDate, set2arrayLocalDate)
      case a: AttrSetManLocalTime      => updateSetRemove(ns, attr, refNs, owner, a.vs, transformLocalTime, extsLocalTime, one2jsonLocalTime, set2arrayLocalTime)
      case a: AttrSetManLocalDateTime  => updateSetRemove(ns, attr, refNs, owner, a.vs, transformLocalDateTime, extsLocalDateTime, one2jsonLocalDateTime, set2arrayLocalDateTime)
      case a: AttrSetManOffsetTime     => updateSetRemove(ns, attr, refNs, owner, a.vs, transformOffsetTime, extsOffsetTime, one2jsonOffsetTime, set2arrayOffsetTime)
      case a: AttrSetManOffsetDateTime => updateSetRemove(ns, attr, refNs, owner, a.vs, transformOffsetDateTime, extsOffsetDateTime, one2jsonOffsetDateTime, set2arrayOffsetDateTime)
      case a: AttrSetManZonedDateTime  => updateSetRemove(ns, attr, refNs, owner, a.vs, transformZonedDateTime, extsZonedDateTime, one2jsonZonedDateTime, set2arrayZonedDateTime)
      case a: AttrSetManUUID           => updateSetRemove(ns, attr, refNs, owner, a.vs, transformUUID, extsUUID, one2jsonUUID, set2arrayUUID)
      case a: AttrSetManURI            => updateSetRemove(ns, attr, refNs, owner, a.vs, transformURI, extsURI, one2jsonURI, set2arrayURI)
      case a: AttrSetManByte           => updateSetRemove(ns, attr, refNs, owner, a.vs, transformByte, extsByte, one2jsonByte, set2arrayByte)
      case a: AttrSetManShort          => updateSetRemove(ns, attr, refNs, owner, a.vs, transformShort, extsShort, one2jsonShort, set2arrayShort)
      case a: AttrSetManChar           => updateSetRemove(ns, attr, refNs, owner, a.vs, transformChar, extsChar, one2jsonChar, set2arrayChar)
    }
  }
  ...
  private def resolveAttrSeqRemove(a: AttrSeqMan): Unit = {
    val (ns, attr, refNs, owner) = (a.ns, a.attr, a.refNs, a.owner)
    a match {
      case a: AttrSeqManID             => updateSeqRemove(ns, attr, refNs, owner, a.vs, transformID, extsID, one2jsonID, seq2arrayID)
      case a: AttrSeqManString         => updateSeqRemove(ns, attr, refNs, owner, a.vs, transformString, extsString, one2jsonString, seq2arrayString)
      case a: AttrSeqManInt            => updateSeqRemove(ns, attr, refNs, owner, a.vs, transformInt, extsInt, one2jsonInt, seq2arrayInt)
      case a: AttrSeqManLong           => updateSeqRemove(ns, attr, refNs, owner, a.vs, transformLong, extsLong, one2jsonLong, seq2arrayLong)
      case a: AttrSeqManFloat          => updateSeqRemove(ns, attr, refNs, owner, a.vs, transformFloat, extsFloat, one2jsonFloat, seq2arrayFloat)
      case a: AttrSeqManDouble         => updateSeqRemove(ns, attr, refNs, owner, a.vs, transformDouble, extsDouble, one2jsonDouble, seq2arrayDouble)
      case a: AttrSeqManBoolean        => updateSeqRemove(ns, attr, refNs, owner, a.vs, transformBoolean, extsBoolean, one2jsonBoolean, seq2arrayBoolean)
      case a: AttrSeqManBigInt         => updateSeqRemove(ns, attr, refNs, owner, a.vs, transformBigInt, extsBigInt, one2jsonBigInt, seq2arrayBigInt)
      case a: AttrSeqManBigDecimal     => updateSeqRemove(ns, attr, refNs, owner, a.vs, transformBigDecimal, extsBigDecimal, one2jsonBigDecimal, seq2arrayBigDecimal)
      case a: AttrSeqManDate           => updateSeqRemove(ns, attr, refNs, owner, a.vs, transformDate, extsDate, one2jsonDate, seq2arrayDate)
      case a: AttrSeqManDuration       => updateSeqRemove(ns, attr, refNs, owner, a.vs, transformDuration, extsDuration, one2jsonDuration, seq2arrayDuration)
      case a: AttrSeqManInstant        => updateSeqRemove(ns, attr, refNs, owner, a.vs, transformInstant, extsInstant, one2jsonInstant, seq2arrayInstant)
      case a: AttrSeqManLocalDate      => updateSeqRemove(ns, attr, refNs, owner, a.vs, transformLocalDate, extsLocalDate, one2jsonLocalDate, seq2arrayLocalDate)
      case a: AttrSeqManLocalTime      => updateSeqRemove(ns, attr, refNs, owner, a.vs, transformLocalTime, extsLocalTime, one2jsonLocalTime, seq2arrayLocalTime)
      case a: AttrSeqManLocalDateTime  => updateSeqRemove(ns, attr, refNs, owner, a.vs, transformLocalDateTime, extsLocalDateTime, one2jsonLocalDateTime, seq2arrayLocalDateTime)
      case a: AttrSeqManOffsetTime     => updateSeqRemove(ns, attr, refNs, owner, a.vs, transformOffsetTime, extsOffsetTime, one2jsonOffsetTime, seq2arrayOffsetTime)
      case a: AttrSeqManOffsetDateTime => updateSeqRemove(ns, attr, refNs, owner, a.vs, transformOffsetDateTime, extsOffsetDateTime, one2jsonOffsetDateTime, seq2arrayOffsetDateTime)
      case a: AttrSeqManZonedDateTime  => updateSeqRemove(ns, attr, refNs, owner, a.vs, transformZonedDateTime, extsZonedDateTime, one2jsonZonedDateTime, seq2arrayZonedDateTime)
      case a: AttrSeqManUUID           => updateSeqRemove(ns, attr, refNs, owner, a.vs, transformUUID, extsUUID, one2jsonUUID, seq2arrayUUID)
      case a: AttrSeqManURI            => updateSeqRemove(ns, attr, refNs, owner, a.vs, transformURI, extsURI, one2jsonURI, seq2arrayURI)
      case a: AttrSeqManShort          => updateSeqRemove(ns, attr, refNs, owner, a.vs, transformShort, extsShort, one2jsonShort, seq2arrayShort)
      case a: AttrSeqManChar           => updateSeqRemove(ns, attr, refNs, owner, a.vs, transformChar, extsChar, one2jsonChar, seq2arrayChar)
      case a: AttrSeqManByte           => throw ModelError(s"Operations on byte arrays (${a.ns}.${a.attr}) not allowed.")
    }
  }
  ...
  private def resolveAttrMapMan(a: AttrMapMan): Unit = {
    ...
    a match {
      case a: AttrMapManID             => updateMapEq(ns, attr, refNs, noValue, owner, a.vs, transformID, value2jsonID)
      case a: AttrMapManString         => updateMapEq(ns, attr, refNs, noValue, owner, a.vs, transformString, value2jsonString)
      case a: AttrMapManInt            => updateMapEq(ns, attr, refNs, noValue, owner, a.vs, transformInt, value2jsonInt)
      case a: AttrMapManLong           => updateMapEq(ns, attr, refNs, noValue, owner, a.vs, transformLong, value2jsonLong)
      case a: AttrMapManFloat          => updateMapEq(ns, attr, refNs, noValue, owner, a.vs, transformFloat, value2jsonFloat)
      case a: AttrMapManDouble         => updateMapEq(ns, attr, refNs, noValue, owner, a.vs, transformDouble, value2jsonDouble)
      case a: AttrMapManBoolean        => updateMapEq(ns, attr, refNs, noValue, owner, a.vs, transformBoolean, value2jsonBoolean)
      case a: AttrMapManBigInt         => updateMapEq(ns, attr, refNs, noValue, owner, a.vs, transformBigInt, value2jsonBigInt)
      case a: AttrMapManBigDecimal     => updateMapEq(ns, attr, refNs, noValue, owner, a.vs, transformBigDecimal, value2jsonBigDecimal)
      case a: AttrMapManDate           => updateMapEq(ns, attr, refNs, noValue, owner, a.vs, transformDate, value2jsonDate)
      case a: AttrMapManDuration       => updateMapEq(ns, attr, refNs, noValue, owner, a.vs, transformDuration, value2jsonDuration)
      case a: AttrMapManInstant        => updateMapEq(ns, attr, refNs, noValue, owner, a.vs, transformInstant, value2jsonInstant)
      case a: AttrMapManLocalDate      => updateMapEq(ns, attr, refNs, noValue, owner, a.vs, transformLocalDate, value2jsonLocalDate)
      case a: AttrMapManLocalTime      => updateMapEq(ns, attr, refNs, noValue, owner, a.vs, transformLocalTime, value2jsonLocalTime)
      case a: AttrMapManLocalDateTime  => updateMapEq(ns, attr, refNs, noValue, owner, a.vs, transformLocalDateTime, value2jsonLocalDateTime)
      case a: AttrMapManOffsetTime     => updateMapEq(ns, attr, refNs, noValue, owner, a.vs, transformOffsetTime, value2jsonOffsetTime)
      case a: AttrMapManOffsetDateTime => updateMapEq(ns, attr, refNs, noValue, owner, a.vs, transformOffsetDateTime, value2jsonOffsetDateTime)
      case a: AttrMapManZonedDateTime  => updateMapEq(ns, attr, refNs, noValue, owner, a.vs, transformZonedDateTime, value2jsonZonedDateTime)
      case a: AttrMapManUUID           => updateMapEq(ns, attr, refNs, noValue, owner, a.vs, transformUUID, value2jsonUUID)
      case a: AttrMapManURI            => updateMapEq(ns, attr, refNs, noValue, owner, a.vs, transformURI, value2jsonURI)
      case a: AttrMapManByte           => updateMapEq(ns, attr, refNs, noValue, owner, a.vs, transformByte, value2jsonByte)
      case a: AttrMapManShort          => updateMapEq(ns, attr, refNs, noValue, owner, a.vs, transformShort, value2jsonShort)
      case a: AttrMapManChar           => updateMapEq(ns, attr, refNs, noValue, owner, a.vs, transformChar, value2jsonChar)
    }
  }
  ...
  private def resolveAttrMapAdd(a: AttrMapMan): Unit = {
    val (ns, attr, refNs, owner) = (a.ns, a.attr, a.refNs, a.owner)
    a match {
      case a: AttrMapManID             => updateMapAdd(ns, attr, refNs, owner, a.vs, transformID, extsID, value2jsonID)
      case a: AttrMapManString         => updateMapAdd(ns, attr, refNs, owner, a.vs, transformString, extsString, value2jsonString)
      case a: AttrMapManInt            => updateMapAdd(ns, attr, refNs, owner, a.vs, transformInt, extsInt, value2jsonInt)
      case a: AttrMapManLong           => updateMapAdd(ns, attr, refNs, owner, a.vs, transformLong, extsLong, value2jsonLong)
      case a: AttrMapManFloat          => updateMapAdd(ns, attr, refNs, owner, a.vs, transformFloat, extsFloat, value2jsonFloat)
      case a: AttrMapManDouble         => updateMapAdd(ns, attr, refNs, owner, a.vs, transformDouble, extsDouble, value2jsonDouble)
      case a: AttrMapManBoolean        => updateMapAdd(ns, attr, refNs, owner, a.vs, transformBoolean, extsBoolean, value2jsonBoolean)
      case a: AttrMapManBigInt         => updateMapAdd(ns, attr, refNs, owner, a.vs, transformBigInt, extsBigInt, value2jsonBigInt)
      case a: AttrMapManBigDecimal     => updateMapAdd(ns, attr, refNs, owner, a.vs, transformBigDecimal, extsBigDecimal, value2jsonBigDecimal)
      case a: AttrMapManDate           => updateMapAdd(ns, attr, refNs, owner, a.vs, transformDate, extsDate, value2jsonDate)
      case a: AttrMapManDuration       => updateMapAdd(ns, attr, refNs, owner, a.vs, transformDuration, extsDuration, value2jsonDuration)
      case a: AttrMapManInstant        => updateMapAdd(ns, attr, refNs, owner, a.vs, transformInstant, extsInstant, value2jsonInstant)
      case a: AttrMapManLocalDate      => updateMapAdd(ns, attr, refNs, owner, a.vs, transformLocalDate, extsLocalDate, value2jsonLocalDate)
      case a: AttrMapManLocalTime      => updateMapAdd(ns, attr, refNs, owner, a.vs, transformLocalTime, extsLocalTime, value2jsonLocalTime)
      case a: AttrMapManLocalDateTime  => updateMapAdd(ns, attr, refNs, owner, a.vs, transformLocalDateTime, extsLocalDateTime, value2jsonLocalDateTime)
      case a: AttrMapManOffsetTime     => updateMapAdd(ns, attr, refNs, owner, a.vs, transformOffsetTime, extsOffsetTime, value2jsonOffsetTime)
      case a: AttrMapManOffsetDateTime => updateMapAdd(ns, attr, refNs, owner, a.vs, transformOffsetDateTime, extsOffsetDateTime, value2jsonOffsetDateTime)
      case a: AttrMapManZonedDateTime  => updateMapAdd(ns, attr, refNs, owner, a.vs, transformZonedDateTime, extsZonedDateTime, value2jsonZonedDateTime)
      case a: AttrMapManUUID           => updateMapAdd(ns, attr, refNs, owner, a.vs, transformUUID, extsUUID, value2jsonUUID)
      case a: AttrMapManURI            => updateMapAdd(ns, attr, refNs, owner, a.vs, transformURI, extsURI, value2jsonURI)
      case a: AttrMapManByte           => updateMapAdd(ns, attr, refNs, owner, a.vs, transformByte, extsByte, value2jsonByte)
      case a: AttrMapManShort          => updateMapAdd(ns, attr, refNs, owner, a.vs, transformShort, extsShort, value2jsonShort)
      case a: AttrMapManChar           => updateMapAdd(ns, attr, refNs, owner, a.vs, transformChar, extsChar, value2jsonChar)
    }
  }
  ...
  private def resolveAttrMapRemove(a: AttrMapMan): Unit = {
    val (ns, attr, refNs, owner) = (a.ns, a.attr, a.refNs, a.owner)
    a match {
      case a: AttrMapManID             => updateMapRemove(ns, attr, refNs, owner, a.vs, transformID, extsID, value2jsonID)
      case a: AttrMapManString         => updateMapRemove(ns, attr, refNs, owner, a.vs, transformString, extsString, value2jsonString)
      case a: AttrMapManInt            => updateMapRemove(ns, attr, refNs, owner, a.vs, transformInt, extsInt, value2jsonInt)
      case a: AttrMapManLong           => updateMapRemove(ns, attr, refNs, owner, a.vs, transformLong, extsLong, value2jsonLong)
      case a: AttrMapManFloat          => updateMapRemove(ns, attr, refNs, owner, a.vs, transformFloat, extsFloat, value2jsonFloat)
      case a: AttrMapManDouble         => updateMapRemove(ns, attr, refNs, owner, a.vs, transformDouble, extsDouble, value2jsonDouble)
      case a: AttrMapManBoolean        => updateMapRemove(ns, attr, refNs, owner, a.vs, transformBoolean, extsBoolean, value2jsonBoolean)
      case a: AttrMapManBigInt         => updateMapRemove(ns, attr, refNs, owner, a.vs, transformBigInt, extsBigInt, value2jsonBigInt)
      case a: AttrMapManBigDecimal     => updateMapRemove(ns, attr, refNs, owner, a.vs, transformBigDecimal, extsBigDecimal, value2jsonBigDecimal)
      case a: AttrMapManDate           => updateMapRemove(ns, attr, refNs, owner, a.vs, transformDate, extsDate, value2jsonDate)
      case a: AttrMapManDuration       => updateMapRemove(ns, attr, refNs, owner, a.vs, transformDuration, extsDuration, value2jsonDuration)
      case a: AttrMapManInstant        => updateMapRemove(ns, attr, refNs, owner, a.vs, transformInstant, extsInstant, value2jsonInstant)
      case a: AttrMapManLocalDate      => updateMapRemove(ns, attr, refNs, owner, a.vs, transformLocalDate, extsLocalDate, value2jsonLocalDate)
      case a: AttrMapManLocalTime      => updateMapRemove(ns, attr, refNs, owner, a.vs, transformLocalTime, extsLocalTime, value2jsonLocalTime)
      case a: AttrMapManLocalDateTime  => updateMapRemove(ns, attr, refNs, owner, a.vs, transformLocalDateTime, extsLocalDateTime, value2jsonLocalDateTime)
      case a: AttrMapManOffsetTime     => updateMapRemove(ns, attr, refNs, owner, a.vs, transformOffsetTime, extsOffsetTime, value2jsonOffsetTime)
      case a: AttrMapManOffsetDateTime => updateMapRemove(ns, attr, refNs, owner, a.vs, transformOffsetDateTime, extsOffsetDateTime, value2jsonOffsetDateTime)
      case a: AttrMapManZonedDateTime  => updateMapRemove(ns, attr, refNs, owner, a.vs, transformZonedDateTime, extsZonedDateTime, value2jsonZonedDateTime)
      case a: AttrMapManUUID           => updateMapRemove(ns, attr, refNs, owner, a.vs, transformUUID, extsUUID, value2jsonUUID)
      case a: AttrMapManURI            => updateMapRemove(ns, attr, refNs, owner, a.vs, transformURI, extsURI, value2jsonURI)
      case a: AttrMapManByte           => updateMapRemove(ns, attr, refNs, owner, a.vs, transformByte, extsByte, value2jsonByte)
      case a: AttrMapManShort          => updateMapRemove(ns, attr, refNs, owner, a.vs, transformShort, extsShort, value2jsonShort)
      case a: AttrMapManChar           => updateMapRemove(ns, attr, refNs, owner, a.vs, transformChar, extsChar, value2jsonChar)
    }
  }
}