...
class ResolveUpdate(
  ...
  private def resolveAttrMapMan(a: AttrMapMan): Unit = {
    ...
    a match {
      case a: AttrMapManID             => updateMapEq(ns, attr, refNs, noValue, a.vs, transformID, value2jsonID)
      case a: AttrMapManString         => updateMapEq(ns, attr, refNs, noValue, a.vs, transformString, value2jsonString)
      case a: AttrMapManInt            => updateMapEq(ns, attr, refNs, noValue, a.vs, transformInt, value2jsonInt)
      case a: AttrMapManLong           => updateMapEq(ns, attr, refNs, noValue, a.vs, transformLong, value2jsonLong)
      case a: AttrMapManFloat          => updateMapEq(ns, attr, refNs, noValue, a.vs, transformFloat, value2jsonFloat)
      case a: AttrMapManDouble         => updateMapEq(ns, attr, refNs, noValue, a.vs, transformDouble, value2jsonDouble)
      case a: AttrMapManBoolean        => updateMapEq(ns, attr, refNs, noValue, a.vs, transformBoolean, value2jsonBoolean)
      case a: AttrMapManBigInt         => updateMapEq(ns, attr, refNs, noValue, a.vs, transformBigInt, value2jsonBigInt)
      case a: AttrMapManBigDecimal     => updateMapEq(ns, attr, refNs, noValue, a.vs, transformBigDecimal, value2jsonBigDecimal)
      case a: AttrMapManDate           => updateMapEq(ns, attr, refNs, noValue, a.vs, transformDate, value2jsonDate)
      case a: AttrMapManDuration       => updateMapEq(ns, attr, refNs, noValue, a.vs, transformDuration, value2jsonDuration)
      case a: AttrMapManInstant        => updateMapEq(ns, attr, refNs, noValue, a.vs, transformInstant, value2jsonInstant)
      case a: AttrMapManLocalDate      => updateMapEq(ns, attr, refNs, noValue, a.vs, transformLocalDate, value2jsonLocalDate)
      case a: AttrMapManLocalTime      => updateMapEq(ns, attr, refNs, noValue, a.vs, transformLocalTime, value2jsonLocalTime)
      case a: AttrMapManLocalDateTime  => updateMapEq(ns, attr, refNs, noValue, a.vs, transformLocalDateTime, value2jsonLocalDateTime)
      case a: AttrMapManOffsetTime     => updateMapEq(ns, attr, refNs, noValue, a.vs, transformOffsetTime, value2jsonOffsetTime)
      case a: AttrMapManOffsetDateTime => updateMapEq(ns, attr, refNs, noValue, a.vs, transformOffsetDateTime, value2jsonOffsetDateTime)
      case a: AttrMapManZonedDateTime  => updateMapEq(ns, attr, refNs, noValue, a.vs, transformZonedDateTime, value2jsonZonedDateTime)
      case a: AttrMapManUUID           => updateMapEq(ns, attr, refNs, noValue, a.vs, transformUUID, value2jsonUUID)
      case a: AttrMapManURI            => updateMapEq(ns, attr, refNs, noValue, a.vs, transformURI, value2jsonURI)
      case a: AttrMapManByte           => updateMapEq(ns, attr, refNs, noValue, a.vs, transformByte, value2jsonByte)
      case a: AttrMapManShort          => updateMapEq(ns, attr, refNs, noValue, a.vs, transformShort, value2jsonShort)
      case a: AttrMapManChar           => updateMapEq(ns, attr, refNs, noValue, a.vs, transformChar, value2jsonChar)
    }
  }
  ...
  private def resolveAttrMapAdd(a: AttrMapMan): Unit = {
    val (ns, attr, refNs) = (a.ns, a.attr, a.refNs)
    a match {
      case a: AttrMapManID             => updateMapAdd(ns, attr, refNs, a.vs, transformID, extsID, value2jsonID)
      case a: AttrMapManString         => updateMapAdd(ns, attr, refNs, a.vs, transformString, extsString, value2jsonString)
      case a: AttrMapManInt            => updateMapAdd(ns, attr, refNs, a.vs, transformInt, extsInt, value2jsonInt)
      case a: AttrMapManLong           => updateMapAdd(ns, attr, refNs, a.vs, transformLong, extsLong, value2jsonLong)
      case a: AttrMapManFloat          => updateMapAdd(ns, attr, refNs, a.vs, transformFloat, extsFloat, value2jsonFloat)
      case a: AttrMapManDouble         => updateMapAdd(ns, attr, refNs, a.vs, transformDouble, extsDouble, value2jsonDouble)
      case a: AttrMapManBoolean        => updateMapAdd(ns, attr, refNs, a.vs, transformBoolean, extsBoolean, value2jsonBoolean)
      case a: AttrMapManBigInt         => updateMapAdd(ns, attr, refNs, a.vs, transformBigInt, extsBigInt, value2jsonBigInt)
      case a: AttrMapManBigDecimal     => updateMapAdd(ns, attr, refNs, a.vs, transformBigDecimal, extsBigDecimal, value2jsonBigDecimal)
      case a: AttrMapManDate           => updateMapAdd(ns, attr, refNs, a.vs, transformDate, extsDate, value2jsonDate)
      case a: AttrMapManDuration       => updateMapAdd(ns, attr, refNs, a.vs, transformDuration, extsDuration, value2jsonDuration)
      case a: AttrMapManInstant        => updateMapAdd(ns, attr, refNs, a.vs, transformInstant, extsInstant, value2jsonInstant)
      case a: AttrMapManLocalDate      => updateMapAdd(ns, attr, refNs, a.vs, transformLocalDate, extsLocalDate, value2jsonLocalDate)
      case a: AttrMapManLocalTime      => updateMapAdd(ns, attr, refNs, a.vs, transformLocalTime, extsLocalTime, value2jsonLocalTime)
      case a: AttrMapManLocalDateTime  => updateMapAdd(ns, attr, refNs, a.vs, transformLocalDateTime, extsLocalDateTime, value2jsonLocalDateTime)
      case a: AttrMapManOffsetTime     => updateMapAdd(ns, attr, refNs, a.vs, transformOffsetTime, extsOffsetTime, value2jsonOffsetTime)
      case a: AttrMapManOffsetDateTime => updateMapAdd(ns, attr, refNs, a.vs, transformOffsetDateTime, extsOffsetDateTime, value2jsonOffsetDateTime)
      case a: AttrMapManZonedDateTime  => updateMapAdd(ns, attr, refNs, a.vs, transformZonedDateTime, extsZonedDateTime, value2jsonZonedDateTime)
      case a: AttrMapManUUID           => updateMapAdd(ns, attr, refNs, a.vs, transformUUID, extsUUID, value2jsonUUID)
      case a: AttrMapManURI            => updateMapAdd(ns, attr, refNs, a.vs, transformURI, extsURI, value2jsonURI)
      case a: AttrMapManByte           => updateMapAdd(ns, attr, refNs, a.vs, transformByte, extsByte, value2jsonByte)
      case a: AttrMapManShort          => updateMapAdd(ns, attr, refNs, a.vs, transformShort, extsShort, value2jsonShort)
      case a: AttrMapManChar           => updateMapAdd(ns, attr, refNs, a.vs, transformChar, extsChar, value2jsonChar)
    }
  }
  ...
  private def resolveAttrMapRemove(a: AttrMapMan): Unit = {
    val (ns, attr, refNs) = (a.ns, a.attr, a.refNs)
    a match {
      case a: AttrMapManID             => updateMapRemove(ns, attr, refNs, a.vs, extsID)
      case a: AttrMapManString         => updateMapRemove(ns, attr, refNs, a.vs, extsString)
      case a: AttrMapManInt            => updateMapRemove(ns, attr, refNs, a.vs, extsInt)
      case a: AttrMapManLong           => updateMapRemove(ns, attr, refNs, a.vs, extsLong)
      case a: AttrMapManFloat          => updateMapRemove(ns, attr, refNs, a.vs, extsFloat)
      case a: AttrMapManDouble         => updateMapRemove(ns, attr, refNs, a.vs, extsDouble)
      case a: AttrMapManBoolean        => updateMapRemove(ns, attr, refNs, a.vs, extsBoolean)
      case a: AttrMapManBigInt         => updateMapRemove(ns, attr, refNs, a.vs, extsBigInt)
      case a: AttrMapManBigDecimal     => updateMapRemove(ns, attr, refNs, a.vs, extsBigDecimal)
      case a: AttrMapManDate           => updateMapRemove(ns, attr, refNs, a.vs, extsDate)
      case a: AttrMapManDuration       => updateMapRemove(ns, attr, refNs, a.vs, extsDuration)
      case a: AttrMapManInstant        => updateMapRemove(ns, attr, refNs, a.vs, extsInstant)
      case a: AttrMapManLocalDate      => updateMapRemove(ns, attr, refNs, a.vs, extsLocalDate)
      case a: AttrMapManLocalTime      => updateMapRemove(ns, attr, refNs, a.vs, extsLocalTime)
      case a: AttrMapManLocalDateTime  => updateMapRemove(ns, attr, refNs, a.vs, extsLocalDateTime)
      case a: AttrMapManOffsetTime     => updateMapRemove(ns, attr, refNs, a.vs, extsOffsetTime)
      case a: AttrMapManOffsetDateTime => updateMapRemove(ns, attr, refNs, a.vs, extsOffsetDateTime)
      case a: AttrMapManZonedDateTime  => updateMapRemove(ns, attr, refNs, a.vs, extsZonedDateTime)
      case a: AttrMapManUUID           => updateMapRemove(ns, attr, refNs, a.vs, extsUUID)
      case a: AttrMapManURI            => updateMapRemove(ns, attr, refNs, a.vs, extsURI)
      case a: AttrMapManByte           => updateMapRemove(ns, attr, refNs, a.vs, extsByte)
      case a: AttrMapManShort          => updateMapRemove(ns, attr, refNs, a.vs, extsShort)
      case a: AttrMapManChar           => updateMapRemove(ns, attr, refNs, a.vs, extsChar)
    }
  }
}