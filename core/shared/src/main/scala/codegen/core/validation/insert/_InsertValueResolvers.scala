...
object _InsertValueResolvers extends CoreGenBase("InsertValueResolvers", "/validation/insert") {
  ...
  val content = {
    ...
    s"""// GENERATED CODE ********************************
       ...
       |          case _: AttrSeqManID             => (tpl: Product) => ArrString(tpl.productElement(i).asInstanceOf[Array[String]])
       |          case _: AttrSeqManString         => (tpl: Product) => ArrString(tpl.productElement(i).asInstanceOf[Array[String]])
       |          case _: AttrSeqManInt            => (tpl: Product) => ArrInt(tpl.productElement(i).asInstanceOf[Array[Int]])
       |          case _: AttrSeqManLong           => (tpl: Product) => ArrLong(tpl.productElement(i).asInstanceOf[Array[Long]])
       |          case _: AttrSeqManFloat          => (tpl: Product) => ArrFloat(tpl.productElement(i).asInstanceOf[Array[Float]])
       |          case _: AttrSeqManDouble         => (tpl: Product) => ArrDouble(tpl.productElement(i).asInstanceOf[Array[Double]])
       |          case _: AttrSeqManBoolean        => (tpl: Product) => ArrBoolean(tpl.productElement(i).asInstanceOf[Array[Boolean]])
       |          case _: AttrSeqManBigInt         => (tpl: Product) => ArrBigInt(tpl.productElement(i).asInstanceOf[Array[BigInt]])
       |          case _: AttrSeqManBigDecimal     => (tpl: Product) => ArrBigDecimal(tpl.productElement(i).asInstanceOf[Array[BigDecimal]])
       |          case _: AttrSeqManDate           => (tpl: Product) => ArrDate(tpl.productElement(i).asInstanceOf[Array[Date]])
       |          case _: AttrSeqManDuration       => (tpl: Product) => ArrDuration(tpl.productElement(i).asInstanceOf[Array[Duration]])
       |          case _: AttrSeqManInstant        => (tpl: Product) => ArrInstant(tpl.productElement(i).asInstanceOf[Array[Instant]])
       |          case _: AttrSeqManLocalDate      => (tpl: Product) => ArrLocalDate(tpl.productElement(i).asInstanceOf[Array[LocalDate]])
       |          case _: AttrSeqManLocalTime      => (tpl: Product) => ArrLocalTime(tpl.productElement(i).asInstanceOf[Array[LocalTime]])
       |          case _: AttrSeqManLocalDateTime  => (tpl: Product) => ArrLocalDateTime(tpl.productElement(i).asInstanceOf[Array[LocalDateTime]])
       |          case _: AttrSeqManOffsetTime     => (tpl: Product) => ArrOffsetTime(tpl.productElement(i).asInstanceOf[Array[OffsetTime]])
       |          case _: AttrSeqManOffsetDateTime => (tpl: Product) => ArrOffsetDateTime(tpl.productElement(i).asInstanceOf[Array[OffsetDateTime]])
       |          case _: AttrSeqManZonedDateTime  => (tpl: Product) => ArrZonedDateTime(tpl.productElement(i).asInstanceOf[Array[ZonedDateTime]])
       |          case _: AttrSeqManUUID           => (tpl: Product) => ArrUUID(tpl.productElement(i).asInstanceOf[Array[UUID]])
       |          case _: AttrSeqManURI            => (tpl: Product) => ArrURI(tpl.productElement(i).asInstanceOf[Array[URI]])
       |          case _: AttrSeqManByte           => (tpl: Product) => ArrByte(tpl.productElement(i).asInstanceOf[Array[Byte]])
       |          case _: AttrSeqManShort          => (tpl: Product) => ArrShort(tpl.productElement(i).asInstanceOf[Array[Short]])
       |          case _: AttrSeqManChar           => (tpl: Product) => ArrChar(tpl.productElement(i).asInstanceOf[Array[Char]])
       |        }
       |
