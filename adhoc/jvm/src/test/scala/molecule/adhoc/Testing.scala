...
//import molecule.adhoc.domains.schema.TypesSchema_h2
//import molecule.adhoc.setup.{MUnitSuite, Test_h2}
//
//
//class Testing extends MUnitSuite with Test_h2 {
//
...
//    val data = JdbcProxy("a", TypesSchema_h2)
//
...
//    val helloWorld = Unpickle[JdbcProxy].fromBytes(buf)
//
//    data ==> helloWorld
//
////    1 ==> 1
