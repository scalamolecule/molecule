...
trait Spi_mariadb_zio extends Spi_zio with SpiBase_mariadb_zio {
  ...
  override def query_inspect[Tpl](q: Query[Tpl]): ZIO[Conn, MoleculeError, Unit] = {
    async2zio[Unit]((conn: JdbcConn_JS, ec: EC) => Spi_mariadb_async.query_inspect(q)(conn, ec))
  }
  ...
  override def queryOffset_inspect[Tpl](q: QueryOffset[Tpl]): ZIO[Conn, MoleculeError, Unit] = {
    async2zio[Unit]((conn: JdbcConn_JS, ec: EC) => Spi_mariadb_async.queryOffset_inspect(q)(conn, ec))
  }
  ...
  override def queryCursor_inspect[Tpl](q: QueryCursor[Tpl]): ZIO[Conn, MoleculeError, Unit] = {
    async2zio[Unit]((conn: JdbcConn_JS, ec: EC) => Spi_mariadb_async.queryCursor_inspect(q)(conn, ec))
  }
  ...
  override def save_inspect(save: Save): ZIO[Conn, MoleculeError, Unit] = {
    async2zio[Unit]((conn: JdbcConn_JS, ec: EC) => Spi_mariadb_async.save_inspect(save)(conn, ec))
  }
  ...
  override def insert_inspect(insert: Insert): ZIO[Conn, MoleculeError, Unit] = {
    async2zio[Unit]((conn: JdbcConn_JS, ec: EC) => Spi_mariadb_async.insert_inspect(insert)(conn, ec))
  }
  ...
  override def update_inspect(update: Update): ZIO[Conn, MoleculeError, Unit] = {
    async2zio[Unit]((conn: JdbcConn_JS, ec: EC) => Spi_mariadb_async.update_inspect(update)(conn, ec))
  }
  ...
  override def delete_inspect(delete: Delete): ZIO[Conn, MoleculeError, Unit] = {
    async2zio[Unit]((conn: JdbcConn_JS, ec: EC) => Spi_mariadb_async.delete_inspect(delete)(conn, ec))
  }
