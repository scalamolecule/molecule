...
trait Spi_sqlite_zio extends Spi_zio with SpiBase_sqlite_zio with StreamingJdbc with ModelUtils {
  ...
  override def query_inspect[Tpl](q: Query[Tpl]): ZIO[Conn, MoleculeError, Unit] = {
    sync2zio[Unit]((conn: JdbcConn_JVM) => Spi_sqlite_sync.query_inspect(q)(conn))
  }
  ...
  override def queryOffset_inspect[Tpl](q: QueryOffset[Tpl]): ZIO[Conn, MoleculeError, Unit] = {
    sync2zio[Unit]((conn: JdbcConn_JVM) => Spi_sqlite_sync.queryOffset_inspect(q)(conn))
  }
  ...
  override def queryCursor_inspect[Tpl](q: QueryCursor[Tpl]): ZIO[Conn, MoleculeError, Unit] = {
    sync2zio[Unit]((conn: JdbcConn_JVM) => Spi_sqlite_sync.queryCursor_inspect(q)(conn))
  }
  ...
  override def save_inspect(save: Save): ZIO[Conn, MoleculeError, Unit] = {
    sync2zio[Unit]((conn: JdbcConn_JVM) => Spi_sqlite_sync.save_inspect(save)(conn))
  }
  ...
  override def insert_inspect(insert: Insert): ZIO[Conn, MoleculeError, Unit] = {
    sync2zio[Unit]((conn: JdbcConn_JVM) => Spi_sqlite_sync.insert_inspect(insert)(conn))
  }
  ...
  override def update_inspect(update: Update): ZIO[Conn, MoleculeError, Unit] = {
    sync2zio[Unit]((conn: JdbcConn_JVM) => Spi_sqlite_sync.update_inspect(update)(conn))
  }
  ...
  override def delete_inspect(delete: Delete): ZIO[Conn, MoleculeError, Unit] = {
    sync2zio[Unit]((conn: JdbcConn_JVM) => Spi_sqlite_sync.delete_inspect(delete)(conn))
  }
