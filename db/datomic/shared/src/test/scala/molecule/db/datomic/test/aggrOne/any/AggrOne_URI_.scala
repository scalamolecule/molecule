...
object AggrOne_URI_ extends DatomicTestSuite {
  ...
  lazy val tests = Tests {
    ...
    "distinct" - types { implicit conn =>
      ...
      Ns.n.a1.uri.query.get.sortBy(_._2) ==> List(
        (1, uri1),
      ...
      Ns.n.a1.uri.apply(distinct).query.get ==> List(
        (1, Set(uri1)),
        (2, Set(uri2, uri3)),
      )
    ...
    "count, countDistinct" - types { implicit conn =>
      ...
      Ns.n.a1.uri(count).query.get ==> List(
        (1, 1),
        (2, 3)
      )
      Ns.n.a1.uri(countDistinct).query.get ==> List(
        (1, 1),
        (2, 2)
      )
    }
