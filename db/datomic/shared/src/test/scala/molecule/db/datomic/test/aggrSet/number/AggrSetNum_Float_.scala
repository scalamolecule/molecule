...
object AggrSetNum_Float_ extends DatomicTestSuite {
  ...
  lazy val tests = Tests {
    ...
    "sum" - types { implicit conn =>
      ...
      Ns.n.floats(sum).query.get ==> List(
    ...
    "median" - types { implicit futConn =>
      ...
      Ns.n.floats(median).query.get ==> List(
        (1, Set(1.0f)),
        (2, Set(3.3f)),
      )
    ...
    "avg" - types { implicit conn =>
      ...
      Ns.n.floats(avg).query.get ==> List(
    ...
    "variance" - types { implicit conn =>
      ...
      Ns.n.floats(variance).query.get ==> List(
    ...
    "stddev" - types { implicit conn =>
      ...
      Ns.n.floats(stddev).query.get ==> List(
