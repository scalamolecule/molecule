...
object AggrOne_Int extends DatomicTestSuite {
  ...
  lazy val tests = Tests {
    ...
    "distinct" - types { implicit conn =>
      ...
      Ns.n.a1.int.query.get.sortBy(_._2) ==> List(
        (1, int1),
      ...
      Ns.n.a1.int.apply(distinct).query.get ==> List(
        (1, Set(int1)),
        (2, Set(int2, int3)),
      )
    ...
    "count, countDistinct" - types { implicit conn =>
      ...
      Ns.n.a1.int(count).query.get ==> List(
        (1, 1),
        (2, 3)
      )
      Ns.n.a1.int(countDistinct).query.get ==> List(
        (1, 1),
        (2, 2)
      )
    }
