...
object ExprOne_Char_ extends DatomicTestSuite {
  ...
  lazy val tests = Tests {
    ...
    "Mandatory" - cardOne { implicit conn =>
      ...
      One.n.a1.char.query.get ==> List(a, b, c)
    ...
    "Tacit" - cardOne { implicit conn =>
      ...
      One.n.a1.char_.query.get ==> List(a, b, c)

      // Match non-asserted attribute (null)
      One.n.a1.char_().query.get ==> List(x)

      // Match attribute values without returning them
      One.n.a1.char_(char0).query.get ==> List()
      One.n.a1.char_(char1).query.get ==> List(a)
    ...
    "Optional" - cardOne { implicit conn =>
      ...
      One.n.a1.char_?.query.get ==> List(a, b, c, x)

      // Find optional values matching
      One.n.a1.char_?(Some(char0)).query.get ==> List()
      One.n.a1.char_?(Some(char1)).query.get ==> List(a)
