...
object AggrSetNum_BigInt_ extends DatomicTestSuite {
  ...
  lazy val tests = Tests {
    ...
    "sum" - types { implicit conn =>
      ...
      Ns.n.bigInts(sum).query.get ==> List(
    ...
    "median" - types { implicit futConn =>
      ...
      Ns.n.bigInts(median).query.get ==> List(
        (1, Set(1.0)),
        (2, Set(3.0)),
      )
    }
    ...
    "avg" - types { implicit conn =>
      ...
      Ns.n.bigInts(avg).query.get ==> List(
    ...
    "variance" - types { implicit conn =>
      ...
      Ns.n.bigInts(variance).query.get ==> List(
        (1, Set(0.25)),
    ...
    "stddev" - types { implicit conn =>
      ...
      Ns.n.bigInts(stddev).query.get ==> List(
        (1, Set(0.5)),
