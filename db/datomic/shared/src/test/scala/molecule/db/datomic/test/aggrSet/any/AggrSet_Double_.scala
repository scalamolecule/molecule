...
object AggrSet_Double_ extends DatomicTestSuite {
  ...
  lazy val tests = Tests {
    ...
    "distinct" - cardSet { implicit conn =>
      ...
      NsSet.doubles(distinct).query.get ==> List(
        Set(
          Set(double1, double2),
          Set(double2, double3),
          Set(double3, double4),
    ...
    "min" - cardSet { implicit conn =>
      ...
      NsSet.doubles(min(1)).query.get ==> List(Set(double1))
      NsSet.doubles(min(2)).query.get ==> List(Set(double1, double2))
    ...
    "max" - cardSet { implicit futConn =>
      ...
      NsSet.doubles(max(1)).query.get ==> List(Set(double4))
      NsSet.doubles(max(2)).query.get ==> List(Set(double3, double4))
    ...
    "rand" - cardSet { implicit conn =>
      ...
      all.intersect(NsSet.doubles(rand(1)).query.get.head).nonEmpty ==> true
      all.intersect(NsSet.doubles(rand(2)).query.get.head).nonEmpty ==> true
    }
    ...
    "sample" - cardSet { implicit futConn =>
      ...
      all.intersect(NsSet.doubles(sample(1)).query.get.head).nonEmpty ==> true
      all.intersect(NsSet.doubles(sample(2)).query.get.head).nonEmpty ==> true
    }
