...
object AggrSet_Char_ extends DatomicTestSuite {
  ...
  lazy val tests = Tests {
    ...
    "distinct" - cardSet { implicit conn =>
      ...
      NsSet.chars(distinct).query.get ==> List(
        Set(
          Set(char1, char2),
          Set(char2, char3),
          Set(char3, char4),
    ...
    "min" - cardSet { implicit conn =>
      ...
      NsSet.chars(min(1)).query.get ==> List(Set(char1))
      NsSet.chars(min(2)).query.get ==> List(Set(char1, char2))
    ...
    "max" - cardSet { implicit futConn =>
      ...
      NsSet.chars(max(1)).query.get ==> List(Set(char4))
      NsSet.chars(max(2)).query.get ==> List(Set(char3, char4))
    ...
    "rand" - cardSet { implicit conn =>
      ...
      all.intersect(NsSet.chars(rand(1)).query.get.head).nonEmpty ==> true
      all.intersect(NsSet.chars(rand(2)).query.get.head).nonEmpty ==> true
    }
    ...
    "sample" - cardSet { implicit futConn =>
      ...
      all.intersect(NsSet.chars(sample(1)).query.get.head).nonEmpty ==> true
      all.intersect(NsSet.chars(sample(2)).query.get.head).nonEmpty ==> true
    }
