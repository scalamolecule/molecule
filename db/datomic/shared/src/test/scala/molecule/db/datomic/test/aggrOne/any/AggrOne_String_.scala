...
object AggrOne_String_ extends DatomicTestSuite {
  ...
  lazy val tests = Tests {
    ...
    "distinct" - types { implicit conn =>
      ...
      Ns.n.a1.string.query.get.sortBy(_._2) ==> List(
        (1, string1),
      ...
      Ns.n.a1.string.apply(distinct).query.get ==> List(
        (1, Set(string1)),
    ...
    "count, countDistinct" - types { implicit conn =>
      ...
      Ns.n.a1.string(count).query.get ==> List(
        (1, 1),
        (2, 3)
      )
      Ns.n.a1.string(countDistinct).query.get ==> List(
        (1, 1),
        (2, 2)
      )
    }
