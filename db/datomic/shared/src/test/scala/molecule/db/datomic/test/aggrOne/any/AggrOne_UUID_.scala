...
object AggrOne_UUID_ extends DatomicTestSuite {
  ...
  lazy val tests = Tests {
    ...
    "distinct" - types { implicit conn =>
      ...
      Ns.n.a1.uuid.query.get.sortBy(_._2) ==> List(
        (1, uuid1),
      ...
      Ns.n.a1.uuid.apply(distinct).query.get ==> List(
        (1, Set(uuid1)),
        (2, Set(uuid2, uuid3)),
      )
    ...
    "count, countDistinct" - types { implicit conn =>
      ...
      Ns.n.a1.uuid(count).query.get ==> List(
        (1, 1),
        (2, 3)
      )
      Ns.n.a1.uuid(countDistinct).query.get ==> List(
        (1, 1),
        (2, 2)
      )
    }
