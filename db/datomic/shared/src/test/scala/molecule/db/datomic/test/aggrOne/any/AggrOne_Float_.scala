...
object AggrOne_Float_ extends DatomicTestSuite {
  ...
  lazy val tests = Tests {
    ...
    "distinct" - types { implicit conn =>
      ...
      Ns.n.a1.float.query.get.sortBy(_._2) ==> List(
        (1, float1),
      ...
      Ns.n.a1.float.apply(distinct).query.get ==> List(
        (1, Set(float1)),
        (2, Set(float2, float3)),
      )
    ...
    "count, countDistinct" - types { implicit conn =>
      ...
      Ns.n.a1.float(count).query.get ==> List(
        (1, 1),
        (2, 3)
      )
      Ns.n.a1.float(countDistinct).query.get ==> List(
        (1, 1),
        (2, 2)
      )
    }
