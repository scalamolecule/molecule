...
object AggrOne_Char_ extends DatomicTestSuite {
  ...
  lazy val tests = Tests {
    ...
    "distinct" - types { implicit conn =>
      ...
      Ns.n.a1.char.query.get.sortBy(_._2) ==> List(
        (1, char1),
      ...
      Ns.n.a1.char.apply(distinct).query.get ==> List(
        (1, Set(char1)),
        (2, Set(char2, char3)),
      )
    ...
    "count, countDistinct" - types { implicit conn =>
      ...
      Ns.n.a1.char(count).query.get ==> List(
        (1, 1),
        (2, 3)
      )
      Ns.n.a1.char(countDistinct).query.get ==> List(
        (1, 1),
        (2, 2)
      )
    }
