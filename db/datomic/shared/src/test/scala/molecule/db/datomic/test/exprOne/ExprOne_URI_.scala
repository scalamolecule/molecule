...
object ExprOne_URI_ extends DatomicTestSuite {
  ...
  lazy val tests = Tests {
    ...
    "Mandatory" - cardOne { implicit conn =>
      ...
      One.n.a1.uri.query.get ==> List(a, b, c)
    ...
    "Tacit" - cardOne { implicit conn =>
      ...
      One.n.a1.uri_.query.get ==> List(a, b, c)

      // Match non-asserted attribute (null)
      One.n.a1.uri_().query.get ==> List(x)

      // Match attribute values without returning them
      One.n.a1.uri_(uri0).query.get ==> List()
      One.n.a1.uri_(uri1).query.get ==> List(a)
    ...
    "Optional" - cardOne { implicit conn =>
      ...
      One.n.a1.uri_?.query.get ==> List(a, b, c, x)

      // Find optional values matching
      One.n.a1.uri_?(Some(uri0)).query.get ==> List()
      One.n.a1.uri_?(Some(uri1)).query.get ==> List(a)
