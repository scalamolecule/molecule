...
object AggrSet_ref_ extends DatomicTestSuite {
  ...
  lazy val tests = Tests {
    ...
    "min" - types { implicit conn =>
      ...
      Ns.n.refs(min).query.get ==> List(
        (1, Set(ref1)),
        (2, Set(ref2)),
      )
      // Same as
      Ns.n.refs(min(1)).query.get ==> List(
        (1, Set(ref1)),
        (2, Set(ref2)),
      )

      Ns.n.refs(min(2)).query.get ==> List(
        (1, Set(ref1, ref2)),
        (2, Set(ref2, ref3)),
      )
    }
    ...
    "max" - types { implicit futConn =>
      ...
      Ns.n.refs(max).query.get ==> List(
        (1, Set(ref2)),
        (2, Set(ref4)),
      )
      // Same as
      Ns.n.refs(max(1)).query.get ==> List(
        (1, Set(ref2)),
        (2, Set(ref4)),
      )

      Ns.n.refs(max(2)).query.get ==> List(
        (1, Set(ref1, ref2)),
        (2, Set(ref3, ref4)),
      )
    }
    ...
    "count, countDistinct" - types { implicit conn =>
      ...
      Ns.n.a1.refs(count).query.get ==> List(
        (1, 2),
        (2, 6)
      )
      Ns.n.a1.refs(countDistinct).query.get ==> List(
        (1, 2),
        (2, 3)
      )
    }
