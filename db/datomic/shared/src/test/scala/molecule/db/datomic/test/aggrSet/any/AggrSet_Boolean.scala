...
object AggrSet_Boolean extends DatomicTestSuite {
  ...
  lazy val tests = Tests {
    ...
    "min" - types { implicit conn =>
      ...
      Ns.n.booleans(min).query.get ==> List(
        (1, Set(true)),
        (2, Set(false)),
      )
      Ns.n.booleans(min(1)).query.get ==> List(
        (1, Set(true)),
        (2, Set(false)),
      )
      Ns.n.booleans(min(2)).query.get ==> List(
        (1, Set(true)),
        (2, Set(false, true)),
      )
    }
    ...
    "max" - types { implicit futConn =>
      ...
      Ns.n.booleans(max).query.get ==> List(
        (1, Set(true)),
        (2, Set(true)),
      )
      Ns.n.booleans(max(1)).query.get ==> List(
        (1, Set(true)),
        (2, Set(true)),
      )
      Ns.n.booleans(max(2)).query.get ==> List(
        (1, Set(true)),
        (2, Set(true, false)),
      )
    }
