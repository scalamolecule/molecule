...
object CardOneExpr extends DatomicTestSuite {
  ...
  lazy val tests = Tests {
    ...
    "Mandatory" - cardOne { implicit conn =>
      ...
      // Arguments as Seq
      One.n.a1.int.apply(Seq(int0)).query.get ==> List()
...
//
//      // todo: unify
//      //          One.n.a1.int_(unify).query.get ==> List(4)
//
//      One.n.a1.int_.apply(int0).query.get ==> List()
//      One.n.a1.int_.apply(int1).query.get ==> List(a)
//      One.n.a1.int_.apply(int1, int2).query.get ==> List(a, b)
//      One.n.a1.int_.apply(int1, int0).query.get ==> List(a)
//      // Same as
//      One.n.a1.int_.apply(Seq(int0)).query.get ==> List()
//      One.n.a1.int_.apply(Seq(int1)).query.get ==> List(a)
//      One.n.a1.int_.apply(Seq(int1, int2)).query.get ==> List(a, b)
//      One.n.a1.int_.apply(Seq(int1, int0)).query.get ==> List(a)
//      One.n.a1.int_.apply(Seq.empty[Int]).query.get ==> List()
//
//
...
//
//      One.n.a1.int_?.apply(Some(int0)).query.get ==> List()
//      One.n.a1.int_?.apply(Some(int1)).query.get ==> List(a)
//
//      One.n.a1.int_?.apply(Some(Seq(int0))).query.get ==> List()
//      One.n.a1.int_?.apply(Some(Seq(int1))).query.get ==> List(a)
//      One.n.a1.int_?.apply(Some(Seq(int1, int2))).query.get ==> List(a, b)
//      One.n.a1.int_?.apply(Some(Seq(int1, int0))).query.get ==> List(a)
//      One.n.a1.int_?.apply(Some(Seq.empty[Int])).query.get ==> List()
//
//      One.n.a1.int_?.apply(Option.empty[Int]).query.get ==> List(x)
//      One.n.a1.int_?.apply(Option.empty[Seq[Int]]).query.get ==> List(x)
//
//
//      // For non-String cardinality-one attributes, `apply` and `==` have same semantics
//
...
//
//      // "Not this value"
//      One.n.a1.int_?.!=(Some(int0)).query.get ==> List(a, b, c)
//      One.n.a1.int_?.!=(Some(int1)).query.get ==> List(b, c)
//      One.n.a1.int_?.!=(Some(int2)).query.get ==> List(a, c)
//      One.n.a1.int_?.!=(Some(int3)).query.get ==> List(a, b)
//      // Same as
//      One.n.a1.int_?.!=(Some(Seq(int0))).query.get ==> List(a, b, c)
//      One.n.a1.int_?.!=(Some(Seq(int1))).query.get ==> List(b, c)
//      One.n.a1.int_?.!=(Some(Seq(int2))).query.get ==> List(a, c)
//      One.n.a1.int_?.!=(Some(Seq(int3))).query.get ==> List(a, b)
//
//      // "Not this OR that value
//      One.n.a1.int_?.!=(Some(Seq(int0, int1))).query.get ==> List(b, c)
//      One.n.a1.int_?.!=(Some(Seq(int1, int2))).query.get ==> List(c)
//      One.n.a1.int_?.!=(Some(Seq(int2, int3))).query.get ==> List(a)
//      One.n.a1.int_?.!=(Some(Seq.empty[Int])).query.get ==> List(a, b, c)
//
//      One.n.a1.int_?.!=(Option.empty[Int]).query.get ==> List(a, b, c)
//      One.n.a1.int_?.!=(Option.empty[Seq[Int]]).query.get ==> List(a, b, c)
//
//
