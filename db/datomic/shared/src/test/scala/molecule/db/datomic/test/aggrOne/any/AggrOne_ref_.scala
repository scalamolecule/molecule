...
object AggrOne_ref_ extends DatomicTestSuite {
  ...
  lazy val tests = Tests {
    ...
    "distinct" - types { implicit conn =>
      ...
      Ns.n.a1.ref.query.get.sortBy(_._2) ==> List(
        (1, ref1),
      ...
      Ns.n.a1.ref.apply(distinct).query.get ==> List(
        (1, Set(ref1)),
        (2, Set(ref2, ref3)),
      )
    ...
    "count, countDistinct" - types { implicit conn =>
      ...
      Ns.n.a1.ref(count).query.get ==> List(
        (1, 1),
        (2, 3)
      )
      Ns.n.a1.ref(countDistinct).query.get ==> List(
        (1, 1),
        (2, 2)
      )
    }
