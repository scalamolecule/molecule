...
object AggrOne_Short_ extends DatomicTestSuite {
  ...
  lazy val tests = Tests {
    ...
    "distinct" - types { implicit conn =>
      ...
      Ns.n.a1.short.query.get.sortBy(_._2) ==> List(
        (1, short1),
      ...
      Ns.n.a1.short.apply(distinct).query.get ==> List(
        (1, Set(short1)),
        (2, Set(short2, short3)),
      )
    ...
    "count, countDistinct" - types { implicit conn =>
      ...
      Ns.n.a1.short(count).query.get ==> List(
        (1, 1),
        (2, 3)
      )
      Ns.n.a1.short(countDistinct).query.get ==> List(
        (1, 1),
        (2, 2)
      )
    }
