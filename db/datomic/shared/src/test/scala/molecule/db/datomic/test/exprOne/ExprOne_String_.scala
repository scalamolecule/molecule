...
object ExprOne_String_ extends DatomicTestSuite {
  ...
  lazy val tests = Tests {
    ...
    "Mandatory" - cardOne { implicit conn =>
      ...
      One.n.a1.string.query.get ==> List(a, b, c)
    ...
    "Tacit" - cardOne { implicit conn =>
      ...
      One.n.a1.string_.query.get ==> List(a, b, c)

      // Match non-asserted attribute (null)
      One.n.a1.string_().query.get ==> List(x)

      // Match attribute values without returning them
      One.n.a1.string_(string0).query.get ==> List()
      One.n.a1.string_(string1).query.get ==> List(a)
    ...
    "Optional" - cardOne { implicit conn =>
      ...
      One.n.a1.string_?.query.get ==> List(a, b, c, x)

      // Find optional values matching
      One.n.a1.string_?(Some(string0)).query.get ==> List()
      One.n.a1.string_?(Some(string1)).query.get ==> List(a)
