...
object AggrOne_Date_ extends DatomicTestSuite {
  ...
  lazy val tests = Tests {
    ...
    "distinct" - types { implicit conn =>
      ...
      Ns.n.a1.date.query.get.sortBy(_._2) ==> List(
        (1, date1),
      ...
      Ns.n.a1.date.apply(distinct).query.get ==> List(
        (1, Set(date1)),
        (2, Set(date2, date3)),
      )
    ...
    "count, countDistinct" - types { implicit conn =>
      ...
      Ns.n.a1.date(count).query.get ==> List(
        (1, 1),
        (2, 3)
      )
      Ns.n.a1.date(countDistinct).query.get ==> List(
        (1, 1),
        (2, 2)
      )
    }
