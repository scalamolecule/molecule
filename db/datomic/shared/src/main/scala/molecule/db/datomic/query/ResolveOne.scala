...
object ResolveOne extends BaseHelpers {
  ...
  lazy val resOptString     = ResOneOpt("String", dString, identity, toOptString)
  lazy val resOptInt        = ResOneOpt("Int", dInt, identity, toOptInt)
  lazy val resOptLong       = ResOneOpt("Long", dLong, identity, toOptLong)
  lazy val resOptFloat      = ResOneOpt("Float", dFloat, identity, toOptFloat)
  lazy val resOptDouble     = ResOneOpt("Double", dDouble, identity, toOptDouble)
  lazy val resOptBoolean    = ResOneOpt("Boolean", dBoolean, identity, toOptBoolean)
  lazy val resOptBigInt     = ResOneOpt("BigInt", dBigInt, fromBigInt, toOptBigInt)
  lazy val resOptBigDecimal = ResOneOpt("BigDecimal", dBigDec, fromBigDec, toOptBigDecimal)
  lazy val resOptDate       = ResOneOpt("Date", dDate, identity, toOptDate)
  lazy val resOptUUID       = ResOneOpt("UUID", dUUID, identity, toOptUUID)
  lazy val resOptURI        = ResOneOpt("URI", dURI, identity, toOptURI)
  lazy val resOptByte       = ResOneOpt("Byte", dByte, fromByte, toOptByte)
  lazy val resOptShort      = ResOneOpt("Short", dShort, fromShort, toOptShort)
  lazy val resOptChar       = ResOneOpt("Char", dChar, fromChar, toOptChar)
}