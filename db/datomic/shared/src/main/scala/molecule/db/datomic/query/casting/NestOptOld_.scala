...
//    if (levels == 1)
//      pullLeaf(pullCasts1, pullSorts1)
//    else
//      pullBranch(pullCasts1, pullSorts1, pullBranch2, refDepths(1))
//  }
//
//  private lazy val pullBranch2: jIterator[_] => List[Any] = {
//    if (levels == 2)
//      pullLeaf(pullCasts2, pullSorts2)
//    else
//      pullBranch(pullCasts2, pullSorts2, pullBranch3, refDepths(2))
//  }
//
//  private lazy val pullBranch3: jIterator[_] => List[Any] = {
//    if (levels == 3)
//      pullLeaf(pullCasts3, pullSorts3)
//    else
//      pullBranch(pullCasts3, pullSorts3, pullBranch4, refDepths(3))
//  }
//
//  private lazy val pullBranch4: jIterator[_] => List[Any] = {
//    if (levels == 4)
//      pullLeaf(pullCasts4, pullSorts4)
//    else
//      pullBranch(pullCasts4, pullSorts4, pullBranch5, refDepths(4))
//  }
//
//  private lazy val pullBranch5: jIterator[_] => List[Any] = {
//    if (levels == 5)
//      pullLeaf(pullCasts5, pullSorts5)
//    else
//      pullBranch(pullCasts5, pullSorts5, pullBranch6, refDepths(5))
//  }
//
//  private lazy val pullBranch6: jIterator[_] => List[Any] = {
//    if (levels == 6)
//      pullLeaf(pullCasts6, pullSorts6)
//    else
//      pullBranch(pullCasts6, pullSorts6, pullBranch7, refDepths(6))
//  }
//
//  private lazy val pullBranch7: jIterator[_] => List[Any] = {
//    pullLeaf(pullCasts7, pullSorts7)
//  }
//
...
//    (row: Row) =>
//      pullBranch1(row.get(0).asInstanceOf[jMap[_, _]].values.iterator).asInstanceOf[Tpl]
//  }
//
