...
object AggrOne_BigInt_ extends DatomicTestSuite {
  ...
  lazy val tests = Tests {
    ...
    "distinct" - types { implicit conn =>
      ...
      Ns.i.a1.bigInt.query.get.sortBy(_._2) ==> List(
        (1, bigInt1),
      ...
      Ns.i.a1.bigInt.apply(distinct).query.get ==> List(
        (1, Set(bigInt1)),
    ...
    "count, countDistinct" - types { implicit conn =>
      ...
      Ns.i.a1.bigInt(count).query.get ==> List(
        (1, 1),
        (2, 3)
      )
      Ns.i.a1.bigInt(countDistinct).query.get ==> List(
        (1, 1),
        (2, 2)
      )
    }
