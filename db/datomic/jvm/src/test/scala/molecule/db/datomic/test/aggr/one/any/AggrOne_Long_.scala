...
object AggrOne_Long_ extends DatomicTestSuite {
  ...
  lazy val tests = Tests {
    ...
    "distinct" - types { implicit conn =>
      ...
      Ns.i.a1.long.query.get.sortBy(_._2) ==> List(
        (1, long1),
      ...
      Ns.i.a1.long.apply(distinct).query.get ==> List(
        (1, Set(long1)),
        (2, Set(long2, long3)),
      )
    ...
    "count, countDistinct" - types { implicit conn =>
      ...
      Ns.i.a1.long(count).query.get ==> List(
        (1, 1),
        (2, 3)
      )
      Ns.i.a1.long(countDistinct).query.get ==> List(
        (1, 1),
        (2, 2)
      )
    }
