...
object InsertTxMetaData extends DatomicTestSuite {
  ...
  lazy val tests = Tests {
    ...
    "Composites everywhere" - refs { implicit conn =>
      (R1.i.s + Ns.i.s.Rs1.*(R1.i.s + R2.i.Rs3.*(R3.i.s + R4.i))).Tx(R5.s_("tx").i_(7) + R6.i_(8)).insert(
        ((1, "a"), (2, "b", List(((3, "c"), (4, List(((5, "d"), 6)))))))
      ).transact

      (R1.i.s + Ns.i.s.Rs1.*(R1.i.s + R2.i.Rs3.*(R3.i.s + R4.i))).Tx(R5.s.i + R6.i).query.get ==> List(
