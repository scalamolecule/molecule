...
object AggrSet_UUID_ extends DatomicTestSuite {
  ...
  lazy val tests = Tests {
    ...
    "min" - types { implicit conn =>
      ...
      Ns.i.uuids(min).query.get ==> List(
        (1, Set(uuid1)),
        (2, Set(uuid2)),
      )
      // Same as
      Ns.i.uuids(min(1)).query.get ==> List(
        (1, Set(uuid1)),
        (2, Set(uuid2)),
      )

      Ns.i.uuids(min(2)).query.get ==> List(
        (1, Set(uuid1, uuid2)),
        (2, Set(uuid2, uuid3)),
      )
    }
    ...
    "max" - types { implicit futConn =>
      ...
      Ns.i.uuids(max).query.get ==> List(
        (1, Set(uuid2)),
        (2, Set(uuid4)),
      )
      // Same as
      Ns.i.uuids(max(1)).query.get ==> List(
        (1, Set(uuid2)),
        (2, Set(uuid4)),
      )

      Ns.i.uuids(max(2)).query.get ==> List(
        (1, Set(uuid1, uuid2)),
        (2, Set(uuid3, uuid4)),
      )
    }
    ...
    "count, countDistinct" - types { implicit conn =>
      ...
      Ns.i.a1.uuids(count).query.get ==> List(
        (1, 2),
        (2, 6)
      )
      Ns.i.a1.uuids(countDistinct).query.get ==> List(
        (1, 2),
        (2, 3)
      )
    }
