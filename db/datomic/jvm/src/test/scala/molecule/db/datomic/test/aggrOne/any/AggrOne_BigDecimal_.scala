...
object AggrOne_BigDecimal_ extends DatomicTestSuite {
  ...
  lazy val tests = Tests {
    ...
    "distinct" - types { implicit conn =>
      ...
      Ns.i.a1.bigDecimal.query.get.sortBy(_._2) ==> List(
        (1, bigDecimal1),
      ...
      Ns.i.a1.bigDecimal.apply(distinct).query.get ==> List(
        (1, Set(bigDecimal1)),
    ...
    "count, countDistinct" - types { implicit conn =>
      ...
      Ns.i.a1.bigDecimal(count).query.get ==> List(
        (1, 1),
        (2, 3)
      )
      Ns.i.a1.bigDecimal(countDistinct).query.get ==> List(
        (1, 1),
        (2, 2)
      )
    }
