...
object AggrSet_Long_ extends DatomicTestSuite {
  ...
  lazy val tests = Tests {
    ...
    "min" - types { implicit conn =>
      ...
      Ns.i.longs(min).query.get ==> List(
        (1, Set(long1)),
        (2, Set(long2)),
      )
      // Same as
      Ns.i.longs(min(1)).query.get ==> List(
        (1, Set(long1)),
        (2, Set(long2)),
      )

      Ns.i.longs(min(2)).query.get ==> List(
        (1, Set(long1, long2)),
        (2, Set(long2, long3)),
      )
    }
    ...
    "max" - types { implicit futConn =>
      ...
      Ns.i.longs(max).query.get ==> List(
        (1, Set(long2)),
        (2, Set(long4)),
      )
      // Same as
      Ns.i.longs(max(1)).query.get ==> List(
        (1, Set(long2)),
        (2, Set(long4)),
      )

      Ns.i.longs(max(2)).query.get ==> List(
        (1, Set(long1, long2)),
        (2, Set(long3, long4)),
      )
    }
    ...
    "count, countDistinct" - types { implicit conn =>
      ...
      Ns.i.a1.longs(count).query.get ==> List(
        (1, 2),
        (2, 6)
      )
      Ns.i.a1.longs(countDistinct).query.get ==> List(
        (1, 2),
        (2, 3)
      )
    }
