...
import AggrOne_Int.{int1, int2, int3}
import utest._
...
object AggrOne_Boolean extends DatomicTestSuite {
  ...
  lazy val tests = Tests {
    ...
    "distinct" - types { implicit conn =>
      ...
      Ns.i.a1.boolean.query.get.sortBy(t => (t._1, t._2)) ==> List(
        (1, true),
      ...
      Ns.i.a1.boolean(distinct).query.get ==> List(
        (1, Set(true)),
        (2, Set(false, true)),
      )
    ...
    "count, countDistinct" - types { implicit conn =>
      ...
      Ns.i.a1.boolean(count).query.get ==> List(
        (1, 1),
        (2, 3)
      )
      Ns.i.a1.boolean(countDistinct).query.get ==> List(
        (1, 1),
        (2, 2)
      )
    }
