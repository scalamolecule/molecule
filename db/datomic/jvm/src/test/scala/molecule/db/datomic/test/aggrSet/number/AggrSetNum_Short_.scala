...
object AggrSetNum_Short_ extends DatomicTestSuite {
  ...
  lazy val tests = Tests {
    ...
    "sum" - types { implicit conn =>
      ...
      Ns.i.shorts(sum).query.get ==> List(
    ...
    "median" - types { implicit futConn =>
      ...
      Ns.i.shorts(median).query.get ==> List(
        (1, Set(1.0)),
        (2, Set(3.0)),
      )
    }
    ...
    "avg" - types { implicit conn =>
      ...
      Ns.i.shorts(avg).query.get ==> List(
    ...
    "variance" - types { implicit conn =>
      ...
      Ns.i.shorts(variance).query.get ==> List(
        (1, Set(0.25)),
    ...
    "stddev" - types { implicit conn =>
      ...
      Ns.i.shorts(stddev).query.get ==> List(
        (1, Set(0.5)),
