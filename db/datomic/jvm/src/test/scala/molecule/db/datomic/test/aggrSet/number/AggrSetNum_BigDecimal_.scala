...
object AggrSetNum_BigDecimal_ extends DatomicTestSuite {
  ...
  lazy val tests = Tests {
    ...
    "sum" - types { implicit conn =>
      ...
      Ns.i.bigDecimals(sum).query.get ==> List(
    ...
    "median" - types { implicit futConn =>
      ...
      Ns.i.bigDecimals(median).query.get ==> List(
        (1, Set(1.0)),
        (2, Set(3.3)),
      )
    ...
    "avg" - types { implicit conn =>
      ...
      Ns.i.bigDecimals(avg).query.get ==> List(
    ...
    "variance" - types { implicit conn =>
      ...
      Ns.i.bigDecimals(variance).query.get ==> List(
    ...
    "stddev" - types { implicit conn =>
      ...
      Ns.i.bigDecimals(stddev).query.get ==> List(
        (1, Set(0.55)),
