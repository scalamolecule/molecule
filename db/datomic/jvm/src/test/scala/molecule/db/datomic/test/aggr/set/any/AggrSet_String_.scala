...
object AggrSet_String_ extends DatomicTestSuite {
  ...
  lazy val tests = Tests {
    ...
    "min" - types { implicit conn =>
      ...
      Ns.i.strings(min).query.get ==> List(
        (1, Set(string1)),
        (2, Set(string2)),
      )
      // Same as
      Ns.i.strings(min(1)).query.get ==> List(
        (1, Set(string1)),
        (2, Set(string2)),
      )

      Ns.i.strings(min(2)).query.get ==> List(
        (1, Set(string1, string2)),
        (2, Set(string2, string3)),
      )
    }
    ...
    "max" - types { implicit futConn =>
      ...
      Ns.i.strings(max).query.get ==> List(
        (1, Set(string2)),
        (2, Set(string4)),
      )
      // Same as
      Ns.i.strings(max(1)).query.get ==> List(
        (1, Set(string2)),
        (2, Set(string4)),
      )

      Ns.i.strings(max(2)).query.get ==> List(
        (1, Set(string1, string2)),
        (2, Set(string3, string4)),
      )
    }
    ...
    "count, countDistinct" - types { implicit conn =>
      ...
      Ns.i.a1.strings(count).query.get ==> List(
        (1, 2),
        (2, 6)
      )
      Ns.i.a1.strings(countDistinct).query.get ==> List(
        (1, 2),
        (2, 3)
      )
    }
