...
object AggrSet_Short_ extends DatomicTestSuite {
  ...
  lazy val tests = Tests {
    ...
    "min" - types { implicit conn =>
      ...
      Ns.i.shorts(min).query.get ==> List(
        (1, Set(short1)),
        (2, Set(short2)),
      )
      // Same as
      Ns.i.shorts(min(1)).query.get ==> List(
        (1, Set(short1)),
        (2, Set(short2)),
      )

      Ns.i.shorts(min(2)).query.get ==> List(
        (1, Set(short1, short2)),
        (2, Set(short2, short3)),
      )
    }
    ...
    "max" - types { implicit futConn =>
      ...
      Ns.i.shorts(max).query.get ==> List(
        (1, Set(short2)),
        (2, Set(short4)),
      )
      // Same as
      Ns.i.shorts(max(1)).query.get ==> List(
        (1, Set(short2)),
        (2, Set(short4)),
      )

      Ns.i.shorts(max(2)).query.get ==> List(
        (1, Set(short1, short2)),
        (2, Set(short3, short4)),
      )
    }
    ...
    "count, countDistinct" - types { implicit conn =>
      ...
      Ns.i.a1.shorts(count).query.get ==> List(
        (1, 2),
        (2, 6)
      )
      Ns.i.a1.shorts(countDistinct).query.get ==> List(
        (1, 2),
        (2, 3)
      )
    }
