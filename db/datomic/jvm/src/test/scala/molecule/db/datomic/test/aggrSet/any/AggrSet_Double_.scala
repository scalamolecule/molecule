...
object AggrSet_Double_ extends DatomicTestSuite {
  ...
  lazy val tests = Tests {
    ...
    "min" - types { implicit conn =>
      ...
      Ns.i.doubles(min).query.get ==> List(
        (1, Set(double1)),
        (2, Set(double2)),
      )
      // Same as
      Ns.i.doubles(min(1)).query.get ==> List(
        (1, Set(double1)),
        (2, Set(double2)),
      )

      Ns.i.doubles(min(2)).query.get ==> List(
        (1, Set(double1, double2)),
        (2, Set(double2, double3)),
      )
    }
    ...
    "max" - types { implicit futConn =>
      ...
      Ns.i.doubles(max).query.get ==> List(
        (1, Set(double2)),
        (2, Set(double4)),
      )
      // Same as
      Ns.i.doubles(max(1)).query.get ==> List(
        (1, Set(double2)),
        (2, Set(double4)),
      )

      Ns.i.doubles(max(2)).query.get ==> List(
        (1, Set(double1, double2)),
        (2, Set(double3, double4)),
      )
    }
    ...
    "count, countDistinct" - types { implicit conn =>
      ...
      Ns.i.a1.doubles(count).query.get ==> List(
        (1, 2),
        (2, 6)
      )
      Ns.i.a1.doubles(countDistinct).query.get ==> List(
        (1, 2),
        (2, 3)
      )
    }
