...
object NestedTypes extends DatomicTestSuite {
  ...
  lazy val tests = Tests {
    ...
    "Card one, mandatory" - types { implicit conn =>
      ...
      Ref.i.Nss.*(Ns.char).insert(12, List(char1, char2)).transact
      Ref.i.Nss.*(Ns.byte).insert(13, List(byte1, byte2)).transact
      Ref.i.Nss.*(Ns.short).insert(14, List(short1, short2)).transact

      Ref.i_.Nss.*(Ns.string.a1).query.get ==> List(List(string1, string2))
      Ref.i_.Nss.*(Ns.int.a1).query.get ==> List(List(int1, int2))
      Ref.i_.Nss.*(Ns.long.a1).query.get ==> List(List(long1, long2))
      Ref.i_.Nss.*(Ns.float.a1).query.get ==> List(List(float1, float2))
      Ref.i_.Nss.*(Ns.double.a1).query.get ==> List(List(double1, double2))
      Ref.i_.Nss.*(Ns.boolean.a1).query.get ==> List(List(boolean1, boolean2))
      Ref.i_.Nss.*(Ns.bigInt.a1).query.get ==> List(List(bigInt1, bigInt2))
      Ref.i_.Nss.*(Ns.bigDecimal.a1).query.get ==> List(List(bigDecimal1, bigDecimal2))
      Ref.i_.Nss.*(Ns.date.a1).query.get ==> List(List(date1, date2))
      Ref.i_.Nss.*(Ns.uuid.a1).query.get ==> List(List(uuid1, uuid2))
      Ref.i_.Nss.*(Ns.uri.a1).query.get ==> List(List(uri1, uri2))
      Ref.i_.Nss.*(Ns.char.a1).query.get ==> List(List(char1, char2))
      Ref.i_.Nss.*(Ns.byte.a1).query.get ==> List(List(byte1, byte2))
      Ref.i_.Nss.*(Ns.short.a1).query.get ==> List(List(short1, short2))
      ...
      Ref.i_(12).Nss.*?(Ns.char.a1).query.get ==> List(List(char1, char2))
      Ref.i_(13).Nss.*?(Ns.byte.a1).query.get ==> List(List(byte1, byte2))
      Ref.i_(14).Nss.*?(Ns.short.a1).query.get ==> List(List(short1, short2))
    ...
    "Card set, mandatory" - types { implicit conn =>
      ...
      if (useFree)
        ...
        Ref.i_(6).Nss.*?(Ns.booleans).query.get ==> List(List(Set(boolean1, boolean2)))
    }
    ...
    "Card set, optional" - types { implicit conn =>
      ...
      if (useFree) {
        ...
        Ref.i(6).Nss.*(Ns.i.a1.booleans_?).query.get ==> List((6, List((1, Some(Set(boolean1, boolean2))), (2, None))))
        Ref.i(6).Nss.*?(Ns.i.a1.booleans_?).query.get ==> List((6, List((1, Some(Set(boolean1, boolean2))), (2, None))))
      }
    }
  }
