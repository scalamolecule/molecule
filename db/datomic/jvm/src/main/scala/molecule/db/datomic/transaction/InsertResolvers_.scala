...
abstract class InsertResolvers_(elements: Seq[Element]) extends DatomicTransactionBase(elements) {
  ...
  final private def resolve1(resolvers: List[Product => Unit]): Product => Unit = {
  ...
  final private def resolve2(resolvers: List[Product => Unit]): Product => Unit = {
  ...
  final private def resolve3(resolvers: List[Product => Unit]): Product => Unit = {
  ...
  final private def resolve4(resolvers: List[Product => Unit]): Product => Unit = {
  ...
  final private def resolve5(resolvers: List[Product => Unit]): Product => Unit = {
  ...
  final private def resolve6(resolvers: List[Product => Unit]): Product => Unit = {
  ...
  final private def resolve7(resolvers: List[Product => Unit]): Product => Unit = {
  ...
  final private def resolve8(resolvers: List[Product => Unit]): Product => Unit = {
  ...
  final private def resolve9(resolvers: List[Product => Unit]): Product => Unit = {
  ...
  final private def resolve10(resolvers: List[Product => Unit]): Product => Unit = {
  ...
  final private def resolve11(resolvers: List[Product => Unit]): Product => Unit = {
  ...
  final private def resolve12(resolvers: List[Product => Unit]): Product => Unit = {
  ...
  final private def resolve13(resolvers: List[Product => Unit]): Product => Unit = {
  ...
  final private def resolve14(resolvers: List[Product => Unit]): Product => Unit = {
  ...
  final private def resolve15(resolvers: List[Product => Unit]): Product => Unit = {
  ...
  final private def resolve16(resolvers: List[Product => Unit]): Product => Unit = {
  ...
  final private def resolve17(resolvers: List[Product => Unit]): Product => Unit = {
  ...
  final private def resolve18(resolvers: List[Product => Unit]): Product => Unit = {
  ...
  final private def resolve19(resolvers: List[Product => Unit]): Product => Unit = {
  ...
  final private def resolve20(resolvers: List[Product => Unit]): Product => Unit = {
  ...
  final private def resolve21(resolvers: List[Product => Unit]): Product => Unit = {
  ...
  final private def resolve22(resolvers: List[Product => Unit]): Product => Unit = {
