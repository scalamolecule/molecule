...
trait Spi_postgresql_async extends Spi_async with StreamingJdbc with ModelUtils {
  ...
  override def fallback_rawQuery(
    ...
    Spi_postgresql_sync.fallback_rawQuery(query, debug)
  }
  ...
  override def fallback_rawTransact(
    ...
    Spi_postgresql_sync.fallback_rawTransact(txData, debug)
  }
}
