package molecule.db.postgresql.compliance.fallback
...
class RawTransact extends MUnit with DbProviders_postgresql with TestUtils {
  ...
  "Insert Set" - types {
    for {
      ...
      _ <- rawTransact(s"insert into Entity (uuidSet          ) values (array['$uuid1', '$uuid2']::uuid[])")
