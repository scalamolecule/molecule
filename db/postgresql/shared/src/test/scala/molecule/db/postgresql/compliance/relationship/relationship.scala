...
class BidirectionalTest extends MUnit {
  Bidirectional(this, Api_postgresql_async)
}
class ManyToManyTest extends MUnit {
  ManyToMany(this, Api_postgresql_async)
}

class FlatEntityTest extends MUnit {
  FlatEntity(this, Api_postgresql_async)
}
class FlatRefTest extends MUnit {
  FlatRef(this, Api_postgresql_async)
}
class FlatOptEntityTest extends MUnit {
  FlatOptEntity(this, Api_postgresql_async)
}
class FlatOptRefTest extends MUnit {
  FlatOptRef(this, Api_postgresql_async)
}
class FlatOptRefNestedTest extends MUnit {
  FlatOptRefNested(this, Api_postgresql_async)
}
class FlatOptRefAdjacentTest extends MUnit {
  FlatOptRefAdjacent(this, Api_postgresql_async)
}
