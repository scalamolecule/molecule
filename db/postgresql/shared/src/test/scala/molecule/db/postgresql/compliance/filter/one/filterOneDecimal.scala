...
class FilterOneDecimal_Float_Test extends MUnit {
  FilterOneDecimal_Float_(this, Api_postgresql_async)
}
class FilterOneDecimal_DoubleTest extends MUnit {
  FilterOneDecimal_Double(this, Api_postgresql_async)
}
class FilterOneDecimal_BigDecimal_Test extends MUnit {
  FilterOneDecimal_BigDecimal_(this, Api_postgresql_async)
}
