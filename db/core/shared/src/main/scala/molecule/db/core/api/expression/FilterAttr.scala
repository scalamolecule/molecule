...
trait FilterAttr[Tpl <: Tuple, T, This[_ <: Tuple, _], Next[_ <: Tuple, _]] {
  protected def _filterAttrTacTac(op: Op, a: Molecule_0 & CardOne)(using NotTuple[T]): This[Tpl, T]
  protected def _filterAttrManTac(op: Op, a: Molecule_0 & CardOne)(using NotTuple[T]): This[Tpl, T] & SortAttrs[Tpl, T, This] = ???
