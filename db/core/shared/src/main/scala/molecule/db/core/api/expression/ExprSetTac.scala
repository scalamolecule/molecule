...
trait ExprSetTacOps[Tpl <: Tuple, T, This[_ <: Tuple, _], Next[_ <: Tuple, _]]
  extends FilterAttr[Tpl, T, This, Next] {
  protected def _exprSet(op: Op, set: Set[T]): This[Tpl, T] = ???
}

trait ExprSetTac[Tpl <: Tuple, T, This[_ <: Tuple, _], Next[_ <: Tuple, _]]
...
trait ExprSetTac_Enum[Tpl <: Tuple, T, This[_ <: Tuple, _], Next[_ <: Tuple, _]]
  extends ExprSetTacOps[Tpl, T, This, Next] {
