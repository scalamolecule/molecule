...
trait ValueTransformers extends JsonBase with BaseHelpers {
  ...
  protected lazy val setterID             = (ps: PS, n: Int, v: Long) => ps.setLong(n, v)
  protected lazy val setterString         = (ps: PS, n: Int, v: String) => ps.setString(n, v)
  protected lazy val setterInt            = (ps: PS, n: Int, v: Int) => ps.setInt(n, v)
  protected lazy val setterLong           = (ps: PS, n: Int, v: Long) => ps.setLong(n, v)
  protected lazy val setterFloat          = (ps: PS, n: Int, v: Float) => ps.setFloat(n, v)
  protected lazy val setterDouble         = (ps: PS, n: Int, v: Double) => ps.setDouble(n, v)
  protected lazy val setterBoolean        = (ps: PS, n: Int, v: Boolean) => ps.setBoolean(n, v)
  protected lazy val setterBigInt         = (ps: PS, n: Int, v: BigInt) => ps.setBigDecimal(n, BigDecimal(v).bigDecimal)
  protected lazy val setterBigDecimal     = (ps: PS, n: Int, v: BigDecimal) => ps.setBigDecimal(n, v.bigDecimal)
  protected lazy val setterDate           = (ps: PS, n: Int, v: Date) => ps.setLong(n, v.getTime)
  protected lazy val setterDuration       = (ps: PS, n: Int, v: Duration) => ps.setString(n, v.toString)
  protected lazy val setterInstant        = (ps: PS, n: Int, v: Instant) => ps.setString(n, v.toString)
  protected lazy val setterLocalDate      = (ps: PS, n: Int, v: LocalDate) => ps.setString(n, v.toString)
  protected lazy val setterLocalTime      = (ps: PS, n: Int, v: LocalTime) => ps.setString(n, v.toString)
  protected lazy val setterLocalDateTime  = (ps: PS, n: Int, v: LocalDateTime) => ps.setString(n, v.toString)
  protected lazy val setterOffsetTime     = (ps: PS, n: Int, v: OffsetTime) => ps.setString(n, v.toString)
  protected lazy val setterOffsetDateTime = (ps: PS, n: Int, v: OffsetDateTime) => ps.setString(n, v.toString)
  protected lazy val setterZonedDateTime  = (ps: PS, n: Int, v: ZonedDateTime) => ps.setString(n, v.toString)
  protected lazy val setterUUID           = (ps: PS, n: Int, v: UUID) => ps.setString(n, v.toString)
  protected lazy val setterURI            = (ps: PS, n: Int, v: URI) => ps.setString(n, v.toString)
  protected lazy val setterByte           = (ps: PS, n: Int, v: Byte) => ps.setByte(n, v)
  protected lazy val setterShort          = (ps: PS, n: Int, v: Short) => ps.setShort(n, v)
  protected lazy val setterChar           = (ps: PS, n: Int, v: Char) => ps.setString(n, v.toString)
  ...
  protected lazy val extsFloat          = List("Float", "AnyRef", "")
  protected lazy val extsDouble         = List("Double", "AnyRef", "")
  protected lazy val extsBoolean        = List("Boolean", "AnyRef", "")
  protected lazy val extsBigInt         = List("BigInt", "AnyRef", "")
  protected lazy val extsBigDecimal     = List("BigDecimal", "AnyRef", "")
  protected lazy val extsDate           = List("Date", "AnyRef", "")
  protected lazy val extsDuration       = List("Duration", "AnyRef", "")
  protected lazy val extsInstant        = List("Instant", "AnyRef", "")
  protected lazy val extsLocalDate      = List("LocalDate", "AnyRef", "")
  protected lazy val extsLocalTime      = List("LocalTime", "AnyRef", "")
  protected lazy val extsLocalDateTime  = List("LocalDateTime", "AnyRef", "")
  protected lazy val extsOffsetTime     = List("OffsetTime", "AnyRef", "")
  protected lazy val extsOffsetDateTime = List("OffsetDateTime", "AnyRef", "")
  protected lazy val extsZonedDateTime  = List("ZonedDateTime", "AnyRef", "")
  protected lazy val extsUUID           = List("UUID", "AnyRef", "")
  protected lazy val extsURI            = List("URI", "AnyRef", "")
  protected lazy val extsByte           = List("Byte", "AnyRef", "")
