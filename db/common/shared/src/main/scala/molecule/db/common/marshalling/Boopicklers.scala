...
object Boopicklers extends MoleculeLogging {
  ...
  pickleOp.addConcreteType[AttrOp.ReplaceAll.type]
  pickleOp.addConcreteType[AttrOp.ToLower.type]
  pickleOp.addConcreteType[AttrOp.ToUpper.type]
  pickleOp.addConcreteType[AttrOp.Plus.type]
  pickleOp.addConcreteType[AttrOp.Minus.type]
  pickleOp.addConcreteType[AttrOp.Times.type]
  pickleOp.addConcreteType[AttrOp.Divide.type]
  pickleOp.addConcreteType[AttrOp.Negate.type]
  pickleOp.addConcreteType[AttrOp.Abs.type]
  pickleOp.addConcreteType[AttrOp.AbsNeg.type]
  pickleOp.addConcreteType[AttrOp.Ceil.type]
  pickleOp.addConcreteType[AttrOp.Floor.type]
  pickleOp.addConcreteType[AttrOp.And.type]
  pickleOp.addConcreteType[AttrOp.Or.type]
  pickleOp.addConcreteType[AttrOp.Not.type]
  ...
  pickleElement.addConcreteType[OptEntity]
