      ...
      case a: Attr =>
        val (tacitFilterAttr, adjacent) = if (a.ent == filterAttr0.ent) {
          ...
          val tacitAttr = filterAttr0 match {
            case a: AttrOneMan => a match {
              case a: AttrOneManID             => AttrOneTacID(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.binding, a.coord)
              case a: AttrOneManString         => AttrOneTacString(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.binding, a.coord)
              case a: AttrOneManInt            => AttrOneTacInt(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.binding, a.coord)
              case a: AttrOneManLong           => AttrOneTacLong(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.binding, a.coord)
              case a: AttrOneManFloat          => AttrOneTacFloat(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.binding, a.coord)
              case a: AttrOneManDouble         => AttrOneTacDouble(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.binding, a.coord)
              case a: AttrOneManBoolean        => AttrOneTacBoolean(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.binding, a.coord)
              case a: AttrOneManBigInt         => AttrOneTacBigInt(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.binding, a.coord)
              case a: AttrOneManBigDecimal     => AttrOneTacBigDecimal(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.binding, a.coord)
              case a: AttrOneManDate           => AttrOneTacDate(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.binding, a.coord)
              case a: AttrOneManDuration       => AttrOneTacDuration(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.binding, a.coord)
              case a: AttrOneManInstant        => AttrOneTacInstant(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.binding, a.coord)
              case a: AttrOneManLocalDate      => AttrOneTacLocalDate(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.binding, a.coord)
              case a: AttrOneManLocalTime      => AttrOneTacLocalTime(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.binding, a.coord)
              case a: AttrOneManLocalDateTime  => AttrOneTacLocalDateTime(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.binding, a.coord)
              case a: AttrOneManOffsetTime     => AttrOneTacOffsetTime(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.binding, a.coord)
              case a: AttrOneManOffsetDateTime => AttrOneTacOffsetDateTime(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.binding, a.coord)
              case a: AttrOneManZonedDateTime  => AttrOneTacZonedDateTime(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.binding, a.coord)
              case a: AttrOneManUUID           => AttrOneTacUUID(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.binding, a.coord)
              case a: AttrOneManURI            => AttrOneTacURI(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.binding, a.coord)
              case a: AttrOneManByte           => AttrOneTacByte(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.binding, a.coord)
              case a: AttrOneManShort          => AttrOneTacShort(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.binding, a.coord)
              case a: AttrOneManChar           => AttrOneTacChar(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.binding, a.coord)
            }
            case a: AttrSetMan => a match {
              case a: AttrSetManID             => AttrSetTacID(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSetManString         => AttrSetTacString(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSetManInt            => AttrSetTacInt(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSetManLong           => AttrSetTacLong(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSetManFloat          => AttrSetTacFloat(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSetManDouble         => AttrSetTacDouble(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSetManBoolean        => AttrSetTacBoolean(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSetManBigInt         => AttrSetTacBigInt(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSetManBigDecimal     => AttrSetTacBigDecimal(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSetManDate           => AttrSetTacDate(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSetManDuration       => AttrSetTacDuration(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSetManInstant        => AttrSetTacInstant(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSetManLocalDate      => AttrSetTacLocalDate(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSetManLocalTime      => AttrSetTacLocalTime(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSetManLocalDateTime  => AttrSetTacLocalDateTime(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSetManOffsetTime     => AttrSetTacOffsetTime(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSetManOffsetDateTime => AttrSetTacOffsetDateTime(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSetManZonedDateTime  => AttrSetTacZonedDateTime(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSetManUUID           => AttrSetTacUUID(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSetManURI            => AttrSetTacURI(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSetManByte           => AttrSetTacByte(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSetManShort          => AttrSetTacShort(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSetManChar           => AttrSetTacChar(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
            }
            case a: AttrSeqMan => a match {
              case a: AttrSeqManID             => AttrSeqTacID(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSeqManString         => AttrSeqTacString(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSeqManInt            => AttrSeqTacInt(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSeqManLong           => AttrSeqTacLong(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSeqManFloat          => AttrSeqTacFloat(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSeqManDouble         => AttrSeqTacDouble(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSeqManBoolean        => AttrSeqTacBoolean(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSeqManBigInt         => AttrSeqTacBigInt(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSeqManBigDecimal     => AttrSeqTacBigDecimal(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSeqManDate           => AttrSeqTacDate(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSeqManDuration       => AttrSeqTacDuration(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSeqManInstant        => AttrSeqTacInstant(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSeqManLocalDate      => AttrSeqTacLocalDate(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSeqManLocalTime      => AttrSeqTacLocalTime(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSeqManLocalDateTime  => AttrSeqTacLocalDateTime(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSeqManOffsetTime     => AttrSeqTacOffsetTime(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSeqManOffsetDateTime => AttrSeqTacOffsetDateTime(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSeqManZonedDateTime  => AttrSeqTacZonedDateTime(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSeqManUUID           => AttrSeqTacUUID(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSeqManURI            => AttrSeqTacURI(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSeqManByte           => AttrSeqTacByte(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSeqManShort          => AttrSeqTacShort(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrSeqManChar           => AttrSeqTacChar(a.ent, a.attr, a.op, a.vs, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
            }
            case a: AttrMapMan => a match {
              case a: AttrMapManID             => AttrMapTacID(a.ent, a.attr, a.op, a.map, a.keys, Nil, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrMapManString         => AttrMapTacString(a.ent, a.attr, a.op, a.map, a.keys, Nil, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrMapManInt            => AttrMapTacInt(a.ent, a.attr, a.op, a.map, a.keys, Nil, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrMapManLong           => AttrMapTacLong(a.ent, a.attr, a.op, a.map, a.keys, Nil, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrMapManFloat          => AttrMapTacFloat(a.ent, a.attr, a.op, a.map, a.keys, Nil, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrMapManDouble         => AttrMapTacDouble(a.ent, a.attr, a.op, a.map, a.keys, Nil, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrMapManBoolean        => AttrMapTacBoolean(a.ent, a.attr, a.op, a.map, a.keys, Nil, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrMapManBigInt         => AttrMapTacBigInt(a.ent, a.attr, a.op, a.map, a.keys, Nil, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrMapManBigDecimal     => AttrMapTacBigDecimal(a.ent, a.attr, a.op, a.map, a.keys, Nil, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrMapManDate           => AttrMapTacDate(a.ent, a.attr, a.op, a.map, a.keys, Nil, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrMapManDuration       => AttrMapTacDuration(a.ent, a.attr, a.op, a.map, a.keys, Nil, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrMapManInstant        => AttrMapTacInstant(a.ent, a.attr, a.op, a.map, a.keys, Nil, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrMapManLocalDate      => AttrMapTacLocalDate(a.ent, a.attr, a.op, a.map, a.keys, Nil, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrMapManLocalTime      => AttrMapTacLocalTime(a.ent, a.attr, a.op, a.map, a.keys, Nil, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrMapManLocalDateTime  => AttrMapTacLocalDateTime(a.ent, a.attr, a.op, a.map, a.keys, Nil, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrMapManOffsetTime     => AttrMapTacOffsetTime(a.ent, a.attr, a.op, a.map, a.keys, Nil, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrMapManOffsetDateTime => AttrMapTacOffsetDateTime(a.ent, a.attr, a.op, a.map, a.keys, Nil, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrMapManZonedDateTime  => AttrMapTacZonedDateTime(a.ent, a.attr, a.op, a.map, a.keys, Nil, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrMapManUUID           => AttrMapTacUUID(a.ent, a.attr, a.op, a.map, a.keys, Nil, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrMapManURI            => AttrMapTacURI(a.ent, a.attr, a.op, a.map, a.keys, Nil, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrMapManByte           => AttrMapTacByte(a.ent, a.attr, a.op, a.map, a.keys, Nil, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrMapManShort          => AttrMapTacShort(a.ent, a.attr, a.op, a.map, a.keys, Nil, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
              case a: AttrMapManChar           => AttrMapTacChar(a.ent, a.attr, a.op, a.map, a.keys, Nil, None, None, a.validator, a.valueAttrs, a.errors, a.ref, a.sort, a.coord)
            }
            case other         => other
          }
