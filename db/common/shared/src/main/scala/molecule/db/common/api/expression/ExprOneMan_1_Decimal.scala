...
trait ExprOneMan_1_Decimal[T, Entity[_]](entity: [t] => DataModel => Entity[t]) extends OneValue { self: Molecule  =>
...
trait ExprOneMan_1_Decimal_Aggr[T, Entity[_]](entity: [t] => DataModel => Entity[t]) extends OneValue { self: Molecule  =>
...
trait ExprOneMan_1_Decimal_AggrOps[T, Entity <: Molecule](entity: DataModel => Entity) extends OneValue { self: Molecule  =>
