...
trait DbProviders_h2_zio extends DbProviders_zio with DbConnection_h2 with Platform {
  ...
  override def types: ZLayer[Any, Throwable, Conn] = connZLayer(Types_h2())
  override def refs: ZLayer[Any, Throwable, Conn] = connZLayer(Refs_h2())
  override def unique: ZLayer[Any, Throwable, Conn] = connZLayer(Uniques_h2())
  override def validation: ZLayer[Any, Throwable, Conn] = connZLayer(Validation_h2())
}