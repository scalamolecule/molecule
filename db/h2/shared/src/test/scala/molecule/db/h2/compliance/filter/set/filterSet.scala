package molecule.db.h2.compliance.filter.set
...
class SetSemanticsTest extends MUnit {
  SetSemantics(this, Api_h2_async)
}

class FilterRefSet_Card1RefTest extends MUnit {
  FilterRefSet_Card1Ref(this, Api_h2_async)
}
class FilterRefSet_Card2RefTest extends MUnit {
  FilterRefSet_Card2Ref(this, Api_h2_async)
}
