...
import molecule.db.compliance.domains.dsl.SocialApp0_overview.metadb.SocialApp0_overview_h2
...
trait DbProviders_h2 extends DbProviders with DbConnection_h2 with Platform {
  ...
  override def social0(test: Conn ?=> Any): Any = run(test, SocialApp0_overview_h2())
