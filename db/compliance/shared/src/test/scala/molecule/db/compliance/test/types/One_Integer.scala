...
case class One_Integer(
  ...
  "integer 1-n" - types {
    ...
    lazy val c5: (String, Int)       = Entity.s.long.apply(count).a1.query.get.head
    lazy val c6: (String, Long)      = Entity.s.long.apply(min).a1.query.get.head
    lazy val c7: (String, Set[Long]) = Entity.s.long.apply(min(3)).a1.query.get.head
    lazy val c8: (String, Double)    = Entity.s.long.apply(avg).a1.query.get.head


    // Optional
    lazy val d1: (String, Option[Long]) = Entity.s.long_?.query.get.head
    lazy val d2: (String, Option[Long]) = Entity.s.long_?.apply(Some(long1)).query.get.head

    lazy val d3: (String, Option[Long]) = Entity.s.long_?.a1.query.get.head
    lazy val d4: (String, Option[Long]) = Entity.s.long_?.apply(Some(long1)).a1.query.get.head
  }
