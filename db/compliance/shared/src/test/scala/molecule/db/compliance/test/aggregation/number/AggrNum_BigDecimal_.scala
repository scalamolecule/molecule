  ...
  "variance ops" - types {
    if (Seq("mariadb", "mysql", "sqlite").contains(database)) {
      ...
      for {
        ...
        // n attributes
        _ <- Entity.i.a1.bigDecimal(variance)(variance1).query.get.map(_ ==> List(a))
        _ <- Entity.i.a1.bigDecimal(variance)(1.0).query.get.map(_ ==> Nil)

        _ <- Entity.i.a1.bigDecimal(variance).not(1.0).query.get.map(_ ==> List(a, b))
        _ <- Entity.i.a1.bigDecimal(variance).not(variance1).query.get.map(_ ==> List(b))

        _ <- Entity.i.a1.bigDecimal(variance).<(variance2).query.get.map(_ ==> List(a))
        _ <- Entity.i.a1.bigDecimal(variance).<(variance1).query.get.map(_ ==> Nil)

        _ <- Entity.i.a1.bigDecimal(variance).<=(variance2).query.get.map(_ ==> List(a, b))
        _ <- Entity.i.a1.bigDecimal(variance).<=(variance1).query.get.map(_ ==> List(a))

        _ <- Entity.i.a1.bigDecimal(variance).>(variance1).query.get.map(_ ==> List(b))
        _ <- Entity.i.a1.bigDecimal(variance).>(variance2).query.get.map(_ ==> Nil)

        _ <- Entity.i.a1.bigDecimal(variance).>=(variance1).query.get.map(_ ==> List(a, b))
        _ <- Entity.i.a1.bigDecimal(variance).>=(variance2).query.get.map(_ ==> List(b))
      } yield ()
    }
  }
  ...
  "stddev ops" - types {
    if (Seq("mariadb", "mysql", "sqlite").contains(database)) {
      ...
      for {
        ...
        // n attributes
        _ <- Entity.i.a1.bigDecimal(stddev)(stddev1).query.get.map(_ ==> List(a))
        _ <- Entity.i.a1.bigDecimal(stddev)(1.0).query.get.map(_ ==> Nil)

        _ <- Entity.i.a1.bigDecimal(stddev).not(1.0).query.get.map(_ ==> List(a, b))
        _ <- Entity.i.a1.bigDecimal(stddev).not(stddev1).query.get.map(_ ==> List(b))

        _ <- Entity.i.a1.bigDecimal(stddev).<(stddev2).query.get.map(_ ==> List(a))
        _ <- Entity.i.a1.bigDecimal(stddev).<(stddev1).query.get.map(_ ==> Nil)

        _ <- Entity.i.a1.bigDecimal(stddev).<=(stddev2).query.get.map(_ ==> List(a, b))
        _ <- Entity.i.a1.bigDecimal(stddev).<=(stddev1).query.get.map(_ ==> List(a))

        _ <- Entity.i.a1.bigDecimal(stddev).>(stddev1).query.get.map(_ ==> List(b))
        _ <- Entity.i.a1.bigDecimal(stddev).>(stddev2).query.get.map(_ ==> Nil)

        _ <- Entity.i.a1.bigDecimal(stddev).>=(stddev1).query.get.map(_ ==> List(a, b))
        _ <- Entity.i.a1.bigDecimal(stddev).>=(stddev2).query.get.map(_ ==> List(b))
      } yield ()
    }
  }
}