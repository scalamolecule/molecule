...
case class TypesSetOpt(
  ...
  "Types" - validation {
    for {
      _ <- Tpe.stringSet_?.insert(Some(Set("a", "b", "d"))).transact
      ...
      _ <- Tpe.intSet_?.insert(Some(Set(1, 2, 4))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
      ...
      _ <- Tpe.longSet_?.insert(Some(Set(1L, 2L, 4L))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
      ...
      _ <- Tpe.floatSet_?.insert(Some(Set(float1, float2, float4))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
      ...
      _ <- Tpe.doubleSet_?.insert(Some(Set(double1, double2, double4))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
      ...
      _ <- Tpe.booleanSet_?.insert(Some(Set(true, false))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
      ...
      _ <- Tpe.bigIntSet_?.insert(Some(Set(bigInt1, bigInt2, bigInt4))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
      ...
      _ <- Tpe.bigDecimalSet_?.insert(Some(Set(bigDecimal1, bigDecimal2, bigDecimal4))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
      ...
      _ <- Tpe.dateSet_?.insert(Some(Set(date1, date2, date4))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
      ...
      _ <- Tpe.durationSet_?.insert(Some(Set(duration1, duration2, duration4))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
      ...
      _ <- Tpe.instantSet_?.insert(Some(Set(instant1, instant2, instant4))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
      ...
      _ <- Tpe.localDateSet_?.insert(Some(Set(localDate1, localDate2, localDate4))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
      ...
      _ <- Tpe.localTimeSet_?.insert(Some(Set(localTime1, localTime2, localTime4))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
      ...
      _ <- Tpe.localDateTimeSet_?.insert(Some(Set(localDateTime1, localDateTime2, localDateTime4))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
      ...
      _ <- Tpe.offsetTimeSet_?.insert(Some(Set(offsetTime1, offsetTime2, offsetTime4))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
      ...
      _ <- Tpe.offsetDateTimeSet_?.insert(Some(Set(offsetDateTime1, offsetDateTime2, offsetDateTime4))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
      ...
      _ <- Tpe.zonedDateTimeSet_?.insert(Some(Set(zonedDateTime1, zonedDateTime2, zonedDateTime4))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
      ...
      uri1 = new URI("ab")
      uri2 = new URI("abcd")
      _ <- Tpe.uriSet_?.insert(Some(Set(uri0, uri1, uri2))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
      ...
      _ <- Tpe.byteSet_?.insert(Some(Set(byte1, byte2, byte4))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
      ...
      _ <- Tpe.shortSet_?.insert(Some(Set(short1, short2, short4))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
      ...
      _ <- Tpe.charSet_?.insert(Some(Set('a', 'b', 'd'))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
