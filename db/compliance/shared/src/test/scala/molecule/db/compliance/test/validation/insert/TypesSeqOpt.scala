...
case class TypesSeqOpt(
  ...
  "Types" - validation {
    for {
      _ <- Tpe.stringSeq_?.insert(Some(Seq("a", "b", "d"))).transact
      ...
      _ <- Tpe.intSeq_?.insert(Some(Seq(1, 2, 4))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
      ...
      _ <- Tpe.longSeq_?.insert(Some(Seq(1L, 2L, 4L))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
      ...
      _ <- Tpe.floatSeq_?.insert(Some(Seq(float1, float2, float4))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
      ...
      _ <- Tpe.doubleSeq_?.insert(Some(Seq(double1, double2, double4))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
      ...
      _ <- Tpe.booleanSeq_?.insert(Some(Seq(true, false))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
      ...
      _ <- Tpe.bigIntSeq_?.insert(Some(Seq(bigInt1, bigInt2, bigInt4))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
      ...
      _ <- Tpe.bigDecimalSeq_?.insert(Some(Seq(bigDecimal1, bigDecimal2, bigDecimal4))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
      ...
      _ <- Tpe.dateSeq_?.insert(Some(Seq(date1, date2, date4))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
      ...
      _ <- Tpe.durationSeq_?.insert(Some(Seq(duration1, duration2, duration4))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
      ...
      _ <- Tpe.instantSeq_?.insert(Some(Seq(instant1, instant2, instant4))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
      ...
      _ <- Tpe.localDateSeq_?.insert(Some(Seq(localDate1, localDate2, localDate4))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
      ...
      _ <- Tpe.localTimeSeq_?.insert(Some(Seq(localTime1, localTime2, localTime4))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
      ...
      _ <- Tpe.localDateTimeSeq_?.insert(Some(Seq(localDateTime1, localDateTime2, localDateTime4))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
      ...
      _ <- Tpe.offsetTimeSeq_?.insert(Some(Seq(offsetTime1, offsetTime2, offsetTime4))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
      ...
      _ <- Tpe.offsetDateTimeSeq_?.insert(Some(Seq(offsetDateTime1, offsetDateTime2, offsetDateTime4))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
      ...
      _ <- Tpe.zonedDateTimeSeq_?.insert(Some(Seq(zonedDateTime1, zonedDateTime2, zonedDateTime4))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
      ...
      uri1 = new URI("ab")
      uri2 = new URI("abcd")
      _ <- Tpe.uriSeq_?.insert(Some(Seq(uri0, uri1, uri2))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
      ...
      _ <- Tpe.shortSeq_?.insert(Some(Seq(short1, short2, short4))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
      ...
      _ <- Tpe.charSeq_?.insert(Some(Seq('a', 'b', 'd'))).transact
        .map(_ ==> "Unexpected success").recover {
          case InsertErrors(errors, _) =>
            errors.head._2.head.errors ==> Seq(
