...
case class TypesSeqOpt(
  ...
  "Types" - validation {
    for {
      _ <- Tpe.stringSeq_?(Some(Seq("a", "b", "d"))).save.transact
      ...
      _ <- Tpe.intSeq_?(Some(Seq(1, 2, 4))).save.transact
        .map(_ ==> "Unexpected success").recover {
          case ValidationErrors(errorMap) =>
      ...
      _ <- Tpe.longSeq_?(Some(Seq(1L, 2L, 4L))).save.transact
        .map(_ ==> "Unexpected success").recover {
          case ValidationErrors(errorMap) =>
            errorMap.head._2 ==> Seq(
      ...
      _ <- Tpe.floatSeq_?(Some(Seq(float1, float2, float4))).save.transact
        .map(_ ==> "Unexpected success").recover {
          case ValidationErrors(errorMap) =>
            errorMap.head._2 ==> Seq(
      ...
      _ <- Tpe.doubleSeq_?(Some(Seq(double1, double2, double4))).save.transact
        .map(_ ==> "Unexpected success").recover {
          case ValidationErrors(errorMap) =>
            errorMap.head._2 ==> Seq(
      ...
      _ <- Tpe.booleanSeq_?(Some(Seq(true, false))).save.transact
        .map(_ ==> "Unexpected success").recover {
          case ValidationErrors(errorMap) =>
            errorMap.head._2 ==> Seq(
      ...
      _ <- Tpe.bigIntSeq_?(Some(Seq(bigInt1, bigInt2, bigInt4))).save.transact
        .map(_ ==> "Unexpected success").recover {
          case ValidationErrors(errorMap) =>
            errorMap.head._2 ==> Seq(
      ...
      _ <- Tpe.bigDecimalSeq_?(Some(Seq(bigDecimal1, bigDecimal2, bigDecimal4))).save.transact
        .map(_ ==> "Unexpected success").recover {
          case ValidationErrors(errorMap) =>
            errorMap.head._2 ==> Seq(
      ...
      _ <- Tpe.dateSeq_?(Some(Seq(date1, date2, date4))).save.transact
        .map(_ ==> "Unexpected success").recover {
          case ValidationErrors(errorMap) =>
            errorMap.head._2 ==> Seq(
      ...
      _ <- Tpe.durationSeq_?(Some(Seq(duration1, duration2, duration4))).save.transact
        .map(_ ==> "Unexpected success").recover {
          case ValidationErrors(errorMap) =>
            errorMap.head._2 ==> Seq(
      ...
      _ <- Tpe.instantSeq_?(Some(Seq(instant1, instant2, instant4))).save.transact
        .map(_ ==> "Unexpected success").recover {
          case ValidationErrors(errorMap) =>
            errorMap.head._2 ==> Seq(
      ...
      _ <- Tpe.localDateSeq_?(Some(Seq(localDate1, localDate2, localDate4))).save.transact
        .map(_ ==> "Unexpected success").recover {
          case ValidationErrors(errorMap) =>
            errorMap.head._2 ==> Seq(
      ...
      _ <- Tpe.localTimeSeq_?(Some(Seq(localTime1, localTime2, localTime4))).save.transact
        .map(_ ==> "Unexpected success").recover {
          case ValidationErrors(errorMap) =>
            errorMap.head._2 ==> Seq(
      ...
      _ <- Tpe.localDateTimeSeq_?(Some(Seq(localDateTime1, localDateTime2, localDateTime4))).save.transact
        .map(_ ==> "Unexpected success").recover {
          case ValidationErrors(errorMap) =>
            errorMap.head._2 ==> Seq(
      ...
      _ <- Tpe.offsetTimeSeq_?(Some(Seq(offsetTime1, offsetTime2, offsetTime4))).save.transact
        .map(_ ==> "Unexpected success").recover {
          case ValidationErrors(errorMap) =>
            errorMap.head._2 ==> Seq(
      ...
      _ <- Tpe.offsetDateTimeSeq_?(Some(Seq(offsetDateTime1, offsetDateTime2, offsetDateTime4))).save.transact
        .map(_ ==> "Unexpected success").recover {
          case ValidationErrors(errorMap) =>
            errorMap.head._2 ==> Seq(
      ...
      _ <- Tpe.zonedDateTimeSeq_?(Some(Seq(zonedDateTime1, zonedDateTime2, zonedDateTime4))).save.transact
        .map(_ ==> "Unexpected success").recover {
          case ValidationErrors(errorMap) =>
            errorMap.head._2 ==> Seq(
      ...
      uri1 = new URI("ab")
      uri2 = new URI("abcd")
      _ <- Tpe.uriSeq_?(Some(Seq(uri0, uri1, uri2))).save.transact
        .map(_ ==> "Unexpected success").recover {
          case ValidationErrors(errorMap) =>
            errorMap.head._2 ==> Seq(
      ...
      _ <- Tpe.shortSeq_?(Some(Seq(short1, short2, short4))).save.transact
        .map(_ ==> "Unexpected success").recover {
          case ValidationErrors(errorMap) =>
            errorMap.head._2 ==> Seq(
      ...
      _ <- Tpe.charSeq_?(Some(Seq('a', 'b', 'd'))).save.transact
        .map(_ ==> "Unexpected success").recover {
          case ValidationErrors(errorMap) =>
            errorMap.head._2 ==> Seq(
