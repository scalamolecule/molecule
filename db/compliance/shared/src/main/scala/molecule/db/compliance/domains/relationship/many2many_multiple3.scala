...
object many2many_multiple3 extends DomainStructure {

  trait Developer {
    val name     = oneString
    val frontend = manyToMany[Project]("designer")
    val backend  = manyToMany[Project]("engineer")
  }
  ...
  //    val frontend = oneToMany[Project]
  //  }
  //
  //  trait Backend extends Join {
  //    val engineer = oneToMany[Developer]
  //    val backend  = oneToMany[Project]
  //  }
}
